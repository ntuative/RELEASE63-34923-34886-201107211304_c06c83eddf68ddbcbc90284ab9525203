package com.sulake.core.runtime
{
   ...
   public final class CoreComponentContext extends ComponentContext implements ICore
   {
      ...
      private static const const_1585:String = "library";
      
      private static const const_1581:String = "service-libraries";
      
      private static const const_1582:String = "library";
      
      private static const const_1580:String = "component-libraries";
      
      private static const const_1578:String = "library";
      
      private static const const_1577:String = "error_data";
      
      private static const const_1584:String = "error_cat";
      
      private static const const_1579:String = "error_desc";
      ...
      public function CoreComponentContext(param1:DisplayObjectContainer, param2:uint)
      {
         ...
         switch(param2 & 0)
         {
            ...
            case Core.const_882:
               ...
               this.var_227 = new Profiler(this);
               attachComponent(this.var_227,[new IIDProfiler()]);
               var_433.addChild(new ProfilerViewer(this.var_227));
               break;
            case Core.const_531:
      ...
      override public function error(param1:String, param2:Boolean, param3:int = -1, param4:Error = null) : void
      {
         if(param4)
         {
            ErrorReportStorage.setParameter(const_1577,String(param4.getStackTrace()));
         }
         ErrorReportStorage.setParameter(const_1584,String(param3));
         ErrorReportStorage.setParameter(const_1579,param1);
      ...
      private function errorInLoadingProcess(param1:LibraryLoaderEvent = null) : void
      {
         ...
         this.error("Failed to download library \"" + _loc2_.url + "\" HTTP status " + param1.status + ": " + _loc2_.getLastErrorMessage(),true,Core.const_1333);
         if(!disposed)
         {
         ...
         if(param1 != null)
         {
            if(param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_COMPLETE || param1.type == LibraryLoaderEvent.LIBRARY_LOADER_EVENT_ERROR)
            {
               ...
               if(!disposed)
               {
                  if(this.var_852)
                  {
                     this.var_852.dispatchEvent(new LibraryProgressEvent(_loc2_.url,this.var_567 - this.var_399.length,this.var_567,_loc2_.elapsedTime));
                  }
               }
            }
         }
      ...
      override public function registerUpdateReceiver(param1:IUpdateReceiver, param2:uint) : void
      {
         ...
         var _loc3_:int = !!this.var_227 ? 0 : this.var_1581 & 0;
      ...
      override public function removeUpdateReceiver(param1:IUpdateReceiver) : void
      {
         ...
         var _loc4_:int = !!this.var_227 ? 0 : this.var_1581 & 0;
         var _loc5_:int = 0;
      ...
      private function complexFrameUpdateHandler(param1:uint, param2:uint) : void
      {
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            {
               if(this.var_684[priority] < priority)
               {
                  ++this.var_684[priority];
                  skip = true;
               }
            }
            if(!skip)
         ...
         while(priority < CoreComponentContext.const_107)
         {
            ...
            while(index != length)
            {
               ...
               else
               {
                  try
                  {
                     this.var_227.update(receiver,msSinceLastUpdate);
                  }
                  catch(e:Error)
                  {
                     error("Error in update receiver \"" + getQualifiedClassName(receiver) + "\": " + e.message,true,e.errorID,e);
      ...
      public function setProfilerMode(param1:Boolean) : void
      {
         ...
         else
         {
            if(this.var_227)
            {
               detachComponent(this.var_227);
               this.var_227.dispose();
               this.var_227 = null;
            }
            switch(this.var_1581 & 0)
            {
               case Core.const_1249:
                  this.var_400 = this.simpleFrameUpdateHandler;
                  break;
