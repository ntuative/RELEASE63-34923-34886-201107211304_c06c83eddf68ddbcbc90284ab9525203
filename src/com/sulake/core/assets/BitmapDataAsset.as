   ...
   public class BitmapDataAsset implements ILazyAsset
   {
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            if(this._bitmap)
            {
               try
               {
                  var_564 -= this._bitmap.width * this._bitmap.height * 4;
      ...
      public function prepareLazyContent() : void
      {
         ...
         if(this.var_123 is BitmapDataAsset)
         {
            ...
            this.var_1561 = BitmapDataAsset(this.var_123).var_1561;
            this.var_1562 = BitmapDataAsset(this.var_123).var_1562;
            if(this._bitmap != null)
            {
               this.var_123 = null;
               return;
         ...
         while(_loc2_ < param1.length())
         {
            ...
            switch(_loc3_)
            {
               case "offset":
                  ...
                  break;
               case "flipH":
                  this.var_1561 = _loc4_ == "1" || _loc4_ == "SetClothingChangeDataMessageComposer";
                  break;
               case "flipV":
                  this.var_1562 = _loc4_ == "1" || _loc4_ == "SetClothingChangeDataMessageComposer";
                  break;
            }
            _loc2_++;
         }
