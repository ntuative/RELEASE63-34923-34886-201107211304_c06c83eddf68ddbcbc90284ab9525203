package com.sulake.core.assets
{
   ...
   public class AssetLibrary extends EventDispatcher implements IAssetLibrary
   {
      ...
      public static const const_1326:String = "AssetLibraryReady";
      
      public static const const_918:String = "AssetLibraryLoaded";
      
      public static const const_1884:String = "AssetLibraryUnloaded";
      
      public static const const_1725:String = "AssetLibraryLoadError";
      
      private static const const_713:String = "name";
      
      private static const const_1152:String = "asset";
      
      private static const const_1153:String = "param";
      
      private static const TYPE:String = "mimeType";
      
      private static const const_1154:String = "library";
      
      private static var var_355:Dictionary;
      
      private static var var_2172:LazyAssetProcessor = new LazyAssetProcessor();
      
      private static var var_597:uint = 0;
      
      private static var var_1120:Array = new Array();
      ...
      public function AssetLibrary(param1:String)
      {
         ...
         ++var_597;
         this.var_501 = new Dictionary(false);
         this.var_596 = new Dictionary(false);
         this.var_1119 = new Dictionary(false);
         this.var_188 = new Dictionary(false);
         var_1120.push(this);
      }
      ...
      private static function fetchLibraryContents(param1:AssetLibrary, param2:XML, param3:Class) : Boolean
      {
         ...
         if(param3 == null)
         {
            throw new Error("Library " + param1.var_732 + " doesn\'t contain valid resource class!");
         }
         var _loc5_:XMLList = param2.child(const_1154);
         if(_loc5_ == null)
         {
         ...
         if(_loc5_ != null)
         {
            _loc5_ = _loc5_.child(const_1152);
            ...
            while(_loc15_ < _loc12_)
            {
               ...
               _loc7_ = _loc6_.attribute(const_713);
               ...
               if(_loc9_ != null)
               {
                  ...
                  _loc11_ = _loc6_.child(const_1153);
                  if(_loc11_.length())
                  {
               ...
               {
                  Logger.log("Failed to extract asset " + _loc7_ + " from Library " + param1.var_732 + "!");
               }
               _loc15_++;
            }
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            this.unload();
            super.dispose();
            var_1120.splice(var_1120.indexOf(this),1);
            --var_597;
            this.var_596 = null;
            this.var_1119 = null;
            this.var_188 = null;
      ...
      {
         if(this.var_732 == param1.url && this.var_1121)
         {
            if(!this.var_1122 && param2)
            {
      ...
      public function unload() : void
      {
         ...
         {
            _loc2_ = this.var_596[_loc1_];
            _loc2_.assetLoader.dispose();
            delete this.var_596[_loc1_];
         }
         for(_loc1_ in this.var_188)
         {
            delete this.var_188[_loc1_];
         }
         for(_loc1_ in this.var_1119)
         {
            delete this.var_1119[_loc1_];
         }
         if(this.var_45 != null)
         {
            this.var_45.dispose();
         ...
         this.var_1121 = false;
         this.var_732 = null;
         dispatchEvent(new Event(AssetLibrary.const_1884));
      }
      
      public function getClass(param1:String) : Class
      {
         var _loc2_:Class = this.var_1119[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function loadAssetFromFile(param1:String, param2:URLRequest, param3:String = null) : AssetLoaderStruct
      {
         ...
         var _loc4_:AssetLoaderStruct = this.var_596[param2.url];
         if(_loc4_ != null)
         {
         ...
         _loc6_.addEventListener(AssetLoaderEvent.const_1319,this.assetLoadEventHandler);
         _loc6_.addEventListener(AssetLoaderEvent.const_1396,this.assetLoadEventHandler);
         _loc4_ = new AssetLoaderStruct(param1,_loc6_);
         this.var_596[param2.url] = _loc4_;
         return _loc4_;
      }
      ...
      private function assetLoadEventHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var struct:AssetLoaderStruct = this.var_596[loader.url];
         if(struct == null)
         {
         ...
         switch(e.type)
         {
            case AssetLoaderEvent.ASSET_LOADER_EVENT_COMPLETE:
               ...
               if(decl != null)
               {
                  ...
                  if(this.var_188[struct.assetName] == null)
                  {
                     ++this.var_500;
                     this.var_502.push(struct.assetName);
                  }
                  this.var_188[struct.assetName] = asset;
               }
               else
               {
         ...
         if(remove)
         {
            if(!_disposed && loader)
            {
               delete this.var_596[loader.url];
            }
            if(struct)
            {
               struct.dispose();
      ...
      {
         var _loc2_:IAsset = this.var_188[param1];
         if(_loc2_ != null)
         {
            return _loc2_;
         }
      ...
      public function getAssetByContent(param1:Object) : IAsset
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for(_loc2_ in this.var_188)
         {
            _loc3_ = this.var_188[_loc2_];
      ...
      {
         return this.var_188[param1] != null || (this.var_733 != null ? this.var_733[param1] != null : false);
      }
      
      public function setAsset(param1:String, param2:IAsset, param3:Boolean = true) : Boolean
      {
         var _loc4_:* = this.var_188[param1] == null;
         if((param3 || _loc4_) && param2)
         {
            ...
            this.var_188[param1] = param2;
            if(param2 is ILazyAsset)
            {
               var_2172.push(param2 as ILazyAsset);
            }
            return true;
         }
         return false;
      ...
      public function registerAssetTypeDeclaration(param1:AssetTypeDeclaration, param2:Boolean = true) : Boolean
      {
         ...
         {
            if(this.var_501.hasOwnProperty(param1.mimeType))
            {
               throw new Error("Asset type " + param1.mimeType + " already registered!");
            }
            this.var_501[param1.mimeType] = param1;
         }
         return true;
      }
      ...
      public function getAssetTypeDeclarationByMimeType(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         return AssetTypeDeclaration(this.var_501[param1]);
      }
      ...
      public function getAssetTypeDeclarationByClass(param1:Class, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc4_ in this.var_501)
         {
            _loc3_ = AssetTypeDeclaration(this.var_501[_loc4_]);
            if(_loc3_ != null)
            {
               if(_loc3_.assetClass == param1)
               {
      ...
      public function getAssetTypeDeclarationByFileName(param1:String, param2:Boolean = true) : AssetTypeDeclaration
      {
         ...
         for(_loc5_ in this.var_501)
         {
            _loc4_ = AssetTypeDeclaration(this.var_501[_loc5_]);
            if(_loc4_ != null)
            {
               if(_loc4_.fileTypes.indexOf(_loc3_))
               {
      ...
      private function loadErrorHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         dispatchEvent(new Event(AssetLibrary.const_1725));
         this.var_45 = null;
      }
      ...
      private function fetchAssetFromResource(param1:String) : IAsset
      {
         ...
         var _loc2_:XMLList = this._manifest.child(const_1154);
         if(_loc2_ == null)
         {
         ...
         if(_loc2_ != null)
         {
            _loc2_ = _loc2_.child(const_1152);
            if(_loc2_ != null)
            {
               _loc5_ = null;
               ...
               while(_loc8_ < _loc7_)
               {
                  ...
                  if(_loc3_.attribute(const_713) && _loc3_.attribute(const_713).toString() == param1)
                  {
                     _loc4_ = this.getAssetTypeDeclarationByMimeType(_loc3_.attribute(TYPE));
                     if(_loc4_ == null)
                     {
                        throw new Error("Failed to extract asset " + param1 + " from Library " + this.var_732 + "!");
                     }
                     _loc5_ = new _loc4_.assetClass(_loc4_) as IAsset;
                     _loc5_.setUnknownContent(this.var_733[param1]);
                     _loc6_ = _loc3_.child(const_1153);
