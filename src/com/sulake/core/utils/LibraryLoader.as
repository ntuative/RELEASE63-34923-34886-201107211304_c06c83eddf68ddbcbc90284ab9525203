package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_2055:uint = 1;
      
      protected static const const_2056:uint = 2;
      
      protected static const const_2054:uint = 4;
      
      protected static const const_2053:uint = 3;
      ...
      private static var var_1090:Array = new Array();
      ...
      protected var var_3063:Boolean = true;
      ...
      protected static function queue(param1:LibraryLoader) : void
      {
         ...
         {
            param1.var_45.load(param1.var_268,param1._context);
         }
      }
      ...
      protected static function throttle() : void
      {
         ...
         if(const_1192)
         {
            ...
            while(var_886.length < const_1808 && false)
            {
               _loc1_ = var_1090.shift() as LibraryLoader;
               if(!_loc1_.ready && !_loc1_.disposed)
               {
                  var_886.push(_loc1_);
                  _loc1_.var_45.load(_loc1_.var_268,_loc1_._context);
               }
            }
         }
      }
      ...
      {
         return !!this.var_1153 ? uint(this.var_1429 - this.var_2273) : uint(getTimer() - this.var_2273);
      }
      ...
      {
         if(!this.var_1153 && !_disposed && this.var_1428 > 0)
         {
            try
            {
               this.var_45.close();
            ...
            this.addRequestCounterToUrlRequest(this.var_268,const_1743 - this.var_1428);
            if(this.var_3063)
            {
            ...
            --this.var_1428;
            this.var_513 = 0;
            this.var_45.load(this.var_268,this._context);
            return true;
         }
         return false;
      }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(this.var_513 == LibraryLoader.const_2053)
         {
