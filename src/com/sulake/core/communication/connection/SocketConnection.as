package com.sulake.core.communication.connection
{
   ...
   public class SocketConnection extends EventDispatcher implements IConnection, IDisposable
   {
      ...
      public static const const_1749:int = 10000;
      ...
      private var var_581:ByteArray;
      
      private var var_1329:IEncryption;
      
      private var var_880:IProtocol;
      ...
      public function SocketConnection(param1:String, param2:ICoreCommunicationManager, param3:IConnectionStateListener)
      {
         ...
         this._id = param1;
         this.var_279 = param2;
         this.var_581 = new ByteArray();
         this.var_1330 = new MessageClassManager();
         this.var_88 = new Socket();
         this.var_232 = new Timer(const_1749,1);
         this.var_232.addEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_232.stop();
            this.var_232.removeEventListener(TimerEvent.TIMER,this.onTimeOutTimer);
         }
         this.var_232 = null;
         this.var_581 = null;
         this.var_580 = null;
      ...
      public function send(param1:IMessageComposer, param2:int = -1) : Boolean
      {
         ...
         var _loc6_:ByteArray = this.var_880.encoder.encode(_loc4_,_loc5_,param2);
         if(this.var_580)
         {
         ...
         {
            _loc3_ = this.var_1329.encipher(_loc6_);
         }
         else
         {
            _loc3_ = _loc6_;
      ...
      override public function toString() : String
      {
         ...
         _loc1_ += "Protocol Encoder: " + this.var_880.encoder + "\n";
         _loc1_ += "Protocol Decoder: " + this.var_880.decoder + "\n";
         return _loc1_ + ("Encryption: " + this.var_1329 + "\n");
      }
      ...
      public function processReceivedData() : void
      {
         ...
         var offset:uint = this.var_880.getMessages(this.var_581,receivedMessages);
         try
         {
            ...
            {
               temp = new ByteArray();
               temp.writeBytes(this.var_581,offset);
               this.var_581 = temp;
               this.logConnection("[SOCKET REST] offset: " + offset + " rest: " + this.var_581.toString());
            }
         }
         catch(e:Error)
         {
      ...
      private function onRead(param1:ProgressEvent) : void
      {
         ...
         {
            this.var_581.writeByte(this.var_88.readUnsignedByte());
         }
      }
      ...
      private function onConnect(param1:Event) : void
      {
         ...
         this.var_232.stop();
         this.var_2066 = true;
         ErrorReportStorage.addDebugData("ConnectionTimer","Connected in " + (getTimer() - this.var_879));
      ...
      private function onClose(param1:Event) : void
      {
         ...
         this.var_2066 = false;
         ErrorReportStorage.addDebugData("ConnectionTimer","Closed in " + (getTimer() - this.var_879));
         dispatchEvent(param1);
      }
      ...
      private function onComplete(param1:Event) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","Completed in " + (getTimer() - this.var_879));
         dispatchEvent(param1);
      }
      ...
      private function onSecurityError(param1:SecurityErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","SecurityError in " + (getTimer() - this.var_879));
         dispatchEvent(param1);
      }
      ...
      private function onIOError(param1:IOErrorEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","IOError in " + (getTimer() - this.var_879));
         switch(param1.type)
         {
      ...
      private function onTimeOutTimer(param1:TimerEvent) : void
      {
         ...
         ErrorReportStorage.addDebugData("ConnectionTimer","TimeOut in " + (getTimer() - this.var_879));
         var _loc2_:IOErrorEvent = new IOErrorEvent(IOErrorEvent.IO_ERROR);
         _loc2_.text = "Socket Timeout (" + this.var_232.delay + " ms). Possible Firewall.";
