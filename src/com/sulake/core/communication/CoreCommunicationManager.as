package com.sulake.core.communication
{
   ...
   public class CoreCommunicationManager extends Component implements ICoreCommunicationManager, IUpdateReceiver
   {
      ...
      private var var_2138:IConnectionStateListener;
      ...
      override public function dispose() : void
      {
         ...
         this.var_901 = null;
         for each(_loc3_ in this.var_1657)
         {
         }
         var _loc5_:* = null;
         this.var_1355 = null;
      ...
      public function createConnection(param1:String, param2:uint = 0) : IConnection
      {
         ...
         switch(param2)
         {
            case ConnectionType.const_1401:
               _loc3_ = new SocketConnection(param1,this,this.var_2138);
               break;
            default:
      ...
      {
         var _loc2_:Class = this.var_1355[param1];
         var _loc3_:* = null;
         if(_loc2_ != null)
         {
      ...
      public function getMessageParser(param1:Class) : IMessageParser
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         for each(var _loc6_ in this.var_1657)
         {
            _loc3_ = _loc6_;
            _loc6_;
            if(_loc3_ is param1)
