package com.sulake.core.window.utils
{
   ...
   public class MouseEventProcessor implements IEventProcessor, IDisposable
   {
      ...
      protected static var var_436:Point = new Point();
       
      
      protected var var_748:Point;
      
      protected var var_191:WindowController;
      
      protected var var_71:WindowController;
      
      protected var var_189:IWindowRenderer;
      ...
      public function MouseEventProcessor()
      {
         ...
         {
            var_365 = new Array();
            var_365[0] = MouseCursorType.const_354;
            var_365[1] = MouseCursorType.const_30;
            var_365[2] = MouseCursorType.const_354;
            var_365[3] = MouseCursorType.const_354;
            var_365[4] = MouseCursorType.const_354;
            var_365[5] = MouseCursorType.const_30;
            var_365[6] = MouseCursorType.const_354;
         }
         if(var_319 == null)
         {
            var_319 = new Array();
            var_319[0] = WindowState.const_88;
            var_319[1] = WindowState.const_87;
            var_319[2] = WindowState.const_89;
      ...
      protected static function convertMouseEventType(param1:MouseEvent, param2:IWindow, param3:IWindow) : WindowMouseEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case MouseEvent.MOUSE_UP:
               ...
               _loc4_ = !!_loc6_ ? "null" : WindowMouseEvent.const_279;
               break;
      ...
      public function process(param1:EventProcessorState, param2:IEventQueue) : void
      {
         ...
         this.var_191 = state.var_1409 as WindowController;
         this.var_189 = state.renderer;
         this.var_934 = state.var_1412;
         eventQueue.begin();
         this.var_748.x = -1;
         this.var_748.y = -1;
         ...
         while(true)
         {
            ...
            if(event.stageX != this.var_748.x || event.stageY != this.var_748.y)
            {
               this.var_748.x = event.stageX;
               this.var_748.y = event.stageY;
               array = new Array();
               this.var_96.groupParameterFilteredChildrenUnderPoint(this.var_748,array,WindowParam.const_31);
            ...
            if(index == 0)
            {
               if(event.type == MouseEvent.MOUSE_MOVE)
               {
                  ...
                  {
                     this.var_71.getGlobalPosition(var_436);
               ...
               if(child != null && child.visible)
               {
                  if(event.type == MouseEvent.MOUSE_MOVE)
                  {
                     if(child != this.var_71)
                     {
                        ...
                        if(!child.disposed)
                        {
                           child.getGlobalPosition(var_436);
         ...
         state.var_1409 = this.var_191;
         state.renderer = this.var_189;
         state.var_1412 = this.var_934;
      }
      ...
      private function passMouseEvent(param1:WindowController, param2:MouseEvent, param3:Boolean = false) : WindowController
      {
         ...
         var _loc5_:BitmapData = this.var_189.getDrawBufferForRenderable(param1);
