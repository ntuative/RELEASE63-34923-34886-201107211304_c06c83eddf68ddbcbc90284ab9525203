package com.sulake.core.window.utils
{
   ...
   public class TextStyleManager
   {
      ...
      private static var var_554:Array;
      ...
      private static const const_1540:String = "/*";
      ...
      public static function setStyles(param1:Array, param2:Boolean = false) : void
      {
         ...
         if(param2)
         {
            _loc5_ = [var_98[const_229],var_98[ITALIC],var_98[BOLD]];
            var_98.reset();
            var_98[const_229] = _loc5_[0];
         ...
         for each(_loc4_ in param1)
         {
            ...
            if(var_554.indexOf(_loc4_.name) == -1)
            {
               var_554.push(_loc4_.name);
            }
         }
         _eventDispatcher.dispatchEvent(new Event(Event.CHANGE));
      ...
      public static function parseCSS(param1:String) : Array
      {
         ...
         for each(_loc7_ in _loc3_)
         {
            ...
            _loc6_.kerning = !!_loc5_.kerning ? _loc5_.kerning == "SetClothingChangeDataMessageComposer" : null;
      ...
      private static function parseStyleNamesFromCSS(param1:String) : Array
      {
         ...
         {
            while(_loc5_.indexOf(const_1540) == 0)
            {
               _loc5_ = _loc5_.substring(_loc5_.indexOf(const_1539) + 2,_loc5_.length);
            }
