package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_1185:String = "_EXCLUDE";
      
      public static const const_2145:String = "_INCLUDE";
      
      public static const const_2247:String = "_TEMP";
      
      private static const const_1628:String = "layout";
      
      private static const const_1120:String = "window";
      
      private static const const_1119:String = "variables";
      
      private static const const_1118:String = "filters";
      
      private static const const_713:String = "name";
      
      private static const const_1622:String = "style";
      
      private static const const_711:String = "params";
      
      private static const const_1627:String = "tags";
      ...
      private static const const_1620:String = "visible";
      
      private static const const_1619:String = "caption";
      
      private static const ID:String = "id";
      
      private static const const_5:String = "background";
      
      private static const const_1236:String = "blend";
      
      private static const const_1615:String = "clipping";
      
      private static const COLOR:String = "color";
      
      private static const const_1623:String = "treshold";
      
      private static const const_1617:String = "children";
      
      private static const const_1624:String = "width_min";
      
      private static const WIDTH_MAX:String = "width_max";
      
      private static const const_1625:String = "height_min";
      
      private static const const_1616:String = "height_max";
      
      private static const const_712:String = "SetClothingChangeDataMessageComposer";
      
      private static const const_190:String = "0";
      
      private static const const_1621:String = "$";
      
      private static const const_1618:String = ",";
      
      private static const const_50:String = "";
      
      private static const const_1629:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1626:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1419:Dictionary;
      ...
      public function WindowParser(param1:IWindowContext)
      {
         ...
         TypeCodeTable.fillTables(this.var_1419,this.var_1420);
         this.var_1150 = new Dictionary();
         this.var_1713 = new Dictionary();
         ParamCodeTable.fillTables(this.var_1150,this.var_1713);
         this.var_2266 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1626,const_50);
         return param1.replace(const_1629,const_50);
      }
      ...
      public function dispose() : void
      {
         ...
         if(!this._disposed)
         {
            for(_loc1_ in this.var_1419)
            {
               delete this.var_1419[_loc1_];
            }
            for(_loc1_ in this.var_1420)
            {
               delete this.var_1420[_loc1_];
            }
            for(_loc1_ in this.var_1150)
            {
               delete this.var_1150[_loc1_];
            }
      ...
      public function parseAndConstruct(param1:XML, param2:IWindow, param3:Map) : IWindow
      {
         ...
         var _loc12_:* = null;
         var _loc13_:int = 0;
         if(param1.localName() == const_1628)
         {
            _loc8_ = param1.child(const_1119);
            if(_loc8_.length() > 0)
            {
               _loc10_ = _loc8_[0];
            ...
            _loc9_ = param1.child(const_1118).children();
            if(_loc9_.length() > 0)
            {
               _loc12_ = new Array();
               _loc13_ = 0;
            ...
            _loc4_ = param1.child(const_1120);
         ...
         if(param1.localName() == const_1120)
         {
      ...
      private function parseSingleWindowEntity(param1:XML, param2:WindowController, param3:Map) : IWindow
      {
         ...
         var id:int = 0;
         type = this.var_1419[xml.localName()];
         name = unescape(String(this.parseAttribute(xml,const_713,variables,"")));
         style = uint(this.parseAttribute(xml,const_1622,variables,style));
         params = uint(this.parseAttribute(xml,const_711,variables,params));
         tag = unescape(String(this.parseAttribute(xml,const_1627,variables,tag)));
         rect = new Rectangle();
         rect.x = Number(this.parseAttribute(xml,X,variables,const_190));
         rect.y = Number(this.parseAttribute(xml,Y,variables,const_190));
         rect.width = Number(this.parseAttribute(xml,name_2,variables,const_190));
         rect.height = Number(this.parseAttribute(xml,name_1,variables,const_190));
         visible = this.parseAttribute(xml,const_1620,variables,visible.toString()) == const_712;
         ...
         if(xml.child(const_711).length() > 0)
         {
            ...
            {
               node = list[i];
               param = this.parseAttribute(node,const_713,variables,"") as String;
               if(this.var_1150[param] == null)
               {
                  throw new Error("Unknown window parameter \"" + String(node.attribute(const_713)) + "\"!");
               }
               params |= this.var_1150[param];
               i++;
            }
         }
         caption = !!(params & 0) ? (!!parent ? parent.caption : const_50) : const_50;
         caption = unescape(String(this.parseAttribute(xml,const_1619,variables,caption)));
         if(tag != const_50)
         {
            tags = tag.split(const_1618);
            length = tags.length;
            i = 0;
            while(i < length)
            {
         ...
         window = this._context.create(name,null,type,style,params,rect,null,parent is IIterable ? null : parent,id,this.parseProperties(xml.child(const_1119)[0]),tags) as WindowController;
         window.limits.minWidth = int(this.parseAttribute(xml,const_1624,variables,window.limits.minWidth));
         window.limits.maxWidth = int(this.parseAttribute(xml,WIDTH_MAX,variables,window.limits.maxWidth));
         window.limits.minHeight = int(this.parseAttribute(xml,const_1625,variables,window.limits.minHeight));
         window.limits.maxHeight = int(this.parseAttribute(xml,const_1616,variables,window.limits.maxHeight));
         background = this.parseAttribute(xml,const_5,variables,window.background.toString()) == const_712;
         blend = Number(this.parseAttribute(xml,const_1236,variables,window.blend.toString()));
         clipping = this.parseAttribute(xml,const_1615,variables,window.clipping.toString()) == const_712;
         color = String(this.parseAttribute(xml,COLOR,variables,window.color.toString()));
         treshold = uint(this.parseAttribute(xml,const_1623,variables,window.mouseThreshold.toString()));
         ...
         list = xml.child(const_1118).children();
         length = list.length();
         if(length > 0)
         {
            filters = new Array();
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_1185) == -1)
                  {
