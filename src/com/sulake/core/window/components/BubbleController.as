package com.sulake.core.window.components
{
   ...
   public class BubbleController extends FrameController implements IBubbleWindow
   {
      ...
      private static const const_2099:String = "_POINTER_DOWN";
      ...
      public function set direction(param1:String) : void
      {
         ...
         if(param1 != this._direction)
         {
            ...
            this.pointerOffset = this.var_910;
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_739,this._direction,PropertyStruct.const_54,true));
         }
         else
         {
         ...
         if(this.var_910 != 0)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_936,this.var_910,PropertyStruct.const_37,true));
         }
         else
         {
