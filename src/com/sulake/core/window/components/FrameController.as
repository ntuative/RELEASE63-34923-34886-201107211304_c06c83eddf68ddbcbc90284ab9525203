package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1486:String = "_TITLE";
      
      private static const const_1690:String = "_HEADER";
      
      private static const const_1688:String = "_CONTENT";
      
      private static const const_1689:String = "_SCALER";
       
      
      private var _title:ILabelWindow;
      
      private var var_1654:IHeaderWindow;
      ...
      public function get title() : ILabelWindow
      {
         if(this._title == null)
         {
            this._title = findChildByTag(const_1486) as ILabelWindow;
            if(!this._title)
            {
      ...
      public function get header() : IHeaderWindow
      {
         ...
         {
            this.var_1654 = findChildByTag(const_1690) as IHeaderWindow;
            if(!this.var_1654)
            {
      ...
      public function get content() : IWindowContainer
      {
         ...
         {
            this.var_210 = findChildByTag(const_1688) as IWindowContainer;
            if(!this.var_210)
            {
      ...
      {
         return findChildByTag(const_1689) as IScalerWindow;
      }
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_341);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_306);
         var _loc4_:Boolean = testParamFlag(WindowParam.const_245);
         if(_loc1_)
         {
            if(_loc3_ || _loc2_)
            {
               _loc1_.setParamFlag(WindowParam.const_306,true);
            }
            else
            {
               _loc1_.setParamFlag(WindowParam.const_306,false);
            }
            if(_loc4_ || _loc2_)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_365,false);
         }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_280,_loc3_.left,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_301,_loc3_.top,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,0 - _loc3_.right,PropertyStruct.const_37,_loc2_));
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_274,0 - _loc3_.bottom,PropertyStruct.const_37,_loc2_));
         return _loc1_;
      }
