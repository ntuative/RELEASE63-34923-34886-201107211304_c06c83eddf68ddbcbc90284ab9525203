package com.sulake.core.window.components
{
   ...
   public class TabContextController extends WindowController implements ITabContextWindow, IIterable
   {
      ...
      private static const const_1598:String = "_SELECTOR";
      
      private static const const_1599:String = "_CONTENT";
       
      
      protected var var_1149:ITabSelectorWindow;
      
      protected var var_2259:IWindowContainer;
      ...
      public function get selector() : ITabSelectorWindow
      {
         ...
         {
            this.var_1149 = findChildByTag(const_1598) as ITabSelectorWindow;
            if(this.var_1149 != null)
            {
      ...
      {
         if(this.var_2259 == null)
         {
            this.var_2259 = findChildByTag(const_1599) as IWindowContainer;
         }
      ...
      {
         return !!this.var_835 ? this.selector.iterator : null;
      }
