package com.sulake.core.window.components
{
   ...
   public class TextFieldController extends TextController implements ITextFieldWindow
   {
      ...
      {
         this.var_1414 = param1 == null ? "" : param1;
      }
      ...
      protected function refreshAutoSize() : void
      {
         ...
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(this.var_835 && autoSize != TextFieldAutoSize.NONE)
         {
            if(false)
            {
      ...
      private function onKeyDownEvent(param1:KeyboardEvent) : void
      {
         ...
         {
            _context.handleError(WindowContext.const_454,e);
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(true ? new PropertyStruct(PropertyDefaults.const_885,false,PropertyStruct.const_38,true) : PropertyDefaults.const_1972);
         _loc1_.push(this.var_1418 != PropertyDefaults.const_1256 ? new PropertyStruct(PropertyDefaults.const_812,this.var_1418,PropertyStruct.const_38,true) : PropertyDefaults.const_1963);
         _loc1_.push(_field.selectable != PropertyDefaults.const_1394 ? new PropertyStruct(PropertyDefaults.const_733,_field.selectable,PropertyStruct.const_38,true) : PropertyDefaults.const_1993);
         _loc1_.push(_field.displayAsPassword != PropertyDefaults.const_1215 ? new PropertyStruct("display_as_password",_field.displayAsPassword,PropertyStruct.const_38,true) : PropertyDefaults.const_1821);
         return _loc1_;
      }
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               case PropertyDefaults.const_812:
                  this.var_1418 = _loc2_.value as Boolean;
                  if(this.var_1418)
                  {
