package com.sulake.core.window.components
{
   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      private var var_1362:IItemListWindow;
      ...
      override public function dispose() : void
      {
         if(this.var_497)
         {
            this.var_497.removeEventListener(WindowEvent.const_298,this.scrollBarEventProc);
            this.var_497.removeEventListener(WindowEvent.const_305,this.scrollBarEventProc);
            this.var_497 = null;
         }
         if(this.var_1362)
         {
      ...
      protected function get _itemList() : IItemListWindow
      {
         if(!this.var_1362)
         {
            this.var_1362 = findChildByTag("_ITEMLIST") as IItemListWindow;
         }
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!this.var_497)
         {
            ...
            if(this.var_497)
            {
               this.var_497.addEventListener(WindowEvent.const_298,this.scrollBarEventProc);
               this.var_497.addEventListener(WindowEvent.const_305,this.scrollBarEventProc);
            }
         }
         return this.var_497;
      }
