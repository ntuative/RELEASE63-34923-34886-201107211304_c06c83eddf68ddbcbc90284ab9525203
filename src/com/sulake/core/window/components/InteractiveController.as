package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      {
         if(param1.toolTipCaption != PropertyDefaults.const_594)
         {
      ...
      public static function writeInteractiveWindowProperties(param1:IInteractiveWindow, param2:Array) : Array
      {
         if(param1.toolTipCaption != PropertyDefaults.const_594)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_760,param1.toolTipCaption,PropertyStruct.const_54,true));
         }
         else
         {
            param2.push(PropertyDefaults.const_1877);
         }
         if(param1.toolTipDelay != PropertyDefaults.const_1252)
         {
            param2.push(new PropertyStruct(PropertyDefaults.const_915,param1.toolTipDelay,PropertyStruct.const_291,true));
         }
         else
         {
      ...
      {
         this.var_1414 = param1 == null ? "null" : param1;
      }
