package com.sulake.core.window.components
{
   ...
   public class BitmapWrapperController extends WindowController implements IBitmapWrapperWindow, IBitmapDataContainer
   {
      ...
      override public function get properties() : Array
      {
         ...
         if(this.var_608 != PropertyDefaults.const_1265)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_924,this.var_608,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1800);
         }
         if(this.var_938 != PropertyDefaults.const_1310)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_845,this.var_938,PropertyStruct.const_54,true));
         }
         else
         {
