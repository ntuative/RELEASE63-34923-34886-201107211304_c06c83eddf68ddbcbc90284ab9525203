package com.sulake.core.window.components
{
   ...
   public class ActivatorController extends ContainerController
   {
      ...
      {
         if(param2.type == WindowEvent.const_326)
         {
            this.setActiveChild(param1 as IWindow);
         }
         else if(param2.type == WindowEvent.const_1366)
         {
            return true;
         }
      ...
      public function setActiveChild(param1:IWindow) : IWindow
      {
         ...
         var _loc2_:IWindow = this.var_941;
         if(this.var_941 != param1)
         {
            if(this.var_941 != null)
            {
               if(!this.var_941.disposed)
               {
                  this.var_941.deactivate();
               }
            }
            this.var_941 = param1;
