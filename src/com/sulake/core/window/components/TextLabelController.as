package com.sulake.core.window.components
{
   ...
   public class TextLabelController extends WindowController implements ILabelWindow, ILocalizable
   {
      ...
      {
         var _loc1_:TextField = TextFieldCache.getTextFieldByStyleName(this.var_448);
         if(_loc1_)
         {
      ...
      {
         if(this.var_448 != param1.name)
         {
            this.var_448 = param1.name;
            this.refresh();
         }
      }
      ...
      private function refresh(param1:Boolean = false) : void
      {
         ...
         this.var_2558 = _loc2_.textWidth;
         this.var_2557 = _loc2_.textHeight;
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push((_loc2_.color != null ? this.var_390 != _loc2_.color : this.var_390 != null && this.var_390 != PropertyDefaults.const_747) ? new PropertyStruct(PropertyDefaults.const_462,this.var_390,PropertyStruct.const_150,true) : PropertyDefaults.const_1223);
         if(this.var_43)
         {
            if(this.var_43.left != PropertyDefaults.const_903)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_280,this.var_43.left,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_799);
            }
            if(this.var_43.top != PropertyDefaults.const_862)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_301,this.var_43.top,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_852);
            }
            if(this.var_43.right != PropertyDefaults.const_890)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_259,this.var_43.right,PropertyStruct.const_37,true));
            }
            else
            {
               _loc1_.push(PropertyDefaults.const_783);
            }
            if(this.var_43.bottom != PropertyDefaults.const_744)
            {
               _loc1_.push(new PropertyStruct(PropertyDefaults.const_274,this.var_43.bottom,PropertyStruct.const_37,true));
            }
            else
            {
