package com.sulake.core.window.components
{
   ...
   public class HTMLTextController extends TextFieldController implements IHTMLTextWindow
   {
      ...
      private static var var_965:String = PropertyDefaults.HTML_LINK_TARGET_VALUE;
      ...
      private var var_1749:StyleSheet = null;
      ...
      {
         if(PropertyDefaults.const_988.indexOf(param1) > -1)
         {
            this.var_770 = param1;
         }
      }
      ...
      override public function set htmlText(param1:String) : void
      {
         ...
         {
            _field.htmlText = convertLinksToEvents(var_18);
            _field.styleSheet = this.var_1749;
            refreshTextImage();
         }
      }
      ...
      override protected function immediateClickHandler(param1:Event) : void
      {
         ...
         if(param1 is TextEvent)
         {
            ...
            if(!_loc2_.isWindowOperationPrevented() && this.linkTarget != LinkTarget.const_1349)
            {
      ...
      override public function get properties() : Array
      {
         ...
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_840,this.var_770,PropertyStruct.const_54,true,PropertyDefaults.const_988));
         }
         else
         {
