package com.sulake.core.window.components
{
   ...
   public class ScrollbarController extends InteractiveController implements IScrollbarWindow, ITouchAwareWindow
   {
      ...
      private static const const_1529:String = "increment";
      
      private static const const_1528:String = "decrement";
      
      private static const const_1080:String = "slider_track";
      
      private static const const_699:String = "slider_bar";
      ...
      public function set scrollable(param1:IScrollableWindow) : void
      {
         if(this.var_17 != null && !this.var_17.disposed)
         {
            ...
            this.var_17.removeEventListener(WindowEvent.const_568,this.onScrollableScrolled);
         }
         this.var_17 = param1;
         if(this.var_17 != null && !this.var_17.disposed)
         {
            this.var_17.addEventListener(WindowEvent.const_40,this.onScrollableResized);
            this.var_17.addEventListener(WindowEvent.const_568,this.onScrollableScrolled);
            this.updateLiftSizeAndPosition();
         }
      }
      ...
      override public function get properties() : Array
      {
         ...
         else if(this.var_1016 != null)
         {
            _loc2_ = this.var_1016;
         }
      ...
      override public function set properties(param1:Array) : void
      {
         ...
         while(_loc4_ < _loc2_)
         {
            ...
            {
               this.var_1016 = _loc3_.value as String;
               this.var_17 = null;
            }
            _loc4_++;
         }
      ...
      {
         return this.track.findChildByName(const_699) as WindowController;
      }
      ...
      override public function update(param1:WindowController, param2:WindowEvent) : Boolean
      {
         switch(param1.name)
         {
            case ScrollbarController.const_699:
         ...
         if(param1 == this)
         {
            ...
            else if(param2.type == WindowMouseEvent.const_345)
            {
      ...
      private function scrollButtonEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46 || param1.type == WindowTouchEvent.const_832)
         {
            ...
            else if(param2.name == const_1528)
            {
               if(this.var_17)
               {
                  this.var_1257 = true;
            ...
            else if(param2.name == const_1080)
            {
               ...
               _loc6_ = WindowController(param2).getChildByName(ScrollbarController.const_699).rectangle;
               if(this._horizontal)
               {
                  if(_loc4_ < _loc6_.x)
                  {
         ...
         if(param1.type == WindowMouseEvent.const_345)
         {
      ...
      private function resolveScrollTarget() : Boolean
      {
         ...
         {
            _loc1_ = findParentByName(this.var_1016) as IScrollableWindow;
            if(_loc1_ == null && _parent is IWindowContainer)
            {
               _loc1_ = IWindowContainer(_parent).findChildByName(this.var_1016) as IScrollableWindow;
               if(_loc1_)
               {
