package com.sulake.core.window.components
{
   ...
   public class ItemListController extends WindowController implements IItemListWindow, IInputProcessorRoot
   {
      ...
      protected var var_752:Number = -1.0;
      ...
      public function ItemListController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function = null, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         this._container = _context.create("_CONTAINER","",WindowType.const_399,WindowStyle.const_105,0 | 0 | 0,new Rectangle(0,0,width,height),null,this,0,null,[TAG_INTERNAL,TAG_EXCLUDE]) as IWindowContainer;
      ...
      {
         return new Rectangle(this.var_750 * this.maxScrollH,this.var_753 * this.maxScrollV,width,height);
      }
      ...
      public function set scrollH(param1:Number) : void
      {
         ...
         if(param1 != this.var_750)
         {
            ...
            _loc2_ = WindowEvent.allocate(WindowEvent.const_568,this,null);
      ...
      public function process(param1:WindowEvent) : Boolean
      {
         ...
         switch(param1.type)
         {
            ...
            case WindowMouseEvent.const_186:
               if(this.var_1427)
               {
                  this.var_1426 = this.var_2271 - _loc3_;
                  this.var_1425 = this.var_2272 - _loc4_;
                  if(this._horizontal)
                  {
      ...
      override public function get properties() : Array
      {
         ...
         if(this._spacing != PropertyDefaults.const_934)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_433,this._spacing,PropertyStruct.const_37,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1227);
         }
         if(this.var_1151 != PropertyDefaults.const_1284)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_864,this.var_1151,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1758);
         }
         if(this.var_512 != PropertyDefaults.const_1285)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_952,this.var_512,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1954);
         }
         if(this.var_1424 != PropertyDefaults.const_1198)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_803,this.var_1424,PropertyStruct.const_38,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1794);
         }
         if(this.var_752 != PropertyDefaults.const_1262)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_749,this.var_752,PropertyStruct.const_139,true));
         }
         else
         {
            _loc1_.push(PropertyDefaults.const_1737);
         }
         if(this.var_751 != PropertyDefaults.const_1175)
         {
            _loc1_.push(new PropertyStruct(PropertyDefaults.const_767,this.var_751,PropertyStruct.const_139,true));
         }
         else
         {
         ...
         for each(_loc2_ in param1)
         {
            switch(_loc2_.key)
            {
               ...
               case PropertyDefaults.const_749:
                  this.var_752 = _loc2_.value as Number;
                  break;
