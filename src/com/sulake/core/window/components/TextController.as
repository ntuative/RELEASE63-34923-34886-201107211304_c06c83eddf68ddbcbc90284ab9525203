package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      private var var_448:String = "regular";
      ...
      public function TextController(param1:String, param2:uint, param3:uint, param4:uint, param5:WindowContext, param6:Rectangle, param7:IWindow, param8:Function, param9:Array = null, param10:Array = null, param11:uint = 0)
      {
         ...
         setTextFormatting(this._field,this.var_448,this._explicitStyle);
      ...
      private static function setTextStyle(param1:TextController, param2:TextStyle) : void
      {
         ...
         if(_loc3_)
         {
            param1.var_448 = _loc3_.name;
            setTextFormatting(param1._field,param1.var_448,param1._explicitStyle);
            param1.refreshTextImage();
         }
      }
      ...
      protected static function setTextFormatting(param1:TextField, param2:String, param3:TextStyle) : void
      {
         ...
         {
            _loc5_.underline = _loc4_.textDecoration == TextStyle.const_820 ? true : null;
         }
      ...
      {
         return TextStyleManager.getStyle(this.var_448);
      }
      ...
      {
         return new Rectangle(this.var_932 * this.maxScrollH,this.var_605 * this.maxScrollV,width,height);
      }
      ...
      override public function get properties() : Array
      {
         ...
         var _loc2_:TextStyle = TextStyleManager.getStyle(this.var_448);
         ...
         _loc1_.push(new PropertyStruct(PropertyDefaults.const_977,this._field.antiAliasType,PropertyStruct.const_54,this._field.antiAliasType != _loc2_.antiAliasType,PropertyDefaults.const_1390));
         _loc1_.push(this._autoSize != PropertyDefaults.const_1323 ? new PropertyStruct(PropertyDefaults.const_1021,this._autoSize,PropertyStruct.const_54,true,PropertyDefaults.const_1201) : PropertyDefaults.const_1736);
         ...
         _loc1_.push(new PropertyStruct("font_size",this.defaultTextFormat.size,PropertyStruct.const_291,this.defaultTextFormat.size != _loc2_.fontSize));
         _loc1_.push(this._field.gridFitType != PropertyDefaults.const_1221 ? new PropertyStruct(PropertyDefaults.const_1222,this._field.gridFitType,PropertyStruct.const_54,true,PropertyDefaults.const_1400) : PropertyDefaults.const_2027);
         _loc1_.push((_loc2_.color != null ? this._field.textColor != _loc2_.color : this._field.textColor != PropertyDefaults.const_747) ? new PropertyStruct(PropertyDefaults.const_462,this._field.textColor,PropertyStruct.const_150,true) : PropertyDefaults.const_1223);
         _loc1_.push(this.var_448 != TextStyleManager.const_229 ? new PropertyStruct(PropertyDefaults.const_430,this.var_448,PropertyStruct.const_54,true,PropertyDefaults.const_962) : PropertyDefaults.const_1274);
         _loc1_.push(this.var_43.left != PropertyDefaults.const_903 ? new PropertyStruct(PropertyDefaults.const_280,this.var_43.left,PropertyStruct.const_37,true) : PropertyDefaults.const_799);
         _loc1_.push(this.var_43.top != PropertyDefaults.const_862 ? new PropertyStruct(PropertyDefaults.const_301,this.var_43.top,PropertyStruct.const_37,true) : PropertyDefaults.const_852);
         _loc1_.push(this.var_43.right != PropertyDefaults.const_890 ? new PropertyStruct(PropertyDefaults.const_259,this.var_43.right,PropertyStruct.const_37,true) : PropertyDefaults.const_783);
         _loc1_.push(this.var_43.bottom != PropertyDefaults.const_744 ? new PropertyStruct(PropertyDefaults.const_274,this.var_43.bottom,PropertyStruct.const_37,true) : PropertyDefaults.const_994);
         _loc1_.push(this._field.mouseWheelEnabled != PropertyDefaults.const_1246 ? new PropertyStruct(PropertyDefaults.const_859,this._field.mouseWheelEnabled,PropertyStruct.const_38,true) : PropertyDefaults.const_1805);
         ...
         _loc1_.push(new PropertyStruct("sharpness",this._field.sharpness,PropertyStruct.const_139,this._field.sharpness != 0));
         _loc1_.push(new PropertyStruct("thickness",this._field.thickness,PropertyStruct.const_139,this._field.thickness != 0));
         ...
         _loc1_.push(new PropertyStruct("spacing",this._field.defaultTextFormat.letterSpacing,PropertyStruct.const_139,this._field.defaultTextFormat.letterSpacing != 0));
         return _loc1_;
      }
   }
}
