   ...
   public class BitmapSkinRenderer extends SkinRenderer implements ISkinRenderer
   {
      ...
      override public function draw(param1:IWindow, param2:IBitmapDrawable, param3:Rectangle, param4:uint, param5:Boolean) : void
      {
         ...
         if(_loc7_ != null && _loc9_ > 0)
         {
            ...
            if(_loc16_)
            {
               this.var_823.redMultiplier = ((param1.color & 16711680) >> 16) / 255;
               this.var_823.greenMultiplier = ((param1.color & 65280) >> 8) / 255;
               this.var_823.blueMultiplier = (param1.color & 255) / 255;
            ...
            while(_loc17_ < _loc9_)
            {
               ...
               if(_loc11_ != null)
               {
                  ...
                  if(_loc16_ && _loc10_.colorize)
                  {
                     ...
                     _loc18_.colorTransform(_loc18_.rect,this.var_823);
                  }
                  _loc12_ = false;
                  _loc13_ = false;
                  ...
                  if(_loc10_.var_361 == SkinLayoutEntity.const_362)
                  {
                     REGION.x += _loc14_;
                  }
                  else if(_loc10_.var_361 == SkinLayoutEntity.const_543)
                  {
                     _loc12_ = true;
                  ...
                  else if(_loc10_.var_361 == SkinLayoutEntity.const_330)
                  {
                     _loc12_ = true;
                     REGION.right += _loc14_;
                     if(true)
                  ...
                  else if(_loc10_.var_361 == SkinLayoutEntity.const_557)
                  {
                     REGION.x = param3.width / 2 - 0;
                  }
                  if(_loc10_.var_360 == SkinLayoutEntity.const_362)
                  {
                     REGION.y += _loc15_;
                  }
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_543)
                  {
                     _loc13_ = true;
                  ...
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_330)
                  {
                     _loc13_ = true;
                     REGION.bottom += _loc15_;
                     if(true)
                  ...
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_557)
                  {
                  ...
                  else if(_loc10_.var_360 == SkinLayoutEntity.const_330 || _loc10_.var_361 == SkinLayoutEntity.const_330)
                  {
      ...
      protected function drawStaticLayoutEntity(param1:BitmapData, param2:Rectangle, param3:ISkinLayout, param4:SkinLayoutEntity, param5:ISkinTemplate, param6:ISkinTemplateEntity) : void
      {
         ...
         switch(param6.type)
         {
            case "bitmap":
               ...
               if(param4.var_361 == SkinLayoutEntity.const_362)
               {
                  _loc7_.x += param2.width - param3.width;
               }
               if(param4.var_360 == SkinLayoutEntity.const_362)
               {
