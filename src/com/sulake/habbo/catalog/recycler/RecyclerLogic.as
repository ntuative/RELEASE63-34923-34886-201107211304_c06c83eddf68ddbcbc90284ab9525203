package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      {
         return this.var_681 != const_1090;
      }
      
      private function get systemActive() : Boolean
      {
         return this.var_1958 != RecyclerStatusMessageEvent.const_1398;
      }
      
      private function get ready() : Boolean
      {
         return this.active && this.var_681 == const_481;
      }
      ...
      {
         this.var_681 = const_1091;
         this.var_135 = new Array(const_234);
         if(param1 == null)
         {
            return;
         }
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(this.var_1958)
         {
            case RecyclerStatusMessageEvent.const_2029:
               this.var_681 = const_481;
            ...
            case RecyclerStatusMessageEvent.const_1398:
               ...
               this._catalog.setupInventoryForRecycler(false);
               break;
            case RecyclerStatusMessageEvent.const_1803:
               if(this._view == null || this._view.disposed)
               {
                  return;
               }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_1299:
               if(this._view != null)
               {
                  this._view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_2018:
      ...
      private function isPoolFull() : Boolean
      {
         ...
         if(this.var_135.length < const_234)
         {
            return false;
         }
         var _loc1_:int = 0;
