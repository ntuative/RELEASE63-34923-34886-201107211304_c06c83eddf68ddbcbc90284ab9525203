package com.sulake.habbo.catalog.purchase
{
   ...
   public class PurchaseConfirmationDialog implements IGetImageListener, IDisposable
   {
      ...
      private const const_2342:int = 10;
      ...
      private const const_2073:uint = 4.293848814E9;
      
      private const const_2074:uint = 4.294967295E9;
      
      private const const_1476:uint = 4.291613146E9;
      ...
      public function onIsOfferGiftable(param1:IsOfferGiftableMessageParser) : void
      {
         ...
         if(this.var_1220 != param1.offerId)
         {
            return;
         }
      ...
      private function showGiftDialog() : void
      {
         ...
         if(_loc1_.isEnabled)
         {
            ...
            if(_loc12_ != null)
            {
               ...
               _loc12_.addEventListener(WindowEvent.const_571,this.onFreeWrappingUnSelect);
            }
            ...
            this.var_1842 = _loc1_.stuffTypes;
            this.var_817 = _loc1_.boxTypes;
            this.var_816 = _loc1_.ribbonTypes;
            this.var_1219 = this.var_1842[0];
            this.var_384 = this.var_817[0];
            this.var_383 = this.var_816[0];
            this.initColorGrid();
      ...
      private function updatePreview() : void
      {
         if(this.var_383 < 0)
         {
            this.var_383 = this.var_816.length - 1;
         }
         if(this.var_383 > this.var_816.length - 1)
         {
            this.var_383 = 0;
         }
         if(this.var_384 < 0)
         {
            this.var_384 = this.var_817.length - 1;
         }
         if(this.var_384 > this.var_817.length - 1)
         {
            this.var_384 = 0;
         }
         var _loc1_:int = this.var_817[this.var_384] * 1000 + this.var_816[this.var_383];
         if(this._window == null)
         {
            return;
         }
         ...
         var _loc2_:ImageResult = this._roomEngine.getFurnitureImage(this.var_1219,new Vector3d(180),64,this,0,_loc1_.toString());
         if(_loc2_ == null)
         {
            return;
         }
         this.var_1505 = _loc2_.id;
      ...
      private function initColorGrid() : void
      {
         ...
         for each(_loc3_ in this.var_1842)
         {
      ...
      private function giveGift() : void
      {
         ...
         var _loc7_:int = !!_loc6_ ? 0 : int(this.var_1219);
         var _loc8_:int = !!_loc6_ ? 0 : int(this.var_817[this.var_384]);
         var _loc9_:int = !!_loc6_ ? 0 : int(this.var_816[this.var_383]);
         this._catalog.purchaseProductAsGift(this.var_1504,this.var_1220,this.var_1503,_loc2_,_loc4_,_loc7_,_loc8_,_loc9_);
      }
      
      private function onBuyButtonClick(param1:WindowEvent) : void
      {
         this._catalog.purchaseProduct(this.var_1504,this.var_1220,this.var_1503);
         this.dispose();
      }
      ...
      private function onNameInputChange(param1:WindowEvent) : void
      {
         ...
         if(this.var_2469 == _loc2_.text)
         {
            return;
         }
         var _loc3_:String = _loc2_.text.toLowerCase();
         var _loc4_:* = [];
         for each(_loc5_ in this.var_255)
         {
            if(_loc5_.toLowerCase().search(_loc3_) != -1)
            {
               _loc4_.push(_loc5_);
            }
            if(_loc4_.length >= this.const_2342)
            {
               break;
            }
         }
         this.updateSuggestions(_loc4_);
         this.var_2469 = _loc2_.text;
      }
      ...
      private function onNameInputKeyUp(param1:WindowEvent) : void
      {
         ...
         {
            case Keyboard.UP:
               this.highlightSuggestion(this.var_382 - 1);
               break;
            case Keyboard.DOWN:
               this.highlightSuggestion(this.var_382 + 1);
               break;
      ...
      {
         if(this.var_277 == null || !this.var_277.visible)
         {
            return;
         }
         var _loc1_:IItemListWindow = this.var_277.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc1_ == null)
         {
            return;
         }
         var _loc2_:IWindowContainer = _loc1_.getListItemAt(this.var_382) as IWindowContainer;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function updateSuggestions(param1:Array) : void
      {
         ...
         if(this.var_277 == null)
         {
            this.var_277 = this._window.findChildByName("suggestion_container") as IWindowContainer;
         }
         if(this.var_818 == null)
         {
            this.var_818 = this.createWindow("suggestion_list_item") as IWindowContainer;
         }
         if(this.var_277 == null || this.var_818 == null)
         {
            return;
         }
         var _loc2_:IItemListWindow = this.var_277.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         {
            _loc5_ = this.var_818.clone() as IWindowContainer;
            if(_loc5_ != null)
            {
      ...
      private function onSuggestionsMouseOver(param1:WindowEvent) : void
      {
         ...
         var _loc3_:IItemListWindow = this.var_277.findChildByName("suggestion_list") as IItemListWindow;
         if(_loc3_ == null)
         {
            return;
         }
      ...
      private function highlightSuggestion(param1:int) : void
      {
         ...
         _loc3_ = _loc2_.getListItemAt(this.var_382) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.getColor(this.var_382);
         }
         this.var_382 = param1;
         if(this.var_382 < 0)
         {
            this.var_382 = _loc2_.numListItems - 1;
         }
         if(this.var_382 >= _loc2_.numListItems)
         {
            this.var_382 = 0;
         }
         _loc3_ = _loc2_.getListItemAt(this.var_382) as IWindowContainer;
         if(_loc3_ != null)
         {
            _loc3_.color = this.const_1476;
         }
      }
      
      private function getColor(param1:int) : uint
      {
         return param1 % 2 == 0 ? uint(this.const_2073) : uint(this.const_2074);
      }
      ...
      {
         this.var_1219 = param1.target.id;
         this.updateColorGrid();
         this.updatePreview();
      }
      ...
      private function updateColorGrid() : void
      {
         ...
         while(_loc4_ < _loc1_.numGridItems)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  _loc3_.visible = _loc2_.id == this.var_1219;
               }
            }
            _loc4_++;
         }
