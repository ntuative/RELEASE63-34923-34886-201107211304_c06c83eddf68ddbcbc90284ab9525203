package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog, IProductDataListener, IUpdateReceiver
   {
      ...
      private static const const_702:uint = 1;
      ...
      private var var_225:CatalogViewer;
      ...
      private var var_226:ChargeConfirmationDialog;
      ...
      private var var_2657:Boolean = true;
      
      private var var_2658:Boolean = true;
      
      private var var_1956:Boolean = false;
      
      private var var_2660:GiftWrappingConfiguration;
      
      private var var_1280:ClubGiftController;
      
      private var var_561:ClubBuyController;
      
      private var var_677:ClubExtendController;
      
      private var var_849:Map;
      
      private var var_1281:Boolean = false;
      
      private var var_848:IPurchasableOffer;
      ...
      private var var_678:RoomPreviewer;
      
      private const const_2071:Point = new Point(100,20);
      ...
      private function reset(param1:Boolean = false) : void
      {
         ...
         if(!param1)
         {
            ...
            {
               Core.crash("Could not reload product data after reset() because _sessionDataManager was null",Core.const_1957);
               return;
            }
      ...
      public function showPurchaseConfirmation(param1:IPurchasableOffer, param2:int, param3:String = "", param4:Boolean = true) : void
      {
         ...
         {
            this.var_561.showConfirmation(param1 as ClubBuyOfferData,param2);
         }
      }
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_2659 = this.isNewItemsNotificationEnabled();
      ...
      {
         if(this._roomEngine != null && this.var_134 != null && this.var_134.getKey("catalog.furniture.animation","HabboRoomUICom_jb_icon_disc") == "SetClothingChangeDataMessageComposer")
         {
            if(this.var_678 == null)
            {
               this.var_678 = new RoomPreviewer(this._roomEngine);
            }
         }
      }
      ...
      {
         return this.var_134.getBoolean("toolbar.new_additions.notification.enabled",false);
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         if(!this.var_835 || !this.var_254 || !this.var_254.isInitialized())
         {
            this.toggleCatalog(true);
            this.var_1033 = -1;
            this.var_847 = param1;
      ...
      public function openCreditsHabblet() : void
      {
         ...
         var _loc1_:* = this.var_134.getKey("client.credits.embed.enabled","HabboRoomUICom_jb_icon_disc") == "SetClothingChangeDataMessageComposer";
         if(false && _loc1_)
         {
         ...
         {
            _loc2_ = this.var_134.getKey("link.format.credits","/credits");
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return this.var_225.getCurrentLayoutCode();
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         this.var_225 = new CatalogViewer(this,_loc1_,this._roomEngine);
         this.var_225.habboCatalog = this;
      }
      
      private function createMainWindow() : void
      {
         var _loc1_:String = "catalog";
         if(this.var_134.getBoolean("catalog.show.purse",false))
         {
            _loc1_ = "catalog_with_purse";
         }
         var _loc2_:XmlAsset = assets.getAssetByName(_loc1_) as XmlAsset;
         this._mainContainer = this._windowManager.buildFromXML(_loc2_.content as XML,const_702) as IWindowContainer;
         this._mainContainer.tags.push("habbo_catalog");
         this._mainContainer.position = this.const_2071;
         this.hideMainWindow();
         ...
         _loc4_.setParamFlag(WindowParam.const_287,false);
      ...
      private function createClubGiftController() : void
      {
         ...
         {
            this.var_1280 = new ClubGiftController(this);
         }
      }
      ...
      private function createClubBuyController() : void
      {
         if(this.var_561 == null)
         {
            this.var_561 = new ClubBuyController(this);
         }
      }
      ...
      private function createClubExtendController() : void
      {
         if(this.var_677 == null)
         {
            this.var_677 = new ClubExtendController(this);
         }
      }
      ...
      private function onWindowClose(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_225 != null)
         {
            this.var_225.catalogWindowClosed();
         }
         if(this.var_107 != null && this.getCurrentLayoutCode() == "recycler")
         {
            this.var_107.cancel();
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         this.var_1568 = (param1 as CatalogIndexMessageEvent).newAdditionsAvailable;
         this.var_254.buildCatalogIndex(_loc2_);
         if(this.var_847 && this.var_847 != "")
         {
            this.var_254.openPage(this.var_847);
            this.var_847 = "";
            this.var_1033 = -1;
         }
         else if(this.var_1033 > -1)
         {
            this.var_254.openPageById(this.var_1033,this.var_1955);
            this.var_1033 = -1;
            this.var_1955 = -1;
            this.var_847 = "";
         }
         else if(this.var_1568 && this.var_2659)
         {
            events.dispatchEvent(new CatalogEvent(CatalogEvent.CATALOG_NEW_ITEMS_SHOW));
            this.var_254.loadNewAdditionsPage(this.getLocalizedPageName(CatalogPageName.const_1731));
         }
         else
         {
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         this.var_225.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers,_loc9_);
      }
      ...
      {
         if(param1 == null || this.var_225 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         this.var_225.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result,_loc2_.nameValidationInfo));
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2657 && this._soundManager != null)
         {
            this._soundManager.playSound(HabboSoundTypesEnum.const_1302);
         }
         this.var_2657 = false;
         if(this.var_226 != null && !this.var_226.disposed)
         {
            this.var_226.refresh();
         }
         events.dispatchEvent(new PurseEvent(PurseEvent.const_129,this.var_114.credits));
      ...
      private function onActivityPointNotification(param1:IMessageEvent) : void
      {
         ...
         this.updatePurse();
         if(!this.var_2658 && this._soundManager != null)
         {
         ...
         if(_loc2_.type == ActivityPointTypeEnum.const_985)
         {
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         this.var_114.isExpiring = _loc2_.responseType == ScrSendUserInfoMessageParser.const_1380 ? true : false;
         this.updatePurse();
      ...
      private function onClubGiftInfo(param1:ClubGiftInfoEvent) : void
      {
         ...
         this.var_1280.setInfo(_loc2_.daysUntilNextGift,_loc2_.giftsAvailable,_loc2_.offers,_loc2_.giftData);
      }
      ...
      private function onGiftWrappingConfiguration(param1:GiftWrappingConfigurationEvent) : void
      {
         ...
         this.var_2660 = new GiftWrappingConfiguration(param1);
      }
      ...
      private function onHabboClubOffers(param1:HabboClubOffersMessageEvent) : void
      {
         if(this.var_561 != null)
         {
            this.var_561.onOffers(param1);
         }
      }
      
      private function onHabboClubExtendOffer(param1:HabboClubExtendOfferMessageEvent) : void
      {
         if(this.var_677 != null && this.var_134.getBoolean("club.membership.extend.promotion.enabled",false))
         {
            this.var_677.onOffer(param1);
         }
      }
      ...
      private function onChargeInfo(param1:ChargeInfoMessageEvent) : void
      {
         ...
         if(this.var_226 == null || this.var_226.disposed)
         {
            this.var_226 = new ChargeConfirmationDialog(this,this._localization);
         }
         this.var_226.showChargeInfo(_loc2_);
      }
      ...
      private function onSellableBreeds(param1:SellablePetBreedsMessageEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            this.var_225.dispatchWidgetEvent(new CatalogWidgetSellablePetBreedsEvent(_loc2_.productCode,_loc3_.slice()));
         }
      }
      ...
      private function noCreditsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         {
            if(false && "SetClothingChangeDataMessageComposer" == this.var_134.getKey("client.credits.embed.enabled"))
            {
               ExternalInterface.call("FlashExternalInterface.openHabblet","credits");
            }
            else
            {
               _loc3_ = this.var_134.getKey("link.format.credits");
               if(_loc3_ != "")
               {
                  this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
      ...
      private function noPixelsConfirmDialogEventProcessor(param1:IConfirmDialog, param2:WindowEvent) : void
      {
         ...
         if(param2.type == WindowEvent.const_146)
         {
            _loc3_ = this.var_134.getKey("link.format.pixels");
            if(_loc3_ != "")
            {
               this._windowManager.alert("${catalog.alert.external.link.title}","${catalog.alert.external.link.desc}",0,this.onExternalLink);
               HabboWebTools.navigateToURL(_loc3_,"habboMain");
      ...
      {
         if(!this.var_134.keyExists("catalog.drag_and_drop") || this.var_134.getKey("catalog.drag_and_drop") != "SetClothingChangeDataMessageComposer")
         {
            return false;
         }
         ...
         switch(_loc2_.productType)
         {
            case ProductTypeEnum.const_195:
               _loc3_ = false;
               break;
            case ProductTypeEnum.const_381:
               _loc3_ = false;
         }
         return _loc3_;
      }
      ...
      {
         var _loc3_:String = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_232);
      ...
      private function onObjectPlaced(param1:RoomEngineObjectPlacedEvent) : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         if(this.var_1281 && param1.type == RoomEngineObjectEvent.const_162)
         {
            this.resetPlacedOfferData(true);
            if(this.var_848 == null || this.var_848.disposed)
            {
               this.resetObjectMover();
               return;
            }
            _loc2_ = param1.category;
            _loc3_ = this.var_848.productContainer.firstProduct;
            _loc4_ = false;
            ...
            this.var_66 = new PlacedObjectPurchaseData(param1.roomId,param1.roomCategory,param1.objectId,param1.category,param1.wallLocation,param1.x,param1.y,param1.direction,this.var_848);
            ...
            if(_loc6_)
            {
               _loc6_.getModelController().setNumber(RoomObjectVariableEnum.const_359,0.5);
            }
         }
      }
            ...
            if(this.var_66.roomCategory == this._roomEngine.activeRoomCategory && this.var_66.roomId == this._roomEngine.activeRoomId)
            {
               ...
               switch(param1.category)
               {
                  ...
                  case FurniCategory.const_367:
                     _loc9_ = this._roomEngine.getRoomStringValue(this._roomEngine.activeRoomId,this._roomEngine.activeRoomCategory,RoomObjectVariableEnum.const_232);
      ...
      private function retrievePreviewAsset(param1:String, param2:Function) : void
      {
         ...
         var _loc3_:String = this.var_134.getKey("image.library.catalogue.url");
      ...
      private function showMainWindow() : void
      {
         ...
         {
            _loc1_ = this._windowManager.getDesktop(const_702);
            if(_loc1_ != null)
            {
      ...
      public function update(param1:uint) : void
      {
         if(this.var_678 != null)
         {
            this.var_678.updatePreviewRoomView();
         }
      }
   }
}
