package com.sulake.habbo.catalog.navigation
{
   ...
   public class CatalogNodeRenderable extends CatalogNode
   {
      ...
      private static const const_1481:Number = 4285716709;
      ...
      private var var_1813:Number = 4.294967295E9;
      ...
      override public function activate() : void
      {
         ...
         if(_loc1_ != null)
         {
            if(this.var_1813 == 4294967295)
            {
               this.var_1813 = _loc1_.color;
            }
      ...
      override public function open() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_2032;
            }
         }
      }
      ...
      override public function close() : void
      {
         ...
         if(isBranch)
         {
            ...
            if(_loc1_ != null)
            {
               _loc1_.style = HabboIconType.const_2011;
            }
         }
      }
      ...
      {
         this.var_63 = navigator.catalog.windowManager.buildFromXML(var_1488) as IItemListWindow;
         if(this.var_63 == null)
         {
