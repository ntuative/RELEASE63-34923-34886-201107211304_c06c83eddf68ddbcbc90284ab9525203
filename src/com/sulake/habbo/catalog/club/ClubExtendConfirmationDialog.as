package com.sulake.habbo.catalog.club
{
   ...
   public class ClubExtendConfirmationDialog
   {
      ...
      private static const const_1659:String = "your_price_icon";
      
      private static const const_1661:String = "http://images.habbo.com/c_images/catalogue/vip_extend_tsr.png";
      
      private static const const_1658:String = "image/png";
      
      private static const const_1660:int = 2000;
      
      private static const const_1657:int = 75;
      ...
      private var var_708:IRegionWindow;
      ...
      public function ClubExtendConfirmationDialog(param1:ClubExtendController, param2:ClubOfferExtendData)
      {
         ...
         this.var_26 = param1;
         this.var_105 = param2;
         this.var_709 = new Vector.<BitmapData>(const_393);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_708)
         {
            this.var_708.removeEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
            this.var_708.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
            this.var_708 = null;
         }
         if(this.var_706)
         {
         ...
         if(this.var_709)
         {
            ...
            {
               this.var_709[_loc1_].dispose();
               this.var_709[_loc1_] = null;
               _loc1_++;
            }
            this.var_709 = null;
         }
      ...
      public function showConfirmation() : void
      {
         ...
         this.var_708 = this._view.findChildByName("maybe_later_region") as IRegionWindow;
         this.var_706 = this._view.findChildByName("maybe_later_link") as ITextWindow;
         if(!this.var_708 || !this.var_706)
         {
            return;
         }
         this.var_708.addEventListener(WindowMouseEvent.const_25,this.onMouseOutLaterRegion);
         this.var_708.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onMouseOverLaterRegion);
         ...
         _loc4_.height = 144;
         _loc4_.width = 133;
         this.loadAssetFromUrl("club_teaser","club_teaser",const_1661,const_1658,this.onTeaserLoaded);
         ...
         this.var_408 = this._view.findChildByName(const_1659) as IBitmapWrapperWindow;
         ...
         while(_loc8_ < const_393)
         {
            ...
            this.var_709[_loc8_] = _loc10_.clone();
            _loc8_++;
         }
         this.startAnimation();
      }
      ...
      private function onMouseOutLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_706)
         {
            this.var_706.textColor = const_2052;
         }
      }
      ...
      private function onMouseOverLaterRegion(param1:WindowMouseEvent) : void
      {
         if(this.var_706)
         {
            this.var_706.textColor = LINK_COLOR_HOVER;
         }
      }
      ...
      private function startAnimation() : void
      {
         ...
         this.var_885 = new Timer(const_1660);
         this.var_885.addEventListener(TimerEvent.TIMER,this.onAnimationTrigger);
         this.var_885.start();
      }
      ...
      private function setAnimationFrame() : void
      {
         ...
         if(this.var_707 < const_393)
         {
            this.var_408.bitmap = new BitmapData(this.var_408.width,this.var_408.height,true,0);
            this.var_408.bitmap.copyPixels(this.var_709[this.var_707],this.var_709[this.var_707].rect,new Point(0,0));
         }
         else
         {
            Logger.log("Animation frame " + this.var_707);
         }
      }
      
      private function startAnimationFrame() : void
      {
         this.var_482 = new Timer(const_1657,const_393 - 1);
         this.var_482.addEventListener(TimerEvent.TIMER,this.onAnimationFrame);
         this.var_482.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationFrameComplete);
         this.var_482.start();
      }
