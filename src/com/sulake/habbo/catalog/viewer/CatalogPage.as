package com.sulake.habbo.catalog.viewer
{
   ...
   public class CatalogPage implements ICatalogPage
   {
      ...
      private var var_591:EventDispatcher;
      
      private var _catalog:HabboCatalog;
      
      private var var_1365:ItemGridCatalogWidget;
      ...
      public function CatalogPage(param1:ICatalogViewer, param2:int, param3:String, param4:IPageLocalization, param5:Array, param6:HabboCatalog)
      {
         ...
         this.var_591 = new EventDispatcher();
      ...
      {
         return this._localization.getLinks(this.var_1364);
      }
      
      public function get hasLinks() : Boolean
      {
         return this._localization.hasLinks(this.var_1364);
      }
      ...
      protected function createWindow(param1:String) : Boolean
      {
         ...
         this.var_2276 = _loc3_.content as XML;
         this._window = this.viewer.catalog.windowManager.buildFromXML(this.var_2276) as IWindowContainer;
         if(this._window == null)
         {
      ...
      private function createWidget(param1:IWindowContainer) : void
      {
         ...
         switch(param1.name)
         {
            case CatalogWidgetEnum.const_1761:
               if(this.var_1365 == null)
               {
                  this.var_1365 = new ItemGridCatalogWidget(param1,this._catalog.sessionDataManager);
                  this.var_39.push(this.var_1365);
               }
               break;
            case CatalogWidgetEnum.const_1951:
            ...
            case CatalogWidgetEnum.const_1882:
               ...
               break;
            case CatalogWidgetEnum.const_1999:
      ...
      private function initializeWidgets() : void
      {
         ...
         this.var_591.dispatchEvent(new CatalogWidgetsInitializedEvent());
      }
      ...
      public function dispatchWidgetEvent(param1:Event) : Boolean
      {
         if(this.var_591 != null)
         {
            return this.var_591.dispatchEvent(param1);
         }
         return false;
      }
