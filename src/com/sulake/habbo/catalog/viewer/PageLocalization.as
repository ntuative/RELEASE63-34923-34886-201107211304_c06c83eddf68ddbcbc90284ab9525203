package com.sulake.habbo.catalog.viewer
{
   ...
   public class PageLocalization implements IPageLocalization
   {
      ...
      private static const const_1084:Object = {"frontpage3":[7,8]};
      
      private static const const_1085:Object = {"frontpage3":[["ctlg_txt1","ctlg_txt2"],["ctlg_txt3"]]};
      ...
      {
         if(param1 < this.var_842.length)
         {
            return this.var_842[param1];
         }
         return "";
      }
      ...
      public function getColorUintFromText(param1:int) : uint
      {
         ...
         if(param1 < this.var_842.length)
         {
            _loc2_ = String(this.var_842[param1]).replace("#","0x");
