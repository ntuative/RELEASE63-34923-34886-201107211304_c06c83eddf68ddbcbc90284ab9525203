package com.sulake.habbo.catalog.viewer
{
   ...
   public class ProductGridItem implements IGridItem
   {
      ...
      private static const const_1064:String = "bg";
       
      
      protected var _view:IWindowContainer;
      
      private var var_222:IItemGrid;
      ...
      {
         this._view.getChildByName(const_1064).style = HabboWindowStyle.const_30;
      }
      
      public function deActivate() : void
      {
         this._view.getChildByName(const_1064).style = 3;
      }
      ...
      public function setDraggable(param1:Boolean) : void
      {
         ...
         {
            (this._view as IInteractiveWindow).setMouseCursorForState(WindowState.const_89,MouseCursorType.const_993);
      ...
      private function eventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            this.var_222.select(this);
            this.var_547 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_547 != null && this.var_547 == param2)
         {
            _loc3_ = this.var_222.startDragAndDrop(this);
            if(_loc3_)
            {
               this.var_547 = null;
            }
