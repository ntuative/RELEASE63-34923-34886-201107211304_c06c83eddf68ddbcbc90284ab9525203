package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TrophyCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private static const const_1545:int = 13421772;
      
      private static const const_1546:int = 13395456;
      ...
      override public function init() : Boolean
      {
         ...
         _loc4_ = this.var_285.getWithIndex(this.var_339);
         if(_loc4_ != null)
         {
            _loc3_ = _loc4_.getValue(this.var_840);
            if(_loc3_ == null)
            {
      ...
      private function onColourIndex(param1:CatalogWidgetColourIndexEvent) : void
      {
         ...
         var _loc2_:Map = this.var_285.getWithIndex(this.var_339);
         if(_loc2_ != null)
         {
            _loc3_ = _loc2_.getValue(this.var_840);
            if(_loc3_ == null)
            {
      ...
      private function onClickNext(param1:WindowMouseEvent) : void
      {
         var _loc3_:* = null;
         ++this.var_339;
         if(this.var_339 >= this.var_285.length)
         {
            this.var_339 = 0;
         }
         var _loc2_:Map = this.var_285.getWithIndex(this.var_339);
      ...
      private function onClickPrev(param1:WindowMouseEvent) : void
      {
         ...
         if(this.var_339 < 0)
         {
            this.var_339 = this.var_285.length - 1;
         }
         var _loc2_:Map = this.var_285.getWithIndex(this.var_339);
         if(_loc2_ != null)
         {
