   ...
   public class MarketPlaceOwnItemsCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      override public function init() : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1308.add(MarketPlaceOfferState.const_1293,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1308.add(MarketPlaceOfferState.const_517,_loc2_);
            }
         }
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc2_)
            {
               this.var_1308.add(MarketPlaceOfferState.const_1342,_loc2_);
            }
         }
      ...
      private function updateList(param1:Map) : void
      {
         ...
         while(_loc7_ < _loc6_.length)
         {
            ...
            if(_loc11_.status == MarketPlaceOfferState.const_517)
            {
               _loc5_++;
            }
            _loc4_ = this.var_1308.getValue(_loc11_.status);
            if(_loc4_)
            {
               ...
               if(!(!_loc12_ || _loc12_.disposed))
               {
                  ...
                  if(_loc11_.status == MarketPlaceOfferState.const_1342)
                  {
