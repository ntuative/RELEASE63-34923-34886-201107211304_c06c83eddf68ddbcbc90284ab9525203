package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_1047.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
            this.var_1047 = null;
         }
         if(this.var_1046 != null)
         {
            this.var_1046.removeEventListener(WindowKeyboardEvent.const_191,this.windowKeyEventProcessor);
            this.var_1046 = null;
         }
      }
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1047 = _window.findChildByName("redeem") as IButtonWindow;
         if(this.var_1047 != null)
         {
            this.var_1047.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onRedeem);
         }
         this.var_1046 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(this.var_1046 != null)
         {
            this.var_1046.addEventListener(WindowKeyboardEvent.const_191,this.windowKeyEventProcessor);
         }
         return true;
      }
