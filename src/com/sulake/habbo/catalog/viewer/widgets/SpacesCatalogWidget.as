package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class SpacesCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private static const const_115:String = "floor";
      ...
      private var var_1450:String = "default";
      ...
      private var var_1451:String = "1.1";
      ...
      override public function init() : Boolean
      {
         ...
         this.var_959 = this.parseElements(_loc2_.floors.pattern);
         this.var_1167 = this.parseElements(_loc2_.walls.pattern);
         this.var_1168 = this.parseElements(_loc2_.landscapes.pattern);
         for each(_loc3_ in page.offers)
         {
            ...
            {
               case "floor":
                  for(_loc10_ in this.var_959)
                  {
                     _loc11_ = this.var_959[_loc10_];
                     if(this.var_621.indexOf(_loc10_) == -1)
                     {
                        this.var_621.push(_loc10_);
                        this.var_1170.push(_loc3_);
                     }
                  }
                  break;
               case "wallpaper":
                  if(this.var_1167[_loc8_] != null)
                  {
                  ...
                  break;
               case "landscape":
                  if(this.var_1168[_loc8_] != null)
                  {
                     this.var_766.push(_loc8_);
         ...
         this.changePattern(const_115,0);
         this.changePattern(const_237,0);
         this.changePattern(TYPE_LANDSCAPE,0);
         this.updateConfiguration();
         events.dispatchEvent(new CatalogWidgetUpdateRoomPreviewEvent(this._floorType,this.var_1450,this.var_1451,64));
         return true;
      }
      ...
      private function onClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc2_.name)
         {
            ...
            case "ctlg_wall_color_next":
               ...
               break;
            case "ctlg_buy_wall":
               _loc3_ = this.var_1169[this.var_446];
               if(_loc3_ != null)
               {
                  (page.viewer.catalog as HabboCatalog).showPurchaseConfirmation(_loc3_,page.pageId,this.var_1450);
               }
               break;
            case "ctlg_floor_pattern_prev":
               this.changePattern(const_115,-1);
               break;
            case "ctlg_floor_pattern_next":
               this.changePattern(const_115,1);
               break;
            case "ctlg_floor_color_prev":
               this.changeColor(const_115,-1);
               break;
            case "ctlg_floor_color_next":
               this.changeColor(const_115,1);
               break;
            case "ctlg_buy_floor":
               _loc3_ = this.var_1170[this.var_441];
               if(_loc3_ != null)
               {
      ...
      private function updateConfiguration() : void
      {
         ...
         var _loc2_:String = this.var_621[this.var_441];
         var _loc3_:Array = this.var_959[_loc2_];
         ...
         var _loc4_:Offer = this.var_1170[this.var_441];
         if(_loc4_ != null)
         {
         ...
         var _loc5_:String = this.var_767[this.var_446];
         var _loc6_:Array = this.var_1167[_loc5_];
         if(_loc6_ != null && this.var_445 >= 0)
         {
            _loc13_ = _loc6_[this.var_445];
            if(_loc13_ != null)
            {
               this.var_1450 = _loc13_;
            }
         }
         var _loc7_:Offer = this.var_1169[this.var_446];
         if(_loc7_ != null)
         {
         ...
         var _loc8_:String = this.var_766[this.var_444];
         var _loc9_:Array = this.var_1168[_loc8_];
         if(_loc9_ != null && this.var_443 >= 0)
         {
            _loc15_ = _loc9_[this.var_443];
            if(_loc15_ != null)
            {
               this.var_1451 = _loc15_;
            }
         }
      ...
      private function changePattern(param1:String, param2:int) : void
      {
         ...
         switch(param1)
         {
            case const_115:
               ...
               if(this.var_441 < 0)
               {
                  this.var_441 = this.var_621.length - 1;
               }
               if(this.var_441 >= this.var_621.length)
               {
                  this.var_441 = 0;
               }
               this.var_442 = 0;
               this.var_961 = 0;
               _loc5_ = this.var_621[this.var_441];
               _loc6_ = this.var_959[_loc5_];
               if(_loc6_ != null)
               {
                  this.var_961 = _loc6_.length;
               }
            ...
            case const_237:
               ...
               if(this.var_446 < 0)
               {
                  this.var_446 = this.var_767.length - 1;
               }
               if(this.var_446 == this.var_767.length)
               {
                  this.var_446 = 0;
               }
               this.var_445 = 0;
               this.var_962 = 0;
               _loc7_ = this.var_767[this.var_446];
               _loc8_ = this.var_1167[_loc7_];
               if(_loc8_ != null)
               {
                  this.var_962 = _loc8_.length;
               }
            ...
            case TYPE_LANDSCAPE:
               ...
               if(this.var_444 < 0)
               {
                  this.var_444 = this.var_766.length - 1;
               }
               if(this.var_444 >= this.var_766.length)
               {
                  this.var_444 = 0;
               }
               this.var_443 = 0;
               this.var_960 = 0;
               _loc9_ = this.var_766[this.var_444];
               _loc10_ = this.var_1168[_loc9_];
               if(_loc10_ != null)
               {
                  this.var_960 = _loc10_.length;
               }
