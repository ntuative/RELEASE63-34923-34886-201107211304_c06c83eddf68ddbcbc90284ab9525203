package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class MarketPlaceCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener, IMarketPlaceVisualization
   {
      ...
      private const const_2374:int = 40;
      
      private const const_2373:int = 10;
      
      private var var_902:Array;
      
      private var var_1658:MarketPlaceOfferData;
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_589)
         {
            this.var_589.removeEventListener(TimerEvent.TIMER,this.onPopulationTimer);
            this.var_589 = null;
         }
      }
      ...
      private function selectSearchCategory(param1:String) : void
      {
         ...
         switch(param1)
         {
            ...
            case "search_by_activity":
               _loc5_ = "marketplace_search_simple";
               this.var_902 = [3,4,5,6];
               break;
            case "search_advanced":
               _loc5_ = "marketplace_search_advanced";
               this.var_902 = [1,2,3,4,5,6];
               break;
            default:
               return;
         }
         ...
         if(_loc7_ != null)
         {
            _loc7_.populate(this.getSortKeys(this.var_902));
            _loc7_.selection = 0;
         }
      }
      ...
      private function updateList() : void
      {
         ...
         if(!this.var_721)
         {
            ...
            this.var_721 = _loc5_.buildFromXML(_loc4_) as IWindowContainer;
         }
         if(!this.var_721)
         {
            return;
         ...
         if(!this.var_589)
         {
            this.var_589 = new Timer(25);
            this.var_589.addEventListener(TimerEvent.TIMER,this.onPopulationTimer);
         }
         this.var_1356 = 0;
         this.populateList();
         this.var_589.start();
      ...
      private function populateList() : Boolean
      {
         ...
         while(_loc1_ < 5)
         {
            if(this.var_1356 >= this._offers.length)
            {
               return true;
            }
            this.addListItem(this._offers.getWithIndex(this.var_1356));
            ++this.var_1356;
            _loc1_++;
         }
         return false;
      ...
      private function addListItem(param1:MarketPlaceOfferData) : void
      {
         ...
         var _loc10_:* = null;
         var _loc11_:* = null;
         if(!param1 || !this._itemList || !this.var_721 || !this.marketPlace.localization)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_721.clone() as IWindowContainer;
      ...
      private function doSearch() : void
      {
         ...
         if(_loc6_ && _loc6_.selection >= 0 && _loc6_.selection < this.var_902.length)
         {
            _loc4_ = this.var_902[_loc6_.selection];
         }
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               case "back_button":
                  ...
                  break;
               case "buy_button":
                  this.marketPlace.buyOffer(this.var_1658.offerId);
            }
            return;
         }
         if(param1.type == WindowEvent.const_48)
