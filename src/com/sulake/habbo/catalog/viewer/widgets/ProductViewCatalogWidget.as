package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private var var_570:IDisplayObjectWrapper;
      
      private var var_1988:Point;
      
      private var var_571:IItemGridWindow;
      
      private var var_1588:IScrollbarWindow;
      ...
      override public function init() : Boolean
      {
         ...
         this.var_1298 = _window.findChildByName("ctlg_description") as ITextWindow;
         ...
         if(this.var_200 != null)
         {
            ...
            this.var_570 = this.var_200.findChildByName("room_canvas") as IDisplayObjectWrapper;
            _loc3_ = (page.viewer.catalog as HabboCatalog).roomPreviewer;
            if(this.var_570 != null && _loc3_ != null)
            {
               this.var_200.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onClickRoomView);
               _loc3_.reset();
               _loc4_ = _loc3_.getRoomCanvas(this.var_570.width,this.var_570.height);
               if(_loc4_ != null)
               {
                  this.var_570.setDisplayObject(_loc4_);
               }
            }
            else
            {
         ...
         this.var_1988 = new Point(this.var_100.x,this.var_100.y);
         this.var_571 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         this.var_1588 = _window.findChildByName("bundleGridScrollbar") as IScrollbarWindow;
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         this.var_1298.text = _loc5_;
         this.var_1049.height = this.var_1049.textHeight + 5;
         this.var_1298.y = this.var_1049.y + this.var_1049.height;
         this.var_1298.height = Math.max(130,this.var_1298.textHeight + 5);
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_544:
                  ...
                  if(this.var_571 != null)
                  {
                     ...
                     _loc11_.populateItemGrid(this.var_571,this.var_1588,this.var_1791);
               ...
               case Offer.const_435:
                  ...
                  if(this.var_200 != null)
                  {
                     if(_loc9_.productType == ProductTypeEnum.const_79 || _loc9_.productType == ProductTypeEnum.const_63 || _loc9_.productType == ProductTypeEnum.const_195)
                     {
                  ...
                  switch(_loc9_.productType)
                  {
                     case ProductTypeEnum.const_79:
                        if(_loc8_ != null && this.var_570 != null)
                        {
                        ...
                        else
                        {
                           ...
                           if(_loc17_.avatarRenderManager != null)
                           {
                              ...
                              if(_loc18_ != null)
                              {
                                 ...
                                 _loc18_.appendAction(AvatarAction.const_384,AvatarAction.const_620);
                                 _loc18_.appendAction(AvatarAction.const_339,_loc9_.productClassId);
      ...
      {
         var _loc1_:* = null;
         for each(_loc1_ in this.var_2697)
         {
            _window.removeChild(_loc1_);
            _loc1_.dispose();
            _loc1_ = null;
         }
         this.var_2697 = new Array();
      }
      ...
      private function setPreviewImage(param1:BitmapData, param2:Boolean, param3:Point = null) : void
      {
         ...
         if(this.var_100 != null && true)
         {
            ...
            this.var_100.x = this.var_1988.x;
            this.var_100.y = this.var_1988.y;
            if(param3 != null)
            {
