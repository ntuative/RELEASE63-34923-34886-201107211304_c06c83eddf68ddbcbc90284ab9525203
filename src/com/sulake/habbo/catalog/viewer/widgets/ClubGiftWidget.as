package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ClubGiftWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function updateInfo() : void
      {
         ...
         if(_loc6_)
         {
            _loc2_ = this.var_26.purse.pastVipDays >= this.const_238 ? "catalog.club_gift.past_vip.long" : "catalog.club_gift.past_vip";
            _loc3_ = this.var_26.purse.pastVipDays % this.const_238;
            _loc4_ = this.var_26.purse.pastVipDays / this.const_238;
            this.var_26.localization.registerParameter(_loc2_,"days",_loc3_.toString());
            this.var_26.localization.registerParameter(_loc2_,"months",_loc4_.toString());
      ...
      private function updateList() : void
      {
         ...
         var _loc3_:Map = this.var_26.method_8();
         if(!_loc3_)
         {
            return;
         }
