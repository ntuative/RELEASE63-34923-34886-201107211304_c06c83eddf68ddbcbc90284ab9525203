package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements ISideContentView
   {
      ...
      private var var_954:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel)
      {
         ...
         this.var_954 = this._window.findChildByName("hc_slots") as IItemListWindow;
         this.var_1165 = this._window.findChildByName("vip_slots") as IItemListWindow;
      ...
      public function update() : void
      {
         ...
         if(this.var_954)
         {
            this.var_954.removeListItems();
         }
         if(this.var_1165)
         {
            this.var_1165.removeListItems();
         }
         ...
         while(_loc3_ < _loc1_.length)
         {
            ...
            if(_loc3_ < 5)
            {
               if(this.var_954)
               {
                  this.var_954.addListItem(_loc2_.view);
                  _loc2_.view.visible = true;
               }
            }
            else if(this.var_1165)
            {
               this.var_1165.addListItem(_loc2_.view);
               _loc2_.view.visible = true;
            }
            _loc3_++;
         }
