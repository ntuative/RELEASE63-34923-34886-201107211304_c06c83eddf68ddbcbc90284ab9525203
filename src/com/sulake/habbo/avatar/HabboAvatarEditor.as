package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor
   {
      ...
      private static const const_1451:String = "hr-100.hd-180-7.ch-215-66.lg-270-79.sh-305-62.ha-1002-70.wa-2007";
      
      private static const const_1450:String = "hr-515-33.hd-600-1.ch-635-70.lg-716-66-62.sh-735-68";
      ...
      private var var_521:HabboAvatarEditorManager;
      ...
      private var var_1166:IHabboAvatarEditorDataSaver = null;
      ...
      public function HabboAvatarEditor(param1:uint, param2:HabboAvatarEditorManager)
      {
         ...
         this.var_521 = param2;
         this.var_958 = this.var_521.avatarRenderManager.getFigureData(AvatarType.const_128);
      }
      ...
      private function init(param1:Array = null) : void
      {
         ...
         this.var_620["null"] = new FigureData(this);
         this.var_620["null"] = new FigureData(this);
         var _loc2_:FigureData = this.var_620["null"];
         var _loc3_:FigureData = this.var_620["null"];
         _loc2_.loadAvatarData(const_1451,FigureData.const_93);
         _loc3_.loadAvatarData(const_1450,FigureData.FEMALE);
         ...
         this.var_119.add(AvatarEditorFigureCategory.const_263,new TorsoModel(this));
         this.var_119.add(AvatarEditorFigureCategory.const_894,new LegsModel(this));
         ...
         this.var_520.add(AvatarEditorSideCategory.const_113,new WardrobeModel(this));
         this.var_520.add(AvatarEditorSideCategory.const_577,new ClubPromoModel(this));
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:int = 0) : void
      {
         ...
         if(this.var_765 != param3)
         {
            this.var_765 = param3;
            _loc4_ = true;
         }
         var _loc5_:FigureData = this.var_620[param2];
         if(_loc5_ == null)
         {
            return;
         }
      ...
      {
         return this.var_620[this.var_1087];
      }
      ...
      public function saveCurrentSelection() : void
      {
         ...
         {
            this.var_1166.saveFigure(_loc1_,_loc2_);
         }
         else
         {
            _loc3_ = new UpdateFigureDataMessageComposer(_loc1_,_loc2_);
            this.var_521.communication.getHabboMainConnection(null).send(_loc3_);
            _loc3_.dispose();
            _loc3_ = null;
         }
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc8_ != null)
         {
            ...
            _loc12_ = this.isClubTryoutAllowed() && this.var_1738;
            for each(_loc13_ in _loc9_.colors)
            {
               if(_loc13_.isSelectable && (_loc12_ || this.var_765 >= _loc13_.clubLevel))
               {
                  _loc17_ = 0;
                  while(_loc17_ < const_682)
                  {
            ...
            {
               _loc20_ = 2;
               _loc14_ = this.var_521.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,_loc20_);
            }
            else
            {
               _loc14_ = this.var_521.avatarRenderManager.getMandatoryAvatarPartSetIds(this.gender,this.clubMemberLevel);
            }
            _loc15_ = Boolean(_loc14_.indexOf(param2) == -1);
            if(_loc15_)
            {
               _loc21_ = this.var_521.assets.getAssetByName("removeSelection") as BitmapDataAsset;
               if(_loc21_)
               {
            ...
            for each(_loc6_ in _loc8_.partSets)
            {
               ...
               if(_loc6_.isSelectable && _loc23_ && (_loc12_ || this.var_765 >= _loc6_.clubLevel))
               {
      ...
      {
         return this.var_521.configuration.getBoolean("avatareditor.allowclubtryout",false);
      }
      ...
      public function getDefaultColour(param1:String) : int
      {
         ...
         if(_loc2_ != null)
         {
            ...
            {
               if(_loc4_.isSelectable && this.var_765 >= _loc4_.clubLevel)
               {
                  return _loc4_.id;
               }
            }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return this.var_520.getValue(AvatarEditorSideCategory.const_113);
      }
