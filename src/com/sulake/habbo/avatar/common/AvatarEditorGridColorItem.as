package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridColorItem
   {
      ...
      public function AvatarEditorGridColorItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IPartColor)
      {
         ...
         this.var_957 = _loc6_.content as BitmapData;
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc3_ != null)
         {
            if(this._isSelected)
            {
               _loc3_.bitmap = new BitmapData(this.var_957.width,this.var_957.height,true,16777215);
               _loc3_.bitmap.copyPixels(this.var_957,this.var_957.rect,new Point(0,0),null,null,true);
               _loc3_.visible = true;
            }
            else
            {
            ...
            if(this.var_999)
            {
               switch(this.var_999.clubLevel)
               {
                  ...
                  case HabboClubLevelEnum.const_35:
                     _loc4_.style = HabboIconType.const_1028;
                     _loc4_.visible = true;
                     break;
