package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridPartItem implements IAvatarImageListener
   {
      ...
      private var var_829:IFigurePartSet;
      ...
      private const const_2346:int = 13421772;
      
      private const const_2345:int = 16777215;
      ...
      public function AvatarEditorGridPartItem(param1:IWindowContainer, param2:IAvatarEditorCategoryModel, param3:IFigurePartSet, param4:Array, param5:Boolean = true)
      {
         ...
         if(param3 == null)
         {
            this.var_755 = new BitmapData(1,1,true,16777215);
         }
         if(param3 != null)
         {
            _loc7_ = param3.parts;
            ...
            {
               this.var_1885 = Math.max(this.var_1885,_loc6_.colorLayerIndex);
            }
         }
         this.var_464 = this.var_78.controller.manager.avatarRenderManager;
      ...
      private function updateThumbVisualization() : void
      {
         ...
         if(_loc1_)
         {
            if(this.var_755 != null && !this.var_1886)
            {
               _loc3_ = this.var_755;
            }
            else
         ...
         if(this.isSelected)
         {
            this.var_1525.color = this.const_2346;
         }
         else
         {
            this.var_1525.color = this.const_2345;
         }
      ...
      private function analyzePartLayers() : Boolean
      {
         ...
         for each(_loc2_ in this.partSet.parts)
         {
            if(_loc7_)
            {
               _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + this.const_390[_loc6_] + "_" + FigureData.const_167;
      ...
      private function renderThumb() : BitmapData
      {
         ...
         for each(_loc2_ in _loc8_)
         {
            ...
            if(_loc4_)
            {
               ...
               if(this.var_1886 && _loc2_.colorLayerIndex > 0)
               {
