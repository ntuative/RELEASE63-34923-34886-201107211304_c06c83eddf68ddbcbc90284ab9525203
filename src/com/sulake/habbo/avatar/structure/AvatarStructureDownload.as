package com.sulake.habbo.avatar.structure
{
   ...
   public class AvatarStructureDownload extends EventDispatcher
   {
      ...
      public static const const_1255:String = "AVATAR_STRUCTURE_DONE";
       
      
      private var var_2784:IStructureData;
      ...
      private function onDataComplete(param1:Event) : void
      {
         ...
         this.var_2784.appendXML(this.var_2028);
         dispatchEvent(new Event(AvatarStructureDownload.const_1255));
      }
