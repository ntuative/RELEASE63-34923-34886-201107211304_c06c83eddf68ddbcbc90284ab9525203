package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      {
         super();
         this.var_2169 = parseInt(param1.@ink);
         var _loc2_:String = String(param1.@foreground);
         _loc2_ = _loc2_.replace("#","");
         var _loc3_:String = String(param1.@background);
         _loc3_ = _loc3_.replace("#","");
         this.var_2985 = parseInt(_loc2_,16);
         this.var_2986 = parseInt(_loc3_,16);
         ...
         this.var_823 = new ColorTransform(this.var_2113,this.var_2111,this.var_2112,this._alphaMultiplier);
         this.var_1385 = this.generatePaletteMapForGrayscale(this.var_2986,this.var_2985);
      }
      ...
      {
         return this.var_1385.getValue("reds") as Array;
      }
      
      public function get greens() : Array
      {
         return this.var_1385.getValue("greens") as Array;
      }
      
      public function get blues() : Array
      {
         return this.var_1385.getValue("blues") as Array;
      }
      
      public function get alphas() : Array
      {
         return this.var_1385.getValue("alphas") as Array;
      }
