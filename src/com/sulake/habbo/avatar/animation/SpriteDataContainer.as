package com.sulake.habbo.avatar.animation
{
   public class SpriteDataContainer implements ISpriteDataContainer
   {
      ...
      public function SpriteDataContainer(param1:IAnimation, param2:XML)
      {
         ...
         this.var_2169 = parseInt(param2.@ink);
         this.var_2811 = String(param2.@member);
         this.var_2810 = Boolean(parseInt(param2.@directions));
         this._dx = [];
         this.var_1609 = [];
         this.var_1608 = [];
         for each(_loc3_ in param2.direction)
         {
            ...
            this.var_1608[_loc4_] = parseInt(_loc3_.@dz);
         }
      }
      ...
      {
         if(param1 < this.var_1608.length)
         {
            return this.var_1608[param1];
         }
         return 0;
      }
