package com.sulake.habbo.avatar
{
   ...
   public class AvatarImage implements IAvatarImage, IDisposable
   {
      ...
      private static const const_1681:String = "Default";
      
      private static const const_1680:int = 2;
      
      private static const const_1682:String = AvatarSetType.const_41;
      ...
      private var var_2932:String = null;
      ...
      public function AvatarImage(param1:AvatarStructure, param2:AssetAliasCollection, param3:AvatarFigureContainer, param4:String)
      {
         ...
         this.setDirection(const_1682,const_1680);
         this.var_364 = new Array();
         this.var_1104 = new ActiveActionData(AvatarAction.const_437);
         this.var_1104.definition = this._structure.getActionDefinition(const_1681);
         this.resetActions();
      ...
      {
         return this._structure.getPartColor(this.var_710,param1);
      }
      
      public function setDirection(param1:String, param2:int) : void
      {
         param2 += this.var_2127;
         if(param2 < AvatarDirectionAngle.const_1383)
         {
            param2 = AvatarDirectionAngle.const_346 + (param2 + 1);
         }
         if(param2 > AvatarDirectionAngle.const_346)
         {
            param2 -= NaN;
         }
         ...
         if(param1 == AvatarSetType.const_57 || param1 == AvatarSetType.const_41)
         {
      ...
      {
         return this._structure.getBodyPartData(param1.animation.id,this.var_718,param1.id);
      }
      ...
      private function getFullImageCacheKey() : String
      {
         ...
         if(this.var_303.length == 1 && this.var_103 == this.var_1980)
         {
            return this.var_103 + this.var_588 + this.var_718 % 4;
         }
         if(this.var_303.length == 2)
         {
            for each(_loc1_ in this.var_303)
            {
               ...
               {
                  _loc2_ = this.var_718 % 11;
                  return this.var_103 + "_" + this.var_1980 + this.var_588 + _loc2_;
               }
            }
         }
         return null;
      ...
      {
         if(param3 != this.var_2933 || param2 != this.var_2931 || param1 != this.var_2932)
         {
            this.var_2933 = param3;
            this.var_2931 = param2;
            this.var_2932 = param1;
            this.var_2131 = this._structure.getBodyParts(param1,param2,param3);
         }
      ...
      public function getImage(param1:String, param2:Boolean) : BitmapData
      {
         ...
         if(this.var_1431 || this.var_47 == null || (this.var_47.width != _loc5_.width || this.var_47.height != _loc5_.height))
         {
            if(this.var_47 != null && !this.var_1431)
            {
               this.var_47.dispose();
            }
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc9_ = _loc4_.getImageContainer(_loc8_,this.var_718);
      ...
      public function getCroppedImage(param1:String) : BitmapData
      {
         ...
         while(_loc12_ >= 0)
         {
            ...
            _loc8_ = _loc2_.getImageContainer(_loc7_,this.var_718);
            if(_loc8_ != null)
            {
               _loc9_ = _loc8_.image;
               if(_loc9_ == null)
      ...
      protected function addActionData(param1:String, param2:String = "") : void
      {
         ...
         this.var_364.push(new ActiveActionData(param1,param2,this.var_718));
      }
      ...
      private function resetActions() : Boolean
      {
         ...
         this.var_317 = this.var_1104;
         this.var_317.definition = this.var_1104.definition;
      ...
      private function sortActions() : Boolean
      {
         ...
         var _loc1_:Boolean = false;
         this.var_588 = "";
         this.var_303 = this._structure.sortActions(this.var_364);
         if(this.var_303 == null)
         {
            this.var_925 = new Array(0,0,0);
            if(this.var_1352 != "")
            {
               _loc1_ = true;
               this.var_1352 = "";
         ...
         {
            this.var_925 = this._structure.getCanvasOffsets(this.var_303,this._scale,this.var_103);
            for each(_loc4_ in this.var_303)
            {
            ...
            if(this.var_1352 != this.var_588)
            {
               _loc1_ = true;
               this.var_1352 = this.var_588;
            }
         }
         this.var_1645 = true;
         return _loc1_;
         ...
         for each(_loc1_ in this.var_303)
         {
            if(!(!_loc1_ || !_loc1_.definition))
            {
               ...
               if(_loc1_.definition.isAnimation)
               {
                  ...
                  if(_loc2_ != null)
                  {
                     this.var_216 = this.var_216.concat(_loc2_.spriteData);
                     if(_loc2_.hasDirectionData())
                     {
                        this.var_2127 = _loc2_.directionData.offset;
                     }
               ...
               if(_loc1_.actionType == AvatarAction.const_366 || _loc1_.actionType == AvatarAction.const_272 || _loc1_.actionType == AvatarAction.const_426)
               {
                  this.var_969 = true;
               }
            }
