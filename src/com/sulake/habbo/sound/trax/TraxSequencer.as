package com.sulake.habbo.sound.trax
{
   ...
   public class TraxSequencer implements IHabboSound, IDisposable
   {
      ...
      private static const const_1145:uint = 88000;
      
      private static const const_719:uint = 88000;
      ...
      private var var_1108:Sound;
      
      private var var_496:SoundChannel;
      
      private var var_495:TraxData;
      ...
      private var var_723:Boolean = true;
      ...
      {
         this.var_1661 = uint(30);
         super();
         this._events = param4;
         this.var_1663 = param1;
         this.var_1064 = 1;
         this.var_1108 = new Sound();
         this.var_496 = null;
      ...
      {
         this.var_187 = uint(param1 * const_120);
      }
      ...
      {
         return this.var_493 / const_120;
      }
      
      public function set fadeOutSeconds(param1:Number) : void
      {
         this.var_493 = int(param1 * const_120);
      }
      
      public function get fadeInSeconds() : Number
      {
         return this.var_903 / const_120;
      }
      
      public function set fadeInSeconds(param1:Number) : void
      {
         this.var_903 = int(param1 * const_120);
      }
      ...
      public function set volume(param1:Number) : void
      {
         ...
         {
            this.var_496.soundTransform = new SoundTransform(this.var_1064);
         }
      }
      
      public function get length() : Number
      {
         return this.var_305 / const_120;
      }
      ...
      public function prepare() : Boolean
      {
         ...
         if(!this.var_1662)
         {
            ...
            {
               this.var_1666 = false;
               if(this.var_495.hasMetaData)
               {
                  this.var_1666 = this.var_495.metaCutMode;
               }
               if(this.var_1666)
               {
      ...
      private function prepareLegacySequence() : Boolean
      {
         ...
         var _loc2_:int = 0;
         while(_loc2_ < this.var_495.channels.length)
         {
            _loc3_ = new Map();
            _loc4_ = this.var_495.channels[_loc2_] as TraxChannel;
            _loc5_ = 0;
            _loc6_ = 0;
            _loc7_ = 0;
            while(_loc7_ < _loc4_.itemCount)
            {
               ...
               _loc9_ = this.var_1665.getValue(_loc8_) as TraxSample;
               _loc9_.setUsageFromSong(this.var_1663,_loc1_);
               if(_loc9_ == null)
               {
               ...
               while(_loc12_ < _loc11_)
               {
                  ...
                  _loc6_ += _loc10_;
                  _loc5_ = uint(_loc6_ * const_719);
                  _loc12_++;
               }
               if(this.var_305 < _loc5_)
               {
                  this.var_305 = _loc5_;
               }
               _loc7_++;
      ...
      private function prepareSequence() : Boolean
      {
         ...
         while(_loc2_ < this.var_495.channels.length)
         {
            ...
            while(_loc8_ < _loc4_.itemCount)
            {
               ...
               _loc10_ = this.var_1665.getValue(_loc9_) as TraxSample;
               _loc10_.setUsageFromSong(this.var_1663,_loc1_);
               if(_loc10_ == null)
               {
      ...
      public function play(param1:Number = 0.0) : Boolean
      {
         ...
         this.var_590 = 0;
         this.var_723 = false;
         this.var_1108.addEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         this.var_1664 = param1 * const_120;
         this.var_1359 = 0;
         this.var_2140 = 0;
         this.var_496 = this.var_1108.play();
         this.volume = this.var_1064;
         return true;
      }
      ...
      {
         if(this.var_493 > 0 && !this.var_723)
         {
      ...
      private function stopImmediately() : void
      {
         ...
         {
            this.var_1108.removeEventListener(SampleDataEvent.SAMPLE_DATA,this.onSampleData);
         }
      }
      ...
      private function stopWithFadeout() : void
      {
         if(this.var_724 == null)
         {
            this.var_904 = true;
            this.var_590 = 0;
            this.var_724 = new Timer(this.var_1661 + this.var_493 / (const_120 / 1000),1);
            this.var_724.start();
            this.var_724.addEventListener(TimerEvent.TIMER_COMPLETE,this.onFadeOutComplete);
         }
      }
      ...
      private function getSampleBars(param1:uint) : int
      {
         if(this.var_1666)
         {
            return Math.round(param1 / const_1145);
         }
      ...
      private function mixChannelsIntoBuffer() : void
      {
         ...
         while(_loc4_ >= 0)
         {
            ...
            _loc8_ = const_119;
            if(this.var_305 - this.var_187 < _loc8_)
            {
               _loc8_ = this.var_305 - this.var_187;
            }
            _loc9_ = 0;
            while(_loc9_ < _loc8_)
            {
      ...
      {
         var _loc1_:int = this.var_305 < this.var_1664 ? int(this.var_305) : (this.var_1664 > 0 ? int(this.var_1664) : int(this.var_305));
         if(this.var_187 > _loc1_ + this.var_1661 * (const_120 / 1000) && !this.var_723)
         {
            this.var_723 = true;
            if(this.var_494 != null)
            {
               this.var_494.reset();
               this.var_494.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onPlayingComplete);
            }
            this.var_494 = new Timer(2,1);
            this.var_494.start();
            this.var_494.addEventListener(TimerEvent.TIMER_COMPLETE,this.onPlayingComplete);
         }
         else if(this.var_187 > _loc1_ - this.var_493 && !this.var_904)
         {
            this.var_1109 = false;
            this.var_904 = true;
            this.var_590 = 0;
      ...
      {
         if(param1.position > this.var_1359)
         {
            ++this.var_2140;
            Logger.log("Audio buffer under run...");
            this.var_1359 = param1.position;
         }
         if(this.volume > 0)
         {
         ...
         if(this.var_305 - this.var_187 < _loc2_)
         {
            _loc2_ = this.var_305 - this.var_187;
            if(_loc2_ < 0)
            {
               _loc2_ = 0;
            }
         ...
         this.var_1359 += const_119;
         if(this.var_496 != null)
         {
            this.var_1661 = param1.position / const_120 * 1000 - this.var_496.position;
         }
      ...
      private function writeAudioToOutputStream(param1:ByteArray, param2:int) : void
      {
         ...
         if(param2 > 0)
         {
            ...
            else
            {
               if(this.var_1109)
               {
                  _loc5_ = 1 / this.var_903;
                  _loc6_ = this.var_1110 / Number(this.var_903);
                  this.var_1110 += const_119;
                  if(this.var_1110 > this.var_903)
                  {
                     this.var_1109 = false;
                  }
               }
               ...
               {
                  _loc5_ = -1 / this.var_493;
                  _loc6_ = 1 - this.var_590 / Number(this.var_493);
                  this.var_590 += const_119;
                  if(this.var_590 > this.var_493)
                  {
                     this.var_590 = this.var_493;
                  }
               }
      ...
      {
         this.stopImmediately();
         this._events.dispatchEvent(new SoundCompleteEvent(SoundCompleteEvent.TRAX_SONG_COMPLETE,this.var_1663));
      }
      ...
      private function removeFadeoutStopTimer() : void
      {
         if(this.var_724 != null)
         {
            this.var_724.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onFadeOutComplete);
            this.var_724.reset();
            this.var_724 = null;
         }
      }
