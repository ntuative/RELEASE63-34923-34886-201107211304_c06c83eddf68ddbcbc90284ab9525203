package com.sulake.habbo.sound
{
   ...
   public class HabboSoundManagerFlash10 extends Component implements IHabboSoundManager, IUpdateReceiver
   {
      ...
      private static const const_1632:int = 60;
      
      private static const const_1633:int = 25165823;
      
      private static const const_1634:int = 16777215;
      ...
      public function HabboSoundManagerFlash10(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null, param4:Boolean = true)
      {
         ...
         events.addEventListener(TraxSongLoadEvent.const_808,this.onTraxLoadComplete);
      ...
      public function playSound(param1:String) : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc2_:HabboSound = this.var_1068.getValue(param1);
         if(_loc2_ == null)
         {
            _loc3_ = "";
            switch(param1)
            {
               case HabboSoundTypesEnum.const_1334:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1875:
               ...
               case HabboSoundTypesEnum.const_1302:
                  ...
                  break;
               case HabboSoundTypesEnum.const_1824:
      ...
      private function loadSample(param1:int) : void
      {
         ...
         var _loc2_:String = this.var_134.getKey("flash.dynamic.download.url","furniture/");
         _loc2_ += this.var_134.getKey("flash.dynamic.download.samples.template","mp3/sound_machine_sample_%typeid%.mp3");
      ...
      private function addTraxSongForDownload(param1:int, param2:String) : IHabboSound
      {
         ...
         if(!_loc3_.ready)
         {
            this.var_1316.add(param1,_loc3_);
         }
         return _loc3_;
      }
      ...
      public function notifyPlayedSong(param1:String, param2:String) : void
      {
         ...
         this.var_1069.addSongPlayingNotification(param1,param2);
      }
      ...
      private function onHabboConfigurationInit(param1:IID = null, param2:IUnknown = null) : void
      {
         if(param2 != null)
         {
            ...
            if(this.var_134.getBoolean("trax.player.sample.memory.purge.enabled",false))
            {
               this.var_2786 = true;
            }
         }
      ...
      private function onNotificationsReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_1069 = IHabboNotifications(param2);
      }
      ...
      {
         if(this.var_134 == null || this._connection == null || this._roomEngine == null || this.var_258 != null)
         {
            return;
         }
      ...
      {
         events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_1768,this.var_863));
         this.var_863 = -1;
         this.var_864 = null;
      }
      ...
      private function storeVolumeSetting() : void
      {
         ...
         {
            this._connection.send(new SetSoundSettingsComposer(int(this.var_1064 * 100)));
         }
      }
      ...
      private function updateVolumeSetting(param1:Number) : void
      {
         ...
         this.var_258.updateVolume(this.var_1064);
      }
      ...
      private function processLoadedSample(param1:Sound) : void
      {
         ...
         if(this.var_691.getValue(param1) != null)
         {
            ...
            if(this.var_295.getValue(_loc2_) == null)
            {
               ...
               param1.extract(this.var_1606,int(_loc3_ * 44.1));
               _loc4_ = new TraxSample(this.var_1606,_loc2_,TraxSample.const_1843,TraxSample.const_1804);
      ...
      private function processLoadedSamples() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:int = 0;
         if(this.var_1315.length > 0)
         {
            _loc1_ = getTimer();
            _loc2_ = _loc1_;
            while(_loc2_ - _loc1_ < const_1632 && this.var_1315.length > 0)
            {
               _loc3_ = this.var_1315.splice(0,1)[0];
               this.processLoadedSample(_loc3_);
               _loc2_ = getTimer();
            }
            if(this.var_691.length == 0 && this.var_863 != -1)
            {
               this.var_864.ready = true;
               _loc4_ = this.var_863;
               this.var_863 = -1;
               this.var_864 = null;
               events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_808,_loc4_));
               if(this.var_2786)
               {
      ...
      private function loadNextSong() : void
      {
         var _loc1_:int = 0;
         var _loc2_:* = null;
         if(this.var_864 == null && this.var_1316.length > 0)
         {
            _loc1_ = this.var_1316.getKey(0);
            _loc2_ = this.var_1316.remove(_loc1_);
            if(_loc2_ != null && !_loc2_.disposed)
            {
               this.validateSampleAvailability(_loc2_,true);
               if(_loc2_.ready)
               {
                  events.dispatchEvent(new TraxSongLoadEvent(TraxSongLoadEvent.const_808,_loc1_));
               }
               else
               {
                  this.var_864 = _loc2_;
      ...
      private function processSampleMemoryUsage() : void
      {
         ...
         if(_loc1_ > const_1633)
         {
            ...
            _loc8_ = 0;
            _loc9_ = 0;
            while(_loc8_ < _loc1_ - const_1634 && _loc9_ < _loc2_.length)
            {
