package com.sulake.habbo.moderation
{
   ...
   public class ModActionCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1269:IDropMenuWindow;
      ...
      private var var_1025:OffenceCategoryData;
      
      private var var_1026:OffenceData;
      ...
      public function ModActionCtrl(param1:ModerationManager, param2:int, param3:String, param4:String)
      {
         ...
         this.var_1270 = IButtonWindow(this.var_36.getXmlWindow("modact_offence"));
         this.var_1268 = IButtonWindow(this.var_36.getXmlWindow("modact_offencectg"));
      }
      ...
      public function show() : void
      {
         ...
         this._frame.caption = "Mod action on: " + this.var_1921;
         ...
         this.var_1269 = IDropMenuWindow(this._frame.findChildByName("banLengthSelect"));
         this.prepareBanSelect(this.var_1269);
      ...
      public function refreshCategorization() : void
      {
         ...
         _loc1_.findChildByName("change_categorization_but").visible = this.var_1025 != null;
         if(this.var_1026 != null)
         {
            this._frame.findChildByName("offence_txt").caption = this.var_1026.name;
            this._frame.findChildByName("offence_category").visible = true;
         }
         else if(this.var_1025 != null)
         {
            this.refreshButtons("offences_cont",2,this.var_1025.offences,this.var_1270,this.onOffenceButton);
         }
         else
         {
            this.refreshButtons("offence_categories_cont",3,this.var_36.initMsg.offenceCategories,this.var_1268,this.onOffenceCtgButton);
      ...
      {
         return WindowTracker.const_1964;
      }
      ...
      private function onSendCautionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModAlertMessageComposer(this.var_1553,this.var_556.text,this.var_1554));
         this.dispose();
      }
      ...
      private function onOffenceCtgButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_1025 = this.var_36.initMsg.offenceCategories[_loc3_];
         this.refreshCategorization();
      }
      ...
      private function onOffenceButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = int(param2.name);
         this.var_1026 = this.var_1025.offences[_loc3_];
         this.var_556.text = this.var_1026.msg;
         this.var_624 = false;
         this.refreshCategorization();
      }
      ...
      private function onKickButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.connection.send(new ModKickMessageComposer(this.var_1553,this.var_556.text,this.var_1554));
         this.dispose();
      }
      ...
      private function onBanButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(this.var_1269.selection < 0)
         {
            this.var_36.windowManager.alert("Alert","You must select ban lenght",0,this.onAlertClose);
            return;
         }
         this.var_36.connection.send(new ModBanMessageComposer(this.var_1553,this.var_556.text,this.getBanLength(),this.var_1554));
         this.dispose();
      }
      ...
      {
         var _loc1_:int = this.var_1269.selection;
