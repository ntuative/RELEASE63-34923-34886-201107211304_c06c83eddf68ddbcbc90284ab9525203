package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_529:UserInfoCtrl;
      ...
      private function createView() : void
      {
         ...
         this.var_529 = new UserInfoCtrl(this._window,this.var_73,_loc3_.message);
         this.var_1181 = new UserInfoCtrl(this._window,this.var_73,_loc3_.message);
         this.var_529.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc3_.reporterUserId);
         ...
         {
            this.var_1181.load(_loc4_,this.var_173.reportedUserId);
         }
         else
         {
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         this.var_73.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),this.var_73,WindowTracker.const_1371,_loc2_),this._window,false,false,true);
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            this.var_529 = new UserInfoCtrl(this._window,this.var_73,_loc3_.message);
            this.var_529.load(IWindowContainer(this._window.findChildByName("caller_user_info")),_loc2_);
         }
      }
