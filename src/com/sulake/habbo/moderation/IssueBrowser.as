package com.sulake.habbo.moderation
{
   ...
   public class IssueBrowser
   {
      ...
      private const const_2377:String = "my_issues";
      
      private const const_2379:String = "open_issues";
      ...
      private var var_418:IIssueBrowserView;
      
      private var var_2160:IIssueBrowserView;
      
      private var var_2159:IIssueBrowserView;
      
      private var var_2161:PickedIssuesView;
      ...
      private function selectView(param1:String) : void
      {
         ...
         this.var_418.view.width = this.var_307.container.width;
         this.var_418.view.height = this.var_307.container.height;
      ...
      private function getView(param1:String) : IIssueBrowserView
      {
         switch(param1)
         {
            case this.const_2377:
               ...
               {
                  this.var_2160 = new MyIssuesView(this.issueManager,this,this.var_307.container);
               }
               return this.var_2160;
            case this.const_2379:
               if(this.var_2159 == null)
               {
                  this.var_2159 = new OpenIssuesView(this.issueManager,this,this.var_307.container);
               }
               return this.var_2159;
            case this.const_2378:
               if(this.var_2161 == null)
               {
                  this.var_2161 = new PickedIssuesView(this.issueManager,this,this.var_307.container);
               }
