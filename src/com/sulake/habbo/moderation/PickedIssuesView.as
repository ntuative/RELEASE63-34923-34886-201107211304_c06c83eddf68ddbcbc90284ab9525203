package com.sulake.habbo.moderation
{
   ...
   public class PickedIssuesView implements IIssueBrowserView
   {
      ...
      private var var_2363:IssueListView;
      ...
      public function PickedIssuesView(param1:IssueManager, param2:IssueBrowser, param3:IWindowContainer)
      {
         ...
         this.var_2363 = new IssueListView(param1,param2,_loc4_,"picked_issues_list_item_xml");
      }
      ...
      {
         var _loc1_:Array = this._issueManager.getBundles(IssueManager.const_1239);
         this.var_2363.update(_loc1_);
      }
   }
}
