package com.sulake.habbo.moderation
{
   ...
   public class IssueBundle
   {
      ...
      private var var_783:IssueMessageData = null;
      ...
      public function IssueBundle(param1:int, param2:IssueMessageData)
      {
         ...
         this.var_2350 = param2.pickerUserId;
         this.var_2349 = param2.pickerUserName;
         this.var_1628 = param2.reportedUserId;
      ...
      private function addIssue(param1:IssueMessageData) : void
      {
         ...
         if(this.var_783 == null || param1.priority > this.var_783.timeStamp)
         {
            this.var_783 = param1;
         }
      }
      ...
      public function getHighestPriorityIssue() : IssueMessageData
      {
         var _loc2_:* = null;
         var _loc3_:int = 0;
         var _loc1_:IssueMessageData = this.var_783;
         if(_loc1_ == null)
         {
