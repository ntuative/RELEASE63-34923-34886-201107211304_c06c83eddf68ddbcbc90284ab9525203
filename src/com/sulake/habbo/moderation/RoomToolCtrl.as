package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1535:ICheckBoxWindow;
      ...
      public function populate() : void
      {
         ...
         this.var_1015 = ICheckBoxWindow(this._frame.findChildByName("kick_check"));
         this.var_1534 = ICheckBoxWindow(this._frame.findChildByName("lock_check"));
         this.var_1535 = ICheckBoxWindow(this._frame.findChildByName("changename_check"));
      ...
      private function onOwnerName(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new UserInfoFrameCtrl(this.var_36,this._data.method_1),this._frame,false,false,true);
      }
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_36.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,this._data.flatId),this.var_36,WindowTracker.const_984,this._data.flatId),this._frame,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = this.determineAction(param1,this.var_1015.isSelected);
         this.var_36.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1995,_loc2_,this.var_556.text,"",""));
         if(this.var_1534.isSelected || this.var_1535.isSelected || this.var_1015.isSelected)
         {
            this.var_36.connection.send(new ModerateRoomMessageComposer(this._data.flatId,this.var_1534.isSelected,this.var_1535.isSelected,this.var_1015.isSelected));
         }
         this.dispose();
      }
      ...
      private function determineAction(param1:Boolean, param2:Boolean) : int
      {
         ...
         return !!param1 ? 0 : int(ModeratorActionMessageComposer.const_1822);
      }
      ...
      private function onSelectTemplate(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = this.var_36.initMsg.roomMessageTemplates[this.var_1255.selection];
         if(_loc3_ != null)
         {
            this.var_624 = false;
