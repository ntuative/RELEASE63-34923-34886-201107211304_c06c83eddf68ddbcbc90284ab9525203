package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private static var var_1959:int = 200;
      ...
      {
         this.var_850 = IWindowContainer(this.var_36.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1831;
      }
