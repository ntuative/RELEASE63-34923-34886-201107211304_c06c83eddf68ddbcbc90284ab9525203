package com.sulake.habbo.roomevents.userdefinedroomevents
{
   ...
   public class UserDefinedRoomEventsCtrl
   {
      ...
      private static var var_1647:int = 2;
      ...
      private var var_2129:TriggerConfs;
      
      private var var_2130:ActionTypes;
      
      private var var_2128:ConditionTypes;
      
      private var var_302:Dictionary;
      
      private var var_37:Triggerable;
      
      private var var_895:RoomObjectHightLighter;
      ...
      {
         this.var_2129 = new TriggerConfs();
         this.var_2130 = new ActionTypes();
         this.var_2128 = new ConditionTypes();
         this.var_302 = new Dictionary();
         super();
         this.var_94 = param1;
         this.var_895 = new RoomObjectHightLighter(param1);
      ...
      public function stuffSelected(param1:int, param2:String) : void
      {
         ...
         {
            delete this.var_302[param1];
            this.var_895.hide(param1);
         }
         else if(this.getStuffIds().length < this.var_37.furniLimit)
         {
            this.var_302[param1] = param2;
            this.var_895.show(param1);
         }
         this.refresh();
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_1351 = new SliderWindowController(this.var_94,IWindowContainer(this.find(this.var_56,"delay_slider_container")),this.var_94.assets,0,20,1);
      ...
      public function close() : void
      {
         if(this._window)
         {
            ...
            this.var_895.hideAll(this.var_302);
         }
      }
      ...
      private function onDecStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = this.var_37.stuffTypeSelectionCode < 1 ? int(var_1647) : int(this.var_37.stuffTypeSelectionCode - 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function onIncStuffSelectionType(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_37.stuffTypeSelectionCode = (this.var_37.stuffTypeSelectionCode + 1) % (var_1647 + 1);
         this.refreshStuffTypeSelectionToggler();
      }
      ...
      private function refresh() : void
      {
         ...
         this.refreshConfigureElement(this.var_2129);
         this.refreshConfigureElement(this.var_2130);
