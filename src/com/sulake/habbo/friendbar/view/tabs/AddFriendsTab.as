package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class AddFriendsTab extends Tab
   {
      ...
      private static const const_1723:String = "add_friends_tab_xml";
      
      private static const const_1724:String = "find_friends_icon_png";
      
      private static var var_1139:int = -1;
      
      private static const const_69:uint = 6907230;
      
      private static const const_1096:uint = 9209986;
      
      private static const POOL:Array = [];
      
      private static const const_490:Array = [];
      ...
      {
         var _loc1_:IWindowContainer = false ? const_490.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1723).content as XML) as IWindowContainer;
      ...
      private function releaseEntityWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            if(const_490.indexOf(param1) == -1)
            {
               const_490.push(param1);
            }
         }
      }
