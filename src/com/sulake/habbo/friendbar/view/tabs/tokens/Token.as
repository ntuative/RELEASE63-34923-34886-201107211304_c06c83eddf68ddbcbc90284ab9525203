package com.sulake.habbo.friendbar.view.tabs.tokens
{
   ...
   public class Token implements IDisposable
   {
      ...
      protected static const const_2057:String = "title";
      ...
      protected function prepare(param1:String, param2:String, param3:String, param4:String, param5:String, param6:Boolean) : void
      {
         ...
         this._window.findChildByName(const_2057).caption = param1;
         this._window.findChildByName(const_1073).caption = !!param2 ? param2 : "";
         ...
         this._icon = var_1435.create("ICON_" + this.typeCode,WindowType.const_360,WindowStyle.const_105,WindowParam.const_31,Token.ICON_RECTANGLE) as IRegionWindow;
         this._icon.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = var_1435.create("BITMAP_" + this.typeCode,WindowType.const_441,WindowStyle.const_105,WindowParam.const_194,Token.ICON_RECTANGLE) as IBitmapWrapperWindow;
