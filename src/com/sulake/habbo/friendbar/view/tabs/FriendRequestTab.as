package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestTab extends FriendEntityTab
   {
      ...
      protected static const const_1073:String = "message";
      ...
      {
         var _loc3_:* = null;
         var _loc2_:FriendRequestTab = !!var_1585 ? var_1585 : new FriendRequestTab();
      ...
      private function allocateRequestTabWindow() : IWindowContainer
      {
         ...
         var _loc7_:IRegionWindow = WINDOWING.create("ICON",WindowType.const_360,WindowStyle.const_105,WindowParam.const_31,new Rectangle(0,0,25,25)) as IRegionWindow;
         _loc7_.mouseThreshold = 0;
         var _loc8_:IBitmapWrapperWindow = WINDOWING.create("BITMAP",WindowType.const_441,WindowStyle.const_105,WindowParam.const_33,new Rectangle(0,0,25,25)) as IBitmapWrapperWindow;
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1036)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(REGION_REJECT_TEXT)).textColor = const_1592;
            }
         }
      }
