package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendEntityTab extends Tab
   {
      ...
      private static const const_1595:String = "entity_xml";
      
      private static const const_1597:String = "facebook_piece_xml";
      
      private static const const_1594:String = "controls_piece_xml";
      
      protected static const const_1035:String = "pieces";
      ...
      protected static const const_713:String = "name";
      
      protected static const const_1073:String = "btn_message";
      
      protected static const const_1034:String = "icon_message";
      
      protected static const const_1414:String = "btn_visit";
      
      protected static const ICON:String = "icon";
      
      protected static const const_1032:String = "label";
      
      protected static const const_592:String = "notification";
      
      private static const const_69:uint = 10338138;
      
      private static const const_1096:uint = 13891476;
      
      private static const const_1098:String = null;
      
      private static const const_704:String = "icon_tag_notify";
      
      private static const const_1596:String = "icon_tag_message";
      ...
      private static function purgeEntityPieces(param1:IWindowContainer) : void
      {
         var _loc3_:* = null;
         var _loc5_:* = null;
         var _loc2_:IItemListWindow = IItemListWindow(param1.getChildByName(const_1035));
         ...
         var _loc4_:* = [];
         _loc2_.groupListItemsWithTag(const_592,_loc4_);
         if(_loc4_.length > 0)
         {
      ...
      override public function select(param1:Boolean) : void
      {
         ...
         if(!selected)
         {
            _loc2_ = IItemListWindow(window.getChildByName(const_1035));
            _loc5_ = false;
            if(this.friend.realName != null && this.friend.realName != "")
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1597).content as XML) as IWindowContainer;
               _loc3_.name = const_1416;
               _loc6_ = _loc3_.getChildByName(const_713) as ITextWindow;
               _loc6_.caption = this.friend.realName;
               if(!_loc6_.wordWrap)
               {
                  var_2239.crop(_loc6_);
               }
            ...
            {
               _loc3_ = WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1594).content as XML) as IWindowContainer;
               _loc3_.name = const_1415;
               _loc8_ = _loc3_.getChildByName(const_1073);
               if(_loc8_)
               {
      ...
      {
         super.expose();
         _window.color = !!exposed ? uint(const_1096) : uint(const_69);
         ITextWindow(_window.findChildByTag(const_1032)).underline = exposed;
      }
      ...
      protected function refresh() : void
      {
         ...
         if(this.var_168)
         {
            ...
            _loc1_ = IItemListWindow(_window.getChildByName(const_1035)).getListItemByName(const_468) as IWindowContainer;
            _loc1_.findChildByName(const_713).caption = this.var_168.name;
            var_2239.crop(_loc1_.getChildByName(const_713) as ITextWindow);
            _loc2_ = IBitmapWrapperWindow(_loc1_.findChildByName(const_316));
            _loc2_.bitmap = var_506.getAvatarFaceBitmap(this.var_168.figure);
      ...
      {
         var _loc1_:IWindowContainer = false ? const_483.pop() : WINDOWING.buildFromXML(ASSETS.getAssetByName(const_1595).content as XML) as IWindowContainer;
            ...
            switch(param1.window.name)
            {
               ...
               case const_1034:
                  ...
                  if(var_359 && this.var_168)
                  {
                     ...
                     this.deselect(true);
                     if(param1.window.name == const_1034)
                     {
      ...
      public function addNotificationToken(param1:FriendNotification, param2:Boolean) : void
      {
         ...
         var _loc5_:String = const_1098;
         switch(param1.typeCode)
         {
            case FriendNotification.const_1363:
            ...
            case FriendNotification.TYPE_ACHIEVEMENT:
               _loc4_ = new AchievementToken(this.friend,param1,param2,var_2237);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_704;
               break;
            case FriendNotification.const_1170:
               _loc4_ = new QuestToken(this.friend,param1,param2,var_2237);
               _loc4_.iconElement.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onMouseClick);
               _loc5_ = const_704;
               break;
            case FriendNotification.const_447:
               _loc4_ = new MessengerToken(this.friend,param1,param2);
               _loc4_.iconElement.name = const_1034;
