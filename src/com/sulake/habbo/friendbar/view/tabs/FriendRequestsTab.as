package com.sulake.habbo.friendbar.view.tabs
{
   ...
   public class FriendRequestsTab extends Tab
   {
      ...
      protected static const const_2049:String = "button_accept_all";
      
      protected static const const_2050:String = "click_area_discard_all";
      
      protected static const const_1419:String = "button_close";
      
      protected static const const_2046:String = "button_accept";
      
      protected static const const_1033:String = "click_area_discard";
      
      protected static const const_1413:String = "text_discard";
      
      private static var var_1585:FriendRequestsTab;
      
      private static const const_69:uint = 4294625561;
      
      private static const const_1096:uint = 4294957414;
      
      private static const const_1593:uint = 4289431312;
      
      private static const const_1591:uint = 4290616362;
      ...
      {
         var _loc2_:FriendRequestsTab = !!var_1585 ? var_1585 : new FriendRequestsTab();
               ...
               if(_loc2_)
               {
                  ...
                  if(!this.var_1982)
                  {
                     ...
                     if(_loc3_)
                     {
                        ...
                        {
                           _loc4_ = this.var_1296.clone() as IWindowContainer;
                           _loc4_.color = _loc8_ % 2 == 0 ? uint(const_1593) : uint(const_1591);
                           _loc5_ = this._requests[_loc8_];
                           _loc4_.id = _loc5_.id;
                           _loc4_.getChildByName(const_713).caption = _loc5_.name;
      ...
      private function allocateRequestsTabWindow() : IWindowContainer
      {
         ...
         this.var_1296 = _loc7_.removeListItemAt(0) as IWindowContainer;
         return _loc1_;
      }
      ...
      private function releaseRequestsTabWindow(param1:IWindowContainer) : void
      {
         ...
         if(param1 && !param1.disposed)
         {
            ...
            _loc3_.bitmap = null;
            ITextWindow(param1.findChildByTag(const_1032)).underline = false;
         }
      }
      ...
      private function bubbleEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_25)
         {
            if(param2.name == const_1033)
            {
               ITextWindow(IWindowContainer(param2).getChildByName(const_1413)).textColor = const_1592;
            }
         }
      }
