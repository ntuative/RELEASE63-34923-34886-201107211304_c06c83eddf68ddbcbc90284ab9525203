package com.sulake.habbo.friendbar.view
{
   ...
   public class HabboFriendBarView extends AbstractView implements IHabboFriendBarView, IAvatarImageListener
   {
      ...
      private static const const_1501:int = 127;
      ...
      private static const const_1505:Boolean = false;
      
      private static const const_693:int = 3;
      
      private static const const_1491:String = "arrow";
      
      private static const const_1495:String = "left";
      
      private static const const_1498:String = "right";
      
      private static const const_1493:String = "bar_xml";
      
      private static const const_1503:String = "toggle_xml";
      
      private static const const_78:String = "container";
      
      private static const const_1069:String = "wrapper";
      
      private static const const_1506:String = "border";
      
      private static const const_692:String = "list";
      ...
      private static const const_1035:String = "pieces";
      
      private static const const_1502:String = "button_left";
      
      private static const BUTTON_RIGHT_SINGLE:String = "button_right";
      
      private static const const_1499:String = "button_left_page";
      
      private static const const_1497:String = "button_right_page";
      
      private static const const_1494:String = "button_left_end";
      
      private static const const_1504:String = "button_right_end";
      
      private static const const_1419:String = "button_close";
      
      private static const const_1500:String = "button_open";
      
      private static const const_1492:String = "link_friendlist";
      
      private static const const_1071:String = "messenger";
      
      private static const const_1068:String = "friendlist";
      
      private static const const_695:String = "stream";
      
      private static const const_1496:String = "stream_new_label";
      ...
      private var var_1229:ITab;
      
      private var var_1001:int = -1;
      
      private var _startIndex:int = 0;
      
      private var var_1513:TextCropper;
      
      private var var_545:FriendListIcon;
      
      private var var_385:MessengerIcon;
      
      private var var_822:StreamIcon;
         ...
         if(!disposed)
         {
            ...
            if(this.var_49)
            {
               if(!this.var_49.disposed)
               {
                  ...
                  {
                     this.var_49.events.removeEventListener(FriendBarUpdateEvent.const_738,this.onRefreshView);
                     this.var_49.events.removeEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
                     this.var_49.events.removeEventListener(FriendRequestUpdateEvent.const_930,this.onFriendRequestUpdate);
                     this.var_49.events.removeEventListener(NewMessageEvent.const_867,this.onNewInstantMessage);
                     this.var_49.events.removeEventListener(NotificationEvent.const_907,this.onFriendNotification);
                  }
            ...
            if(_windowManager)
            {
               if(true)
               {
                  _windowManager.getWindowContext(const_476).getDesktopWindow().removeEventListener(WindowEvent.const_40,this.onDesktopResized);
               }
            }
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         if(this.var_221)
         {
            ...
            if(this.var_42)
            {
               this.var_221.x = this.var_42.x;
               this.var_221.y = this.var_42.y;
      ...
      {
         return this.var_42 && this.var_42.visible;
      }
      ...
      public function populate() : void
      {
         ...
         var _loc15_:int = 0;
         var _loc16_:* = null;
         var _loc1_:int = this.var_1001;
         this.deSelect(false);
         var _loc2_:IWindowContainer = this.var_42.findChildByName(const_78) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_692) as IItemListWindow;
         ...
         var _loc9_:int = _loc6_ + (!!this.var_1512 ? 1 : 0) + (_loc7_ > 0 ? 1 : 0);
         ...
         if(this.var_1512)
         {
            ...
            {
               _loc15_ = 1;
               if(this.var_76.length + _loc15_ < const_693)
               {
                  _loc15_ = Math.min(_loc8_ - this.var_76.length,const_693 - this.var_76.length);
               }
      ...
      private function onFriendBarDataAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_49.events.addEventListener(FriendBarUpdateEvent.const_738,this.onRefreshView);
         this.var_49.events.addEventListener(FindFriendsNotificationEvent.TYPE,this.onFindFriendsNotification);
         this.var_49.events.addEventListener(FriendRequestUpdateEvent.const_930,this.onFriendRequestUpdate);
         this.var_49.events.addEventListener(NewMessageEvent.const_867,this.onNewInstantMessage);
         this.var_49.events.addEventListener(NotificationEvent.const_907,this.onFriendNotification);
      }
      ...
      {
         var_760 = param2 as IHabboLocalizationManager;
      }
      
      private function isUserInterfaceReady() : Boolean
      {
         return this.var_42 && !this.var_42.disposed;
      }
      
      private function buildUserInterface() : void
      {
         var _loc2_:* = null;
         Tab.var_359 = this.var_49;
         Tab.var_506 = this;
         Tab.ASSETS = assets;
         Tab.WINDOWING = _windowManager;
         Tab.var_2237 = var_760;
         Tab.var_2239 = this.var_1513;
         Token.WINDOWING = _windowManager;
         Token.ASSETS = assets;
         var _loc1_:IAsset = assets.getAssetByName(const_1493);
         this.var_42 = _windowManager.buildFromXML(_loc1_.content as XML,const_476) as IWindowContainer;
         this.var_42.x = const_694;
         this.var_42.y = this.var_42.parent.height - (this.var_42.height + const_1507);
         this.var_42.width = this.var_42.parent.width - (const_694 + const_1070);
         this.var_42.setParamFlag(WindowParam.const_278,true);
         this.var_42.procedure = this.barWindowEventProc;
         if(const_1505)
         {
            _loc1_ = assets.getAssetByName(const_1503);
            this.var_221 = _windowManager.buildFromXML(_loc1_.content as XML,const_476) as IWindowContainer;
            this.var_221.x = this.var_42.x;
            this.var_221.y = this.var_42.y;
            this.var_221.setParamFlag(WindowParam.const_278,true);
            this.var_221.visible = false;
            this.var_221.procedure = this.toggleWindowEventProc;
         }
         _loc2_ = IWindowContainer(this.var_42.findChildByName(const_1068));
         ...
         _loc2_ = IWindowContainer(this.var_42.findChildByName(const_1071));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_385 = new MessengerIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow);
         this.var_385.enable(false);
         this.visible = true;
         _windowManager.getWindowContext(const_476).getDesktopWindow().addEventListener(WindowEvent.const_40,this.onDesktopResized);
         this.var_42.findChildByName(const_695).visible = var_950.getBoolean("friendbar.stream.enabled",false) == true;
         _loc2_ = IWindowContainer(this.var_42.findChildByName(const_695));
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onIconMouseEvent);
         _loc2_.addEventListener(WindowMouseEvent.const_25,this.onIconMouseEvent);
         this.var_822 = new StreamIcon(assets,_loc2_.getChildByName(ICON) as IBitmapWrapperWindow,this.var_42.findChildByName(const_1496) as IWindowContainer);
      }
      ...
      public function getAvatarFaceBitmap(param1:String) : BitmapData
      {
         ...
         if(var_612)
         {
            _loc3_ = var_612.createAvatarImage(param1,AvatarScaleType.const_61,null,this);
            if(_loc3_)
            {
      ...
      public function avatarImageReady(param1:String) : void
      {
         ...
         var _loc12_:* = null;
         var _loc13_:* = null;
         var _loc3_:IItemListWindow = this.var_42.findChildByName(const_692) as IItemListWindow;
         ...
         while(_loc5_ < _loc4_)
         {
            ...
            if(_loc2_.figure == param1)
            {
               ...
               if(_loc8_)
               {
                  ...
                  if(_loc9_)
                  {
                     _loc10_ = _loc9_.getChildByName(const_1035) as IItemListWindow;
                     if(_loc10_)
                     {
      ...
      {
         return this.var_1001 == param1.id;
      }
      ...
      public function selectTab(param1:ITab, param2:Boolean) : void
      {
         if(!param1.selected)
         {
            ...
            {
               this.var_1001 = FriendEntityTab(param1).friend.id;
            }
         }
      }
      ...
      private function onFriendRequestUpdate(param1:FriendRequestUpdateEvent) : void
      {
         if(this.var_545)
         {
            this.var_545.notify(this.var_49.numFriendRequests > 0);
         }
         this.populate();
      }
      ...
      private function onNewInstantMessage(param1:NewMessageEvent) : void
      {
         if(this.var_385)
         {
            if(param1.notify)
            {
               this.var_385.notify(true);
            }
            else
            {
               this.var_385.enable(true);
            }
         }
      }
      ...
      private function barWindowEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            _loc4_ = this.var_49.numFriends + (!!this.var_1512 ? 1 : 0) + (this.var_49.numFriendRequests > 0 ? 1 : 0);
            switch(param2.name)
            {
               case const_1502:
         ...
         if(param1.type == WindowEvent.const_616)
         {
            this.deSelect(true);
         }
      }
      ...
      private function toggleArrowButtons(param1:Boolean, param2:Boolean, param3:Boolean) : void
      {
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc6_:IWindowContainer = this.var_42.findChildByName(const_1069) as IWindowContainer;
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1491,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            _loc4_.visible = param1;
         }
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1495,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param2)
            {
         ...
         _loc5_ = [];
         _loc6_.groupChildrenWithTag(const_1498,_loc5_);
         for each(_loc4_ in _loc5_)
         {
            if(param3)
            {
         ...
         if(!disposed)
         {
            if(this.var_42)
            {
               ...
               if(!param1)
               {
                  ...
                  {
                     if(this.var_76.length < const_693)
                     {
                        param1 = true;
                     }
                     else if(this.var_76.length < this.var_49.numFriends + (!!this.var_1512 ? 1 : 0))
                     {
                        param1 = true;
                     }
      ...
      {
         var _loc1_:IWindowContainer = this.var_42.findChildByName(const_78) as IWindowContainer;
         var _loc2_:IWindowContainer = _loc1_.getChildByName(const_1069) as IWindowContainer;
         var _loc3_:IItemListWindow = _loc2_.findChildByName(const_692) as IItemListWindow;
         var _loc4_:int = _loc2_.width - _loc3_.width;
         return (_loc1_.width - _loc4_) / (const_1501 + _loc3_.spacing);
      }
