package com.sulake.habbo.friendbar.data
{
   ...
   public class HabboFriendBarData extends Component implements IHabboFriendBarData
   {
      ...
      private static const const_1159:Boolean = false;
      
      private static const const_730:String = "Navigation";
      
      private static const const_729:String = "Friend Bar";
      
      private static const const_1714:String = "go.friendbar";
      
      private static const const_1715:String = "chat_btn_click";
      
      private static const const_1717:String = "find_friends_btn_click";
      
      private static const const_1160:String = "Toolbar";
      
      private static const const_1161:String = "open";
      
      private static const const_1158:String = "close";
      
      private static const const_1716:String = "FRIENDLIST";
      
      private static const const_1718:String = "MESSENGER";
       
      
      private var var_1134:IHabboConfigurationManager;
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            if(this.var_1134)
            {
               this.var_1134.release(new IIDHabboConfigurationManager());
               this.var_1134 = null;
            }
            if(this.var_95)
            {
            ...
            if(this.var_91)
            {
               if(!this.var_91.disposed)
               {
                  ...
                  this.var_91.events.removeEventListener(FriendRequestEvent.const_225,this.onFriendRequestEvent);
               }
      ...
      public function followToRoom(param1:int) : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_730,const_729,const_1714));
         }
      }
      ...
      public function startConversation(param1:int) : void
      {
         if(this.var_236)
         {
            ...
            if(this.var_95)
            {
               this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_730,const_729,const_1715));
            }
         }
      }
      ...
      public function findNewFriends() : void
      {
         if(this.var_95)
         {
            ...
            this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_730,const_729,const_1717));
         }
      }
      ...
      public function toggleFriendList() : void
      {
         ...
         if(this.var_91)
         {
            if(!this.var_91.disposed)
            {
               ...
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1160,const_1716,!!this.var_91.isOpen() ? const_1161 : const_1158));
               }
            }
         }
      }
      ...
      public function toggleMessenger() : void
      {
         if(this.var_236)
         {
            if(!this.var_236.disposed)
            {
               ...
               if(this.var_95)
               {
                  this.var_95.getHabboMainConnection(null).send(new EventLogMessageComposer(const_1160,const_1718,!!this.var_236.isOpen() ? const_1161 : const_1158));
               }
            }
         }
      }
      ...
      {
         this.var_1134 = param2 as IHabboConfigurationManager;
         this.var_3023 = this.var_1134.getBoolean("friendbar.notifications.enabled",false);
         this.var_2195 = this.var_1134.getBoolean("friendbar.requests.enabled",false);
      }
      ...
      private function onFriendListComponentAvailable(param1:IID, param2:IUnknown) : void
      {
         ...
         this.var_91.events.addEventListener(FriendRequestEvent.const_225,this.onFriendRequestEvent);
      }
      ...
      private function onNewConsoleMessage(param1:NewConsoleMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.makeNotification(String(this.var_921),FriendNotification.const_447,null,false,false);
         }
      }
      ...
      private function onRoomInvite(param1:RoomInviteEvent) : void
      {
         ...
         {
            events.dispatchEvent(new NewMessageEvent(true,this.var_921));
            this.makeNotification(String(this.var_921),FriendNotification.const_447,null,true,false);
         }
      }
