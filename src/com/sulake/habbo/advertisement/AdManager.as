package com.sulake.habbo.advertisement
{
   ...
   public class AdManager extends Component implements IAdManager
   {
      ...
      private var var_428:AdImageRequest;
      
      private var var_1408:BitmapData = null;
      
      private var var_1407:BitmapData = null;
      ...
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_3038 = this._config.getKey("interstitial.enabled","HabboRoomUICom_jb_icon_disc") == "SetClothingChangeDataMessageComposer";
         this.var_3039 = int(this._config.getKey("interstitial.interval","30000"));
         this.var_3037 = int(this._config.getKey("interstitial.show.time","5000"));
         this.var_2203 = int(this._config.getKey("interstitial.max.displays.flash","-1"));
      ...
      public function showInterstitial() : Boolean
      {
         ...
         if(this.var_267 != null && this.var_267.running)
         {
            this.var_267.reset();
            return false;
         }
         ...
         if(this.var_2203 > 0 && this.var_2204 >= this.var_2203)
         {
            return false;
         }
         var _loc1_:int = getTimer() - this.var_1406;
         if(_loc1_ > this.var_3039)
         {
            ++this.var_2204;
      ...
      private function onInterstitial(param1:InterstitialMessageEvent) : void
      {
         ...
         this.var_1700 = _loc2_.imageUrl;
         this.var_3036 = _loc2_.clickUrl;
         this.var_1406 = getTimer();
         if(this.var_1700 != "")
         {
            _loc3_ = this.var_1700;
            ...
            {
               this.var_267 = new Timer(this.var_3037,1);
               this.var_267.addEventListener(TimerEvent.TIMER_COMPLETE,this.interstitialTimerComplete);
            }
            if(this.var_267.running)
            {
               this.var_267.reset();
            }
            this.var_267.start();
            _loc4_ = new URLRequest(this.var_1700);
      ...
      private function startInterstitial(param1:Bitmap) : void
      {
         ...
         {
            events.dispatchEvent(new InterstitialEvent(InterstitialEvent.const_648,param1.bitmapData,this.var_3036));
            this.var_1406 = getTimer();
         }
         else
         {
      ...
      {
         this.var_428 = new AdImageRequest(param1,param2);
      ...
      private function onRoomAd(param1:RoomAdMessageEvent) : void
      {
         ...
         if(this.var_428 != null && _loc2_.imageUrl != "" && _loc2_.clickUrl != "")
         {
            ...
            this.var_428 = new AdImageRequest(this.var_428.roomId,this.var_428.roomCategory,_loc2_.imageUrl,_loc2_.clickUrl);
      ...
      private function roomAdImageReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(this.isValidAdImage(_loc3_) && this.var_428 != null)
         {
            _loc4_ = this.emulateBackgroundTransparency(_loc3_.bitmapData);
            events.dispatchEvent(new AdEvent(AdEvent.const_584,this.var_428.roomId,this.var_428.roomCategory,_loc4_,_loc2_.assetName,this.var_428.clickURL,this.var_1408,this.var_1407));
            this.var_428 = null;
         }
      }
      ...
      private function adWarningLeftReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1408 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function adWarningRightReady(param1:AssetLoaderEvent) : void
      {
         ...
         if(_loc3_ != null)
         {
            this.var_1407 = this.emulateBackgroundTransparency(_loc3_.bitmapData);
         }
      }
      ...
      private function dispatchImageAsset(param1:BitmapData, param2:int, param3:int, param4:int, param5:int, param6:String, param7:String) : void
      {
         if(events != null)
         {
            events.dispatchEvent(new AdEvent(AdEvent.const_975,param2,param3,param1,param6,param7,null,null,param4,param5));
         }
      }
