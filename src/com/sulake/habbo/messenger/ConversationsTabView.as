package com.sulake.habbo.messenger
{
   ...
   public class ConversationsTabView
   {
      ...
      public function ConversationsTabView(param1:HabboMessenger, param2:IFrameWindow)
      {
         ...
         this.var_952 = IWindowContainer(param2.findChildByName("conversationstab"));
      ...
      {
         return Math.floor(this.var_952.width / this.var_1163);
      }
      ...
      {
         var _loc3_:IWindowContainer = this.var_952.getChildAt(param1) as IWindowContainer;
         if(_loc3_ == null)
         {
            if(param2 == null)
            {
         ...
         _loc3_.x = param1 * this.var_1163;
         _loc3_.width = this.var_1163;
         return false;
      }
      ...
      private function refreshAsArrow(param1:int, param2:Boolean) : void
      {
         ...
         var _loc4_:int = this.var_952.width % this.var_1163;
         _loc3_.width = this.var_1163 + (!!param2 ? _loc4_ : 0);
      }
      ...
      private function onTabClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            _loc4_ = param2.name == HabboMessenger.const_187 ? this.var_151.conversations.findConversation(param2.id) : this.var_151.conversations.openConversations[_loc3_ + this.var_151.conversations.startIndex];
            if(_loc4_ == null)
            {
               return;
            }
