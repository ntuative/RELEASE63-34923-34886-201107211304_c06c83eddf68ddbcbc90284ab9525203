package com.sulake.habbo.messenger.domain
{
   ...
   public class Conversations
   {
      ...
      private static var var_1230:int = 1;
       
      
      private var var_460:IConversationsDeps;
      ...
      public function setSelected(param1:Conversation) : void
      {
         ...
         while(this._startIndex + this.var_460.getTabCount() <= _loc2_)
         {
            ++this._startIndex;
         }
      }
      ...
      public function addConversation(param1:int) : Conversation
      {
         ...
         if(_loc2_)
         {
            _loc3_.addMessage(new Message(Message.const_736,0,this.var_460.getText("messenger.moderationinfo"),""));
         }
         return _loc3_;
      }
      ...
      public function addMessageAndUpdateView(param1:Message) : void
      {
         ...
         this.var_460.addMsgToView(_loc3_,param1);
         if(_loc2_ != this.var_155.length || _loc4_ != _loc3_.newMessageArrived)
         {
            this.var_460.refresh(false);
         }
      }
      ...
      public function setOnlineStatusAndUpdateView(param1:int, param2:Boolean) : void
      {
         ...
         this.var_460.addMsgToView(_loc3_,_loc4_);
      }
      ...
      private function addConversationInt(param1:int) : Conversation
      {
         ...
         _loc2_ = this.var_460.createConversation(param1);
         if(_loc2_ == null)
         {
            return null;
         }
      ...
      {
         this._startIndex = Math.min(this._startIndex,this.var_155.length - this.var_460.getTabCount());
         this._startIndex = Math.max(0,this._startIndex);
      }
      
      private function getOnlineInfoMsg(param1:Boolean) : Message
      {
         return new Message(Message.const_935,0,this.getOnlineText(param1),Util.getFormattedNow());
      }
      
      private function getOnlineText(param1:Boolean) : String
      {
         return this.var_460.getText(!!param1 ? "messenger.notification.online" : "messenger.notification.offline");
      }
   }
}
