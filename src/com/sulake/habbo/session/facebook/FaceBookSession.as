package com.sulake.habbo.session.facebook
{
   ...
   public class FaceBookSession implements IDisposable
   {
      ...
      private static const const_1523:String = "sendAccessTokenToServer";
      
      private static const const_1524:String = "fbKLogOut";
      ...
      private function onAuthenticate(param1:FaceBookAuthenticateEvent) : void
      {
         ...
         if(false)
         {
            ExternalInterface.addCallback(const_1523,this.jsFaceBookLogInCallback);
            ExternalInterface.addCallback(const_1524,this.jsFaceBookLogOutCallback);
