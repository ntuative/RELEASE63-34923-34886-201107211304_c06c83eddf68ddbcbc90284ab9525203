package com.sulake.habbo.session.product
{
   ...
   public class ProductDataParser extends EventDispatcher
   {
      ...
      private var var_905:AssetLibrary;
      
      public function ProductDataParser(param1:String, param2:Dictionary)
      {
         super();
         this.var_1317 = param2;
         this.var_905 = new AssetLibrary("ProductDataParserAssetLib");
         var _loc3_:AssetLoaderStruct = this.var_905.loadAssetFromFile(param1,new URLRequest(param1),"text/plain");
