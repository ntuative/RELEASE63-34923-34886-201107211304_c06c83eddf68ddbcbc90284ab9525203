package com.sulake.habbo.quest
{
   ...
   public class AchievementController implements IDisposable, IUpdateReceiver
   {
      ...
      private static const const_1473:int = 8;
      
      private static const const_1468:int = 5;
      
      private static const const_1475:int = 6;
      
      private static const const_1467:int = 3;
      
      private static const const_1464:int = 2;
      
      private static const const_1053:int = 6;
      
      private static const const_1466:int = 180;
      
      private static const const_1472:int = 246;
      
      private static const const_1470:int = 45;
      
      private static const const_1465:Point = new Point(115,93);
      
      private static const const_1471:Point = new Point(72,1);
      ...
      private var var_633:ProgressBar;
      
      private var var_798:ProgressBar;
      
      private var var_1198:Matrix;
      
      private var var_1796:ColorMatrixFilter;
      
      private var var_1474:AchievementData;
      
      private var var_800:Timer;
      
      private var var_634:Dictionary;
      
      private var var_797:AchievementLevelUp;
      ...
      public function AchievementController(param1:HabboQuestEngine)
      {
         ...
         this.var_800 = new Timer(2000,1);
         this.var_800.addEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
         this.var_797 = new AchievementLevelUp(this.var_51);
         this.var_1198 = new Matrix();
         this.var_1796 = this.createGrayscaleFilter();
         this.var_634[16] = 1;
         this.var_634[28] = 6;
         this.var_634[38] = 4;
         this.var_634[39] = 3;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_800)
         {
            this.var_800.removeEventListener(TimerEvent.TIMER,this.switchIntoPendingLevel);
            this.var_800.reset();
            this.var_800 = null;
         }
         if(this.var_633)
      ...
      private function refresh() : void
      {
         ...
         this._window.height = getLowestPoint(this._window.content) + const_1470;
      }
      ...
      private function refreshCategoryList() : void
      {
         ...
         this.var_449.height = getLowestPoint(this.var_449);
      }
      ...
      private function refreshCategoryListFooter() : void
      {
         ...
         this.var_798.refresh(this.var_119.getProgress(),this.var_119.getMaxProgress(),0);
      }
      ...
      private function refreshAchievementList() : void
      {
         ...
         this.var_799.height = getLowestPoint(this.var_799);
      }
      ...
      private function refreshAchievementsHeader() : void
      {
         ...
         this.var_983.findChildByName("category_name_txt").caption = this.var_51.getAchievementCategoryName(this._category.code);
         ...
         this.var_51.setupAchievementCategoryImage(this.var_983,this._category,false);
      }
      ...
      private function refreshAchievementDetails() : void
      {
         ...
         this.var_450.findChildByName("achievement_name_txt").caption = this.var_51.localization.getBadgeName(_loc1_);
         var _loc2_:String = this.var_51.localization.getBadgeDesc(_loc1_);
         this.var_450.findChildByName("achievement_desc_txt").caption = _loc2_ == null ? "" : _loc2_;
         ...
         this.var_51.refreshReward(!this.var_74.finalLevel,this.var_450,this.var_74.levelRewardPointType,this.var_74.levelRewardPoints);
         this.refreshBadgeImageLarge(this.var_450,this.var_74);
         this.var_633.refresh(this.var_74.currentPoints,this.var_74.scoreLimit,this.var_74.type * 10000 + this.var_74.level);
         this.var_633.visible = !this.var_74.finalLevel;
      }
      ...
      private function prepareWindow() : void
      {
         ...
         this.var_449 = IWindowContainer(this._window.findChildByName("categories_cont"));
         this.var_983 = IWindowContainer(this._window.findChildByName("achievements_header_cont"));
         this.var_799 = IWindowContainer(this._window.findChildByName("achievements_cont"));
         this.var_450 = IWindowContainer(this._window.findChildByName("achievement_cont"));
         this.var_1473 = IWindowContainer(this._window.findChildByName("achievements_footer_cont"));
         this.var_1199 = IWindowContainer(this._window.findChildByName("categories_footer_cont"));
         this.var_633 = new ProgressBar(this.var_51,this.var_450,const_1466,"achievements.details.progress",true,const_1465);
         this.var_798 = new ProgressBar(this.var_51,this.var_1199,const_1472,"achievements.categories.totalprogress",true,const_1471);
      }
      
      private function refreshCategoryEntry(param1:int, param2:AchievementCategory) : Boolean
      {
         var _loc3_:IWindowContainer = IWindowContainer(this.var_449.getChildByName("" + param1));
         var _loc4_:int = Math.floor(param1 / const_685);
         var _loc5_:* = _loc4_ < const_1467;
         if(_loc3_ == null)
         {
            ...
            _loc3_.x = (_loc3_.width + const_1473) * (param1 % const_685);
            _loc3_.y = (_loc3_.height + const_1468) * Math.floor(param1 / const_685) + const_1475;
         }
      ...
      {
         var _loc9_:* = null;
         var _loc3_:IWindowContainer = IWindowContainer(this.var_799.getChildByName("" + param1));
         ...
         if(_loc3_ == null)
         {
            ...
            _loc3_.y = _loc3_.height * _loc4_ + const_1474;
      ...
      private function refreshMouseOver(param1:int) : void
      {
         ...
         var _loc5_:* = null;
         var _loc2_:int = 0;
         while(_loc2_ < this.var_449.numChildren)
         {
            _loc3_ = _loc2_ == param1;
            _loc4_ = IWindowContainer(this.var_449.getChildAt(_loc2_));
      ...
      private function refreshBadgeImage(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc7_:int = const_1052 - _loc5_.height + this.getPositionFix(param2.type);
         ...
         {
            _loc3_.bitmap.applyFilter(_loc5_,_loc5_.rect,_loc8_,this.var_1796);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      private function refreshBadgeImageLarge(param1:IWindowContainer, param2:AchievementData) : void
      {
         ...
         var _loc6_:int = 2 * (const_1052 - _loc5_.height + this.getPositionFix(param2.type));
         this.var_1198.identity();
         this.var_1198.scale(2,2);
         this.var_1198.translate((_loc3_.width - _loc5_.width * 2) / 2,_loc6_);
         _loc3_.bitmap.fillRect(_loc3_.bitmap.rect,16777215);
         _loc3_.bitmap.draw(_loc5_,this.var_1198);
         if(!param2.firstLevelAchieved)
         {
            _loc3_.bitmap.applyFilter(_loc3_.bitmap,_loc3_.bitmap.rect,new Point(0,0),this.var_1796);
         }
         _loc3_.visible = false;
         _loc3_.visible = true;
      }
      ...
      {
         this.var_74 = this.var_1474;
         this.var_119.update(this.var_1474);
         this.var_1474 = null;
         this.refresh();
      }
      ...
      {
         return !!this.var_634[param1] ? int(this.var_634[param1]) : 0;
      }
