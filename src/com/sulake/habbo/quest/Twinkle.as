package com.sulake.habbo.quest
{
   ...
   public class Twinkle implements AnimationObject, IDisposable
   {
      ...
      private static const const_1133:Array = [1,2,3,4,5,6,5,4,3,2,1];
      ...
      {
         this.var_1293 = new Point(Math.round(Math.random() * 0),Math.round(Math.random() * 0));
      }
      ...
      {
         return this.getFrame(param1) == const_1132;
      }
      
      public function getBitmap(param1:int) : BitmapData
      {
         var _loc2_:int = this.getFrame(param1);
         return this._twinkleImages.getImage(const_1133[_loc2_]);
      }
      ...
      private function getFrame(param1:int) : int
      {
         ...
         var _loc3_:int = Math.floor(_loc2_ / const_1671);
         if(_loc3_ >= const_1133.length)
         {
            return const_1132;
         }
         return _loc3_;
