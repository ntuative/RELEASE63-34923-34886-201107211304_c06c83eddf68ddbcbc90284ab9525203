package com.sulake.habbo.quest
{
   ...
   public class HabboQuestEngine extends Component implements IHabboQuestEngine, IUpdateReceiver
   {
      ...
      private static const const_1518:int = 800;
      ...
      private var var_1242:QuestController;
      ...
      public function HabboQuestEngine(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_1242 = new QuestController(this);
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_396.events.removeEventListener(BadgeImageReadyEvent.const_209,this.var_1012.onBadgeImageReady);
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_396.events.addEventListener(BadgeImageReadyEvent.const_209,this.var_1012.onBadgeImageReady);
      }
      ...
      {
         return this.var_1242.questTracker.isVisible();
      }
      ...
      public function setupQuestImage(param1:IWindowContainer, param2:QuestMessageData) : void
      {
         ...
         var _loc5_:String = param2.waitPeriodSeconds > 0 ? "quest_timer_questionmark" : (param2.campaignCode + "_" + param2.method_4 + param2.imageVersion + _loc4_).toLowerCase();
      ...
      public function setupPromptFrameImage(param1:IWindowContainer, param2:QuestMessageData, param3:String) : void
      {
         ...
         _loc4_.id = param2.id;
         new PendingImage(this,_loc4_,(param2.campaignCode + "_" + param2.method_4 + param2.imageVersion + "_" + param3).toLowerCase());
      }
      ...
      {
         return QUESTS_WITH_PROMPTS.indexOf(param1.method_4) > -1;
      }
