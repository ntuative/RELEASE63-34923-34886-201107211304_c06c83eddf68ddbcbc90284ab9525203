package com.sulake.habbo.quest
{
   ...
   public class QuestDetails implements IDisposable
   {
      ...
      private static const const_1470:int = 56;
      ...
      private static const const_1508:Array = ["PLACE_ITEM","PLACE_FLOOR","PLACE_WALLPAPER","PET_DRINK","PET_EAT"];
      ...
      public function onQuest(param1:QuestMessageData) : void
      {
         ...
         else if(this.var_141 == null || this.var_141.id != param1.id)
         {
            this.close();
         }
      }
      ...
      private function openDetails(param1:QuestMessageData) : void
      {
         ...
         var _loc2_:* = this.var_141.waitPeriodSeconds > 0;
         ...
         if(!_loc2_)
         {
            ...
            _loc3_.height = _loc3_.textHeight + const_1509;
         }
         ...
         this._window.height = _loc8_.height + const_1470;
      ...
      {
         return this.var_141.waitPeriodSeconds < 1 && const_1508.indexOf(this.var_141.type) > -1;
      }
      
      private function hasNavigatorLink() : Boolean
      {
         var _loc1_:Boolean = this.var_51.localization.hasKey(this.var_141.getCampaignLocalizationKey() + ".searchtag");
         var _loc2_:Boolean = this.var_51.localization.hasKey(this.var_141.getCampaignLocalizationKey() + ".searchtag");
         return this.var_141.waitPeriodSeconds < 1 && (_loc1_ || _loc2_);
      }
      ...
      private function onLinkProc(param1:WindowEvent, param2:IWindow = null) : void
      {
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            ...
            {
               this.var_51.openNavigator(this.var_141);
            }
         }
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         this.var_1515 = NextQuestTimer.const_1020;
         var _loc2_:Boolean = this.var_51.questController.questsList.refreshDelay(this._window,this.var_141);
         if(_loc2_)
         {
            this.openDetails(this.var_141);
         }
      }
   }
}
