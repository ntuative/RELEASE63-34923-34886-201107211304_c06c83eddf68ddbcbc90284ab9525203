package com.sulake.habbo.notifications
{
   ...
   public class HabboNotifications extends Component implements IHabboNotifications, IUpdateReceiver, IGetImageListener
   {
      ...
      private static const const_1531:String = "pixelbalance";
      
      private static const const_1534:String = "badges";
      
      private static const const_1532:String = "selectbadge";
      
      private static const const_1536:String = "inventory";
      
      private static const const_1533:String = "selectfurni";
      
      private static const UILINK_CREDITS:String = "credits";
      
      private static const const_1537:String = "friendlist";
      
      private static const const_1530:String = "pet_inventory";
      
      private static const const_1535:String = "go_to_room";
      ...
      private var var_1912:IHabboToolbar;
      ...
      private var var_553:HabboNotificationViewManager;
      
      private var var_251:HabboAlertDialogManager;
      
      private var var_836:ParkBusDialogManager;
      
      private var var_2606:Boolean;
      
      private var var_1020:ClubGiftNotification;
      
      private var var_1017:ClubEndingNotification;
      
      private var var_1018:ClubPromoNotification;
      ...
      public function HabboNotifications(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         if(_loc5_ != null)
         {
            XMLVariableParser.parseVariableList(XML(_loc5_.content).children(),this.var_1019);
         }
         var _loc6_:Map = this.var_1019["styles"];
         if(_loc6_ != null)
         {
            _loc7_ = 0;
      ...
      private function addItem(param1:String, param2:String, param3:BitmapData, param4:String = null) : int
      {
         ...
         var _loc5_:Map = this.var_1019["styles"];
         if(_loc5_ == null)
         {
            return 0;
         }
      ...
      private function onLocalizationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_251 = new HabboAlertDialogManager(this._windowManager,this._localization);
         if(this._communication)
         {
      ...
      {
         this.var_1912 = param2 as IHabboToolbar;
      }
      ...
      {
         this.var_553 = new HabboNotificationViewManager(this._assetLibrary,this._windowManager,this._config,this.var_1912,this.var_1019["styles"],this.var_1019["view"]);
         ...
         registerUpdateReceiver(this.var_553,1);
         registerUpdateReceiver(this,2);
         this.var_396.events.addEventListener(BadgeImageReadyEvent.const_209,this.onBadgeImage);
      ...
      function onRespectNotification(param1:IMessageEvent) : void
      {
         ...
         if(this.var_396.userId == _loc2_.userId)
         {
            ...
            if(_loc3_)
            {
               this.addItem(_loc3_.value,NotificationType.const_1212,null);
            }
            if(_loc4_)
            {
               this.addItem(_loc4_.value,NotificationType.const_1212,null);
            }
         }
      }
      ...
      public function addSongPlayingNotification(param1:String, param2:String) : void
      {
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1752,null);
         }
      }
      
      public function showGenericNotification(param1:String) : void
      {
         this.addItem(param1,NotificationType.const_937,null);
      }
      ...
      private function onPurchaseOK(param1:IMessageEvent) : void
      {
         ...
         for each(_loc6_ in _loc4_.products)
         {
            if(_loc6_)
            {
               ...
               if(_loc8_)
               {
                  this.addItem(_loc8_.value,NotificationType.const_1819,_loc5_);
               }
            }
         }
      ...
      private function onRecyclerFinished(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || _loc2_.recyclerFinishedStatus != RecyclerFinishedMessageEvent.const_1299)
         {
            return;
         }
         ...
         if(_loc3_)
         {
            this.addItem(_loc3_.value,NotificationType.const_1931,null);
         }
      ...
      private function onSubscriptionInfo(param1:IMessageEvent) : void
      {
         ...
         else
         {
            ...
            if(_loc2_.isShowBasicPromo)
            {
               ...
               this.var_1018 = new ClubPromoNotification(_loc2_.basicNormalPrice,_loc2_.basicPromoPrice,assets,this._windowManager,this._catalog,this._localization);
            }
         }
      }
      ...
      private function checkClubEndingNotification(param1:ScrSendUserInfoMessageParser) : void
      {
         ...
         if(_loc2_ > 0 && param1.daysToPeriodEnd > 0 && param1.daysToPeriodEnd <= _loc2_ && param1.periodsSubscribedAhead == 0)
         {
            ...
            this.var_1017 = new ClubEndingNotification(param1.daysToPeriodEnd,param1.isVIP,assets,this._windowManager,this._catalog,this._localization);
         }
      }
      ...
      {
         var _loc2_:* = null;
         if(this.var_553.isSpaceAvailable() && this.var_1258.length > 0)
         {
            _loc2_ = this.getNextItemFromQueue();
            if(!this.var_553.showItem(_loc2_))
            {
               _loc2_.dispose();
            }
         }
      ...
      public function onExecuteLink(param1:String) : void
      {
         switch(param1)
         {
            ...
            case const_1534:
               if(this.var_12 != null)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_213);
               }
               break;
            case const_1532:
               break;
            ...
            case const_1530:
               if(this.var_12 != null && this.var_12.hasRoomSession)
               {
                  this.var_12.toggleInventoryPage(InventoryCategory.const_124);
               }
               break;
            case const_1533:
               break;
      ...
      {
         if(param1 != null && this.var_553 != null)
         {
            this.var_553.replaceIcon(param1);
         }
      }
      ...
      private function onModMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(_loc2_ == null || this.var_251 == null)
         {
            return;
         }
         this.var_251.handleModMessage(_loc2_.message,_loc2_.url);
      }
      ...
      private function onUserBannedMessageEvent(param1:IMessageEvent) : void
      {
         ...
         this.var_251.handleUserBannedMessage(_loc2_.message);
      }
      ...
      private function onHotelClosing(param1:IMessageEvent) : void
      {
         ...
         this.var_251.handleHotelClosingMessage(_loc2_.minutesUntilClosing);
      }
      ...
      private function onHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_251.handleHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute,_loc2_.userThrownOutAtClose);
      }
      ...
      private function onLoginFailedHotelClosed(param1:IMessageEvent) : void
      {
         ...
         this.var_251.handleLoginFailedHotelClosedMessage(_loc2_.openHour,_loc2_.openMinute);
      }
      ...
      private function onParkBusMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(this.var_836 == null)
         {
            this.var_836 = new ParkBusDialogManager(this._windowManager,assets,this._localization);
         }
         if(_loc2_ != null || this.var_836 != null)
         {
            this.var_836.handleParkBusCannotEnter(_loc2_.reason);
         }
      }
      ...
      private function onPetLevelNotification(param1:PetLevelNotificationEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1248,_loc4_);
         }
      }
      ...
      private function onPetReceived(param1:PetReceivedMessageEvent) : void
      {
         ...
         if(_loc3_)
         {
            ...
            this.addItem(_loc3_.value,NotificationType.const_1248,_loc5_);
         }
      }
      ...
      private function getPetImage(param1:int, param2:int, param3:String) : BitmapData
      {
         ...
         if(param1 < 8)
         {
            ...
            _loc6_ = this.var_1095.createPetImage(param1,param2,_loc5_,AvatarScaleType.const_61);
            if(_loc6_ != null)
            {
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         ...
         if(!this.var_2606)
         {
            ...
            this.addItem(_loc2_,NotificationType.const_937,null);
            this.var_2606 = true;
      ...
      {
         if(param2.type == WindowEvent.const_146 || param2.type == WindowEvent.const_660)
         {
            param1.dispose();
         }
      }
      ...
      private function onClubGiftNotification(param1:ClubGiftNotificationEvent) : void
      {
         ...
         if(this.var_1020 && this.var_1020.visible)
         {
            return;
         }
         this.var_1020 = new ClubGiftNotification(_loc2_.numGifts,assets,this._windowManager,this._catalog,this.var_1912);
      }
      ...
      private function onClubGiftSelected(param1:ClubGiftSelectedEvent) : void
      {
         ...
         this.addItem(_loc5_,NotificationType.const_937,_loc6_);
      }
   }
}
