package com.sulake.habbo.inventory.badges
{
   ...
   public class BadgesModel implements IInventoryModel
   {
      ...
      public function BadgesModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:ISessionDataManager)
      {
         ...
         this.var_396 = param5;
         this.var_396.events.addEventListener(BadgeImageReadyEvent.const_209,this.onBadgeImageReady);
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_396.events.removeEventListener(BadgeImageReadyEvent.const_209,this.onBadgeImageReady);
            this.var_396 = null;
         }
      }
      ...
      private function stopWearingBadge(param1:Badge) : void
      {
         ...
         {
            if(this.var_906[_loc2_] == param1)
            {
               this.var_906.splice(_loc2_,1);
      ...
      public function updateBadge(param1:String, param2:Boolean, param3:int = 0) : void
      {
         ...
         if(param3 > 0)
         {
            this.var_1374.add(param1,param3);
         }
         ...
         else
         {
            ...
            _loc10_ = this.var_726.indexOf(param3) != -1;
      ...
      public function saveBadgeSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_350);
         var _loc3_:int = 0;
      ...
      public function forceSelection() : void
      {
         ...
         var _loc2_:Array = this.getBadges(const_587);
         ...
         var _loc3_:Array = this.getBadges(const_350);
      ...
      {
         return this.getItemInIndex(param1,const_350);
      }
      
      public function getBadgeFromInactive(param1:int) : Badge
      {
         return this.getItemInIndex(param1,const_587);
      }
      ...
      {
         if(param1 == InventoryCategory.const_213 && this.var_26.isVisible)
         {
      ...
      public function addUnseenBadges(param1:Array) : void
      {
         ...
         {
            if(this.var_726.indexOf(_loc2_) == -1)
            {
               this.var_726.push(_loc2_);
            }
         }
      }
      ...
      public function resetUnseenItems() : void
      {
         ...
         if(this.var_726 && this.var_726.length > 0)
         {
            _loc1_.send(new ResetUnseenItemsComposer(UnseenItemCategoryEnum.const_1200));
            this.var_726 = [];
