package com.sulake.habbo.inventory
{
   ...
   public class ItemPopupCtrl
   {
      ...
      private static const const_1568:int = 250;
      
      private static const const_1567:int = 100;
      
      private static const const_1569:int = 180;
      ...
      {
         this.var_395 = new Timer(const_1568,1);
         this.var_394 = new Timer(const_1567,1);
         super();
         if(param1 == null)
         {
            return;
         ...
         this._assets = param2;
         this.var_395.addEventListener(TimerEvent.TIMER,this.onDisplayTimer);
         this.var_394.addEventListener(TimerEvent.TIMER,this.onHideTimer);
         var _loc3_:BitmapDataAsset = this._assets.getAssetByName("popup_arrow_right_png") as BitmapDataAsset;
         if(_loc3_ != null && _loc3_.content != null)
         {
            this.var_1032 = _loc3_.content as BitmapData;
         }
      ...
      public function dispose() : void
      {
         ...
         {
            this.var_395.removeEventListener(TimerEvent.TIMER,this.onDisplayTimer);
            this.var_395.stop();
            this.var_395 = null;
         }
      ...
      public function updateContent(param1:IWindowContainer, param2:String, param3:BitmapData, param4:int = 2) : void
      {
         ...
         if(_loc6_)
         {
            _loc7_ = new BitmapData(Math.min(const_1569,param3.width),Math.min(const_1566,param3.height),true,16777215);
      ...
      public function show() : void
      {
         ...
         this.refreshArrow(this.var_1954);
         switch(this.var_1954)
         {
            case const_1331:
               this.var_93.x = -1 * this.var_93.width - const_1089;
               break;
            case const_554:
               this.var_93.x = this._parent.width + const_1089;
         }
      ...
      private function refreshArrow(param1:int = 2) : void
      {
         ...
         {
            case const_1331:
               _loc2_.bitmap = this.var_1032.clone();
               _loc2_.width = this.var_1032.width;
               _loc2_.height = this.var_1032.height;
               _loc2_.y = (this.var_93.height - this.var_1032.height) / 2;
