package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsView implements IInventoryView, IPetImageListener, IGetImageListener
   {
      ...
      private const const_2094:int = 0;
      
      private const const_1058:int = 1;
      ...
      public function PetsView(param1:PetsModel, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IRoomEngine, param6:IAvatarRenderManager)
      {
         ...
         this.var_222 = this._view.findChildByName("grid") as IItemGridWindow;
      ...
      public function removePet(param1:int) : void
      {
         ...
         this.var_222.removeGridItem(_loc2_.window);
      ...
      public function addPet(param1:PetData) : void
      {
         ...
         if(_loc2_ != null)
         {
            this.var_222.addGridItem(_loc2_.window);
      ...
      public function updateState() : void
      {
         ...
         {
            _loc2_ = this.const_1140;
         }
         else
         {
            _loc2_ = this.const_1142;
         }
         ...
         switch(_loc2_)
         {
            case this.const_1058:
               ...
               break;
            case this.const_1140:
               _loc3_.visible = false;
               _loc4_.visible = true;
               _loc5_.visible = false;
               _loc6_.visible = false;
               break;
            case this.const_1142:
               _loc3_.visible = false;
               _loc4_.visible = false;
               _loc5_.visible = true;
               _loc6_.visible = true;
      ...
      public function updateCategoryButtons() : void
      {
         ...
         _loc1_.visible = this.var_78.furniModel.getUnseenItemCount(UnseenItemCategoryEnum.const_438) > 0;
