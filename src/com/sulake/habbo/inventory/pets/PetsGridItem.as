package com.sulake.habbo.inventory.pets
{
   ...
   public class PetsGridItem
   {
      ...
      private function eventHandler(param1:WindowEvent, param2:IWindow) : void
      {
         switch(param1.type)
         {
            case WindowMouseEvent.const_46:
               this.var_1659.setSelectedGridItem(this);
               this.var_1660 = true;
               break;
            ...
            case WindowMouseEvent.const_25:
               ...
               {
                  this.var_1660 = false;
                  this.var_1659.placePetToRoom(this._petData.id,true);
               }
         }
      }
      ...
      public function setSelected(param1:Boolean) : void
      {
         ...
         this.var_1525.color = !!this.var_1634 ? uint(const_1673) : uint(const_1672);
         this.var_2906.visible = param1;
      }
