package com.sulake.habbo.inventory
{
   ...
   public class InventoryMainView
   {
      ...
      private var var_2116:IWindowContainer;
      
      private var var_889:String;
      
      private var var_2907:IWindowContainer;
      ...
      private const const_2071:Point = new Point(120,150);
      ...
      public function showInventory() : void
      {
         ...
         _loc1_.visible = true;
         this.var_26.inventoryViewOpened(this.var_889);
      }
      ...
      public function updateSubCategoryView() : void
      {
         ...
         this.setSubViewToCategory(this.var_889);
      }
      ...
      private function resetUnseenCounters(param1:String) : void
      {
         switch(param1)
         {
            case InventoryCategory.const_74:
               ...
               break;
            case InventoryCategory.const_124:
               this.var_26.petsModel.resetUnseenItems();
               break;
            case InventoryCategory.const_213:
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         _loc2_.container.removeChild(this.var_2116);
         _loc2_.invalidate();
      ...
      private function onHabboToolbarEvent(param1:HabboToolbarEvent) : void
      {
         ...
         {
            if(this.var_412 == InventoryCategory.const_124)
            {
               this.toggleCategoryView(InventoryCategory.const_124);
            }
