   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      override public function dispose() : void
      {
         ...
         if(this.var_15 != null)
         {
            ...
            this.var_15.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_551,this.roomSessionEventHandler);
      ...
      public function get furniModel() : FurniModel
      {
         ...
         return FurniModel(this.var_62.getValue(InventoryCategory.const_74));
      }
      ...
      public function get tradingModel() : TradingModel
      {
         ...
         return TradingModel(this.var_62.getValue(InventorySubCategory.const_327));
      }
      ...
      public function get badgesModel() : BadgesModel
      {
         ...
         return BadgesModel(this.var_62.getValue(InventoryCategory.const_213));
      }
      ...
      public function get recyclerModel() : RecyclerModel
      {
         ...
         return RecyclerModel(this.var_62.getValue(InventorySubCategory.const_1253));
      }
      ...
      public function get petsModel() : PetsModel
      {
         ...
         return PetsModel(this.var_62.getValue(InventoryCategory.const_124));
      }
      ...
      public function get marketplaceModel() : MarketplaceModel
      {
         ...
         return this.var_62.getValue(InventoryCategory.const_395) as MarketplaceModel;
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         this.var_15.events.addEventListener(RoomSessionPropertyUpdateEvent.const_551,this.roomSessionEventHandler);
         this.initInventory();
      }
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_86:
               ...
               break;
            case RoomSessionPropertyUpdateEvent.const_551:
               if(this.petsModel != null)
               {
                  this.petsModel.updatePetsAllowed();
               }
      ...
      private function initInventory() : void
      {
         ...
         this.var_62.add(InventoryCategory.const_395,_loc1_);
         ...
         this.var_62.add(InventorySubCategory.const_327,_loc5_);
         ...
         this.var_62.add(InventorySubCategory.const_1253,_loc6_);
         ...
         this.var_62.add(InventoryCategory.const_124,_loc7_);
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            if(this.var_993.indexOf(param1) == -1)
            {
         ...
         {
            _loc3_ = this.var_993.indexOf(param1);
            if(_loc3_ >= 0)
            {
               this.var_993.splice(_loc3_,1);
            }
         }
      }
      ...
      {
         if(this.var_993.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(this.const_2341);
         }
      }
      
      public function notifyChangedEffects() : void
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_273));
      }
      ...
      public function updateUnseenItemCounts() : void
      {
         ...
         if(_loc1_ != this.var_2436)
         {
            this.var_2436 = _loc1_;
