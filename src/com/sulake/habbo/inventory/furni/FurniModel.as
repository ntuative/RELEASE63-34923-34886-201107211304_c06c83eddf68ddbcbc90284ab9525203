package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel extends FurniModelCategory implements IInventoryModel
   {
      ...
      private static const const_1489:int = 1000;
      ...
      private var var_1511:Vector.<Array>;
      ...
      public function FurniModel(param1:HabboInventory, param2:MarketplaceModel, param3:IHabboWindowManager, param4:IHabboCommunicationManager, param5:IAssetLibrary, param6:IRoomEngine, param7:IHabboCatalog, param8:IHabboSoundManager)
      {
         ...
         this.var_458 = [];
         this.var_459 = [];
         this.var_645 = new Timer(const_1488,1);
         this.var_645.addEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
         var _loc9_:IAsset = this._assets.getAssetByName("inventory_thumb_xml");
         var _loc10_:XmlAsset = XmlAsset(_loc9_);
         this.var_2493 = XML(_loc10_.content);
         this.clearFurniList();
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            ...
            {
               this.var_645.removeEventListener(TimerEvent.TIMER_COMPLETE,this.onImageUpdateTimerEvent);
               this.var_645.stop();
               this.var_645 = null;
            }
      ...
      public function insertFurniList(param1:String, param2:Array, param3:int, param4:int) : void
      {
         ...
         if(param3 >= param4 && param3 > 1)
         {
            if(param1 == const_36)
            {
               ...
               {
                  this.var_1511 = new Vector.<Array>(param3,true);
               }
               _loc15_ = this.var_1511;
            }
            else
            {
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Number = NaN, param6:Boolean = false) : GroupItem
      {
         ...
         if(this.var_821 == null)
         {
            this.var_821 = this._windowManager.buildFromXML(this.var_2493) as IWindowContainer;
         ...
         if(param1 == InventoryCategory.const_74 && this.var_26.isVisible)
         {
            switch(this._view.visibleCategoryId)
            {
               ...
               case const_45:
                  ...
                  break;
               case const_265:
                  this.var_26.toggleInventoryPage(InventoryCategory.const_124);
            }
         }
      }
      ...
      {
         this.var_26.checkCategoryInitilization(InventoryCategory.const_395);
      ...
      public function clearFurniList() : void
      {
         ...
         this.var_644.add(const_36,new Array());
         this.var_644.add(const_45,new Array());
         if(this._view != null)
         {
      ...
      {
         return getTimer() < this.var_2492 + const_1489;
      }
      ...
      {
         return this.var_26.getSubCategoryViewId() == InventorySubCategory.const_327;
      }
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_357 || _loc3_.category == FurniCategory.const_367 || _loc3_.category == FurniCategory.const_344)
         {
            if(param1)
            {
               return false;
      ...
      public function getAllStripIds(param1:String, param2:Array) : void
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:int = 0;
         var _loc3_:Array = this.var_644.getValue(param1) as Array;
         if(_loc3_ != null)
         {
            for each(_loc4_ in _loc3_)
            {
               _loc5_ = _loc4_.getTotalCount();
               if(_loc4_.category == FurniCategory.const_946)
               {
                  _loc5_ = 1;
               }
               _loc6_ = 0;
