package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniGridView
   {
      ...
      private var var_222:IItemGridWindow;
      
      private var var_547:IWindow;
      ...
      public function FurniGridView(param1:FurniModel, param2:String, param3:IHabboWindowManager, param4:IAssetLibrary, param5:IRoomEngine)
      {
         ...
         if(this._view != null)
         {
            this.var_222 = this._view.findChildByName("item_grid") as IItemGridWindow;
         }
      }
      ...
      public function clearGrid() : void
      {
         ...
         {
            this.var_222.removeGridItems();
         }
      }
      
      public function updateItem(param1:int, param2:IWindowContainer) : void
      {
         var _loc3_:IWindow = this.var_222.getGridItemAt(param1);
         if(_loc3_)
         {
            _loc3_ = param2;
         }
      ...
      public function setLock(param1:Boolean) : void
      {
         if(param1)
         {
            this.var_222.autoArrangeItems = false;
            this.var_222.lock();
         }
         else
         {
            this.var_222.autoArrangeItems = true;
            this.var_222.unlock();
         }
      }
      ...
      private function itemEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowMouseEvent.const_46)
         {
            ...
            this.var_78.toggleItemSelection(this._category,this.var_222.getGridItemIndex(param1.window));
            this.var_547 = param2;
         }
         else if(param1.type == WindowMouseEvent.const_25 && this.var_547 != null && this.var_547 == param2 && !this.var_78.isTradingOpen)
         {
