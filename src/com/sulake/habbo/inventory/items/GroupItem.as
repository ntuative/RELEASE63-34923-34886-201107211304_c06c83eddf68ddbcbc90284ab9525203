package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      private static const const_1672:int = 13421772;
      
      private static const const_1673:int = 10275685;
      ...
      protected var var_940:int = 0;
      
      protected var var_755:BitmapData;
      ...
      protected var var_3064:BitmapData;
      
      private var var_1641:Boolean;
      
      private const const_2093:Number = 1;
      ...
      public function GroupItem(param1:int, param2:String, param3:int, param4:IWindowContainer, param5:IRoomEngine, param6:BitmapData, param7:Boolean, param8:String = null, param9:Number = NaN, param10:BitmapData = null, param11:Boolean = false)
      {
         ...
         this.var_2906 = this._window.findChildByName("outline");
      ...
      public function initImage(param1:Boolean = true) : void
      {
         ...
         if(this.var_2275 == FurniModelCategory.const_36)
         {
            _loc2_ = this._roomEngine.getFurnitureIcon(this._type,this,String(this.var_1601));
         }
         else
         {
      ...
      public function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            {
               this._window.blend = this.const_2093;
               _loc1_.blend = this.const_2093;
            }
         }
         this.var_1525.color = !!this.var_1641 ? uint(const_1673) : uint(const_1672);
         this.var_2906.visible = this.isSelected;
         ...
         if(_loc5_)
         {
            if(this.var_2274 && this.getRecyclableCount() > 0)
            {
               _loc5_.bitmap = this.var_3064;
               _loc5_.visible = true;
            }
            else
            {
