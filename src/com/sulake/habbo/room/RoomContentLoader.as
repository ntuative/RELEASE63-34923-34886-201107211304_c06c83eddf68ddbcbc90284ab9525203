package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IFurniDataListener, IDisposable
   {
      ...
      private static const const_2060:int = 0;
      
      private static const const_1058:int = 1;
      
      private static const name_5:int = 2;
      
      private static const const_475:String = "place_holder";
      
      private static const const_690:String = "wall_place_holder";
      
      private static const const_689:String = "pet_place_holder";
      
      private static const PLACE_HOLDER_DEFAULT:String = const_475;
      ...
      private var var_1485:IEventDispatcher = null;
      ...
      private var var_218:PublicRoomData = null;
      
      private var var_1484:Map = null;
      ...
      {
         this.var_380 = new Dictionary();
         this._wallItems = new Dictionary();
         this._pets = new Dictionary();
         this.var_2416 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         this.var_2419 = ["room_public","room_public_park","room_public_pool"];
         super();
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         this.var_2415 = param2.getKey("flash.dynamic.download.url","furniture/");
         this.var_2418 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
      ...
      public function dispose() : void
      {
         ...
         {
            _loc2_ = this.var_534.length;
            _loc3_ = 0;
            while(_loc3_ < _loc2_)
            {
               _loc4_ = this.var_534.getWithIndex(_loc3_) as AssetLibrary;
               if(_loc4_ != null)
               {
                  _loc4_.dispose();
               }
         ...
         if(this.var_452 != null)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               _loc5_ = this.var_452.getWithIndex(_loc3_) as IGraphicAssetCollection;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         {
            for(_loc1_ in this.var_380)
            {
               delete this.var_380[_loc1_];
            }
            this.var_380 = null;
         }
      ...
      private function populateFurniData(param1:Array) : void
      {
         ...
         for each(_loc2_ in param1)
         {
            ...
            {
               this.var_807.add(_loc4_,_loc6_);
            }
            _loc7_ = _loc2_.name;
            if(_loc2_.type == "s")
            {
               this.var_453.add(_loc3_,_loc4_);
               if(this.var_380[_loc7_] == null)
               {
                  this.var_380[_loc7_] = 1;
               }
            }
      ...
      private function continueInitilization() : void
      {
         if(this.var_2417)
         {
            ...
            {
               this.var_1485.dispatchEvent(new Event(const_989));
            }
         }
      }
      ...
      public function setRoomObjectAlias(param1:String, param2:String) : void
      {
         if(this.var_536 != null)
         {
            this.var_536.remove(param1);
            this.var_536.add(param1,param2);
         }
         if(this.var_535 != null)
         {
            this.var_535.remove(param2);
            this.var_535.add(param2,param1);
         }
      }
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(this.var_218 != null && (this.var_218.type == param1 || this.var_218.hasWorldType(param1)))
         {
      ...
      {
         return [const_475,const_690,const_689,const_691,TILE_CURSOR,const_1059];
      }
      
      public function getActiveObjectType(param1:int) : String
      {
         var _loc2_:String = this.var_453.getValue(param1) as String;
      ...
      public function getRoomObjectAdURL(param1:String) : String
      {
         ...
         {
            return this.var_807.getValue(param1);
         }
         return "";
      }
      ...
      {
         if(this.var_218 != null && this.var_218.hasWorldType(const_389 + param1))
         {
            return this.var_218.type;
         }
         return param1;
      }
      ...
      {
         if(param1 == RoomObjectVisualizationEnum.const_251 || param1 == RoomObjectVisualizationEnum.const_56 || param1 == RoomObjectVisualizationEnum.BOT)
         {
            return true;
         }
         return false;
      ...
      public function insertObjectContent(param1:int, param2:int, param3:IAssetLibrary) : Boolean
      {
         ...
         if(_loc5_)
         {
            ...
            if(this.initializeGraphicAssetCollection(_loc4_,param3))
            {
               ...
               {
                  case RoomObjectCategoryEnum.const_27:
                     if(this.var_380[_loc4_] == null)
                     {
                        this.var_380[_loc4_] = 1;
                     }
                     break;
                  case RoomObjectCategoryEnum.const_26:
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         if(this.var_1484.getValue(param1) != null)
         {
            this.var_218 = this.var_1484.getValue(param1) as PublicRoomData;
         }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         {
            if(_loc3_[_loc5_].toString().length > 0 && this.var_2416.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,Core.const_1874);
               return;
            }
         }
      }
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(this.var_2419.indexOf(this.getVisualizationType(_loc5_)) >= 0)
            {
         ...
         {
            _loc3_ = new RoomContentLoadedEvent(RoomContentLoadedEvent.const_658,_loc5_);
         }
      ...
      private function extractPublicRoomDataFromLoadedContent(param1:String, param2:IAssetLibrary) : void
      {
         ...
         this.var_1484.add(param1,_loc4_);
         this.var_218 = _loc4_;
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         var _loc3_:IAssetLibrary = this.var_534.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
         if(_loc3_ == null)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc3_ = this.var_534.getValue(this.getAssetLibraryName(_loc2_)) as IAssetLibrary;
            }
         }
         return _loc3_;
      }
      ...
      private function addAssetLibraryCollection(param1:String, param2:IEventDispatcher) : IAssetLibrary
      {
         ...
         this.var_534.add(_loc5_,_loc4_);
      ...
      private function createGraphicAssetCollection(param1:String, param2:IAssetLibrary) : IGraphicAssetCollection
      {
         ...
         _loc3_ = this.var_600.createGraphicAssetCollection();
         if(_loc3_ != null)
         {
      ...
      {
         var _loc2_:String = this.getContentType(param1);
         return this.var_452.getValue(_loc2_) as IGraphicAssetCollection;
      }
      ...
      private function disposeGraphicAssetCollection(param1:String) : Boolean
      {
         var _loc3_:* = null;
         var _loc2_:String = this.getContentType(param1);
         if(this.var_452[_loc2_] != null)
         {
            _loc3_ = this.var_452.remove(_loc2_);
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
      ...
      {
         if(this.getObjectCategory(const_389 + param1) == RoomObjectCategoryEnum.const_85)
         {
            return true;
         }
         return false;
      ...
      public function getPublicRoomWorldHeightScale(param1:String) : Number
      {
         ...
         {
            return this.var_218.getWorldHeightScale(const_389 + param1);
         }
         return 1;
      }
      ...
      public function getPublicRoomWorldSize(param1:String) : int
      {
         if(this.var_218 != null)
         {
            return this.var_218.getWorldScale(const_389 + param1);
         }
         return 32;
      }
