package com.sulake.habbo.room.object.logic.furniture
{
   ...
   public class FurnitureLogic extends MovingObjectLogic
   {
      ...
      private static const const_1157:Number = 0.0625;
      ...
      private var var_1684:Number = 0.0;
      ...
      private var var_1390:RoomObjectUpdateMessage;
      ...
      {
         var _loc1_:Array = [RoomObjectRoomAdEvent.const_380,RoomObjectRoomAdEvent.const_349,RoomObjectRoomAdEvent.const_581,RoomObjectStateChangeEvent.const_67,RoomObjectMouseEvent.const_157,RoomObjectRoomAdEvent.const_235,RoomObjectMouseEvent.const_572];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc3_.length() == 1)
         {
            this.var_1684 = Number(_loc3_);
         }
         this.var_2637 = this.var_555 / 2;
         this.var_2636 = this.var_661 / 2;
         _loc3_ = _loc2_.@centerZ;
         if(_loc3_.length() == 1)
         {
            this.var_2177 = Number(_loc3_);
         }
         else
         {
            this.var_2177 = this.var_1684 / 2;
         }
         ...
         object.getModelController().setNumber(RoomObjectVariableEnum.const_295,this.var_555,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_363,this.var_661,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_582,this.var_1684,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1833,this.var_2637,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_1865,this.var_2636,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_910,this.var_2177,true);
         object.getModelController().setNumberArray(RoomObjectVariableEnum.const_735,this.var_294,true);
         object.getModelController().setNumber(RoomObjectVariableEnum.const_359,1);
      }
      ...
      private function handleDataUpdateMessage(param1:RoomObjectDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            ...
            _loc2_.setNumber(RoomObjectVariableEnum.const_784,lastUpdateTime);
         }
      }
      ...
      private function handleItemDataUpdateMessage(param1:RoomObjectItemDataUpdateMessage) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_1365,param1.itemData);
         }
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(param1.dir != null && param1.loc != null)
         {
            if(!(param1 is RoomObjectMoveUpdateMessage))
            {
               ...
               if(_loc4_ != null && _loc4_.x != param1.dir.x && this.var_2176 && _loc5_ != null && _loc5_.x == param1.loc.x && _loc5_.y == param1.loc.y && _loc5_.z == param1.loc.z)
               {
                  this.var_419 = 1;
                  this.var_1390 = new RoomObjectUpdateMessage(param1.loc,param1.dir);
                  param1 = null;
               }
            }
            this.var_2176 = true;
      ...
      override protected function getLocationOffset() : IVector3d
      {
         if(this.var_419 > 0)
         {
            this.var_1125.x = 0;
            this.var_1125.y = 0;
            if(this.var_419 <= const_489 / 2)
            {
               this.var_1125.z = const_1157 * this.var_419;
            }
            else if(this.var_419 <= const_489)
            {
               if(this.var_1390)
               {
                  super.processUpdateMessage(this.var_1390);
                  this.var_1390 = null;
               }
               this.var_1125.z = const_1157 * (const_489 - this.var_419);
            }
