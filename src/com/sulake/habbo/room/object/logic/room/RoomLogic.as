package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1736:int = 255;
      
      private var var_1565:uint = 16777215;
      
      private var var_1948:int = 255;
      ...
      {
         var _loc1_:Array = [RoomObjectMouseEvent.const_529,RoomObjectMouseEvent.const_157];
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_966,param1.toString());
            _loc2_.setNumber(RoomObjectVariableEnum.const_1011,16777215);
         ...
         if(this.var_1564)
         {
            if(object != null)
            {
               ...
               if(_loc2_ != null)
               {
                  ...
                  _loc2_.setString(RoomObjectVariableEnum.const_966,_loc3_.toString());
                  _loc2_.setNumber(RoomObjectVariableEnum.const_1406,param1);
      ...
      private function updateBackgroundColor(param1:int) : void
      {
         ...
         if(this.var_1279)
         {
            _loc2_ = param1;
            _loc3_ = this._color;
            _loc4_ = this.var_1736;
            if(_loc2_ - this.var_1279 >= this.var_1949)
            {
               _loc3_ = this.var_1278;
               _loc4_ = this.var_1947;
               this.var_1279 = 0;
            }
            else
            {
               _loc7_ = this.var_1565 >> 16 & 255;
               _loc8_ = this.var_1565 >> 8 & 255;
               _loc9_ = this.var_1565 & 255;
               _loc10_ = this.var_1278 >> 16 & 255;
               _loc11_ = this.var_1278 >> 8 & 255;
               _loc12_ = this.var_1278 & 255;
               _loc13_ = (_loc2_ - this.var_1279) / this.var_1949;
               _loc7_ += (_loc10_ - _loc7_) * _loc13_;
               _loc8_ += (_loc11_ - _loc8_) * _loc13_;
               _loc9_ += (_loc12_ - _loc9_) * _loc13_;
               _loc3_ = (_loc7_ << 16) + (_loc8_ << 8) + _loc9_;
               _loc4_ = this.var_1948 + (this.var_1947 - this.var_1948) * _loc13_;
               this._color = _loc3_;
               this.var_1736 = _loc4_;
            }
            ...
            _loc6_.setNumber(RoomObjectVariableEnum.const_1011,_loc3_);
         }
      }
      ...
      private function updatePlaneTypes(param1:RoomObjectRoomUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            ...
            case RoomObjectRoomUpdateMessage.const_869:
               param2.setString(RoomObjectVariableEnum.const_232,param1.value);
               break;
      ...
      private function updatePlaneMasks(param1:RoomObjectRoomMaskUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomMaskUpdateMessage.const_654:
               ...
               this.var_573.addMask(param1.maskId,param1.maskType,param1.maskLocation,_loc5_);
               _loc4_ = true;
               break;
            case RoomObjectRoomMaskUpdateMessage.const_866:
               _loc4_ = this.var_573.removeMask(param1.maskId);
         }
         if(_loc4_)
         {
            _loc6_ = this.var_573.getXML();
            _loc7_ = _loc6_.toXMLString();
            param2.setString(RoomObjectVariableEnum.const_1283,_loc7_);
         }
      }
      ...
      private function updatePlaneVisibilities(param1:RoomObjectRoomPlaneVisibilityUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         switch(param1.type)
         {
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1367:
               param2.setNumber(RoomObjectVariableEnum.const_957,_loc3_);
               break;
            case RoomObjectRoomPlaneVisibilityUpdateMessage.const_1397:
      ...
      private function updatePlaneProperties(param1:RoomObjectRoomPlanePropertyUpdateMessage, param2:IRoomObjectModelController) : void
      {
         switch(param1.type)
         {
            case RoomObjectRoomPlanePropertyUpdateMessage.const_681:
               param2.setNumber(RoomObjectVariableEnum.const_1183,param1.value);
               break;
            case RoomObjectRoomPlanePropertyUpdateMessage.const_1188:
               param2.setNumber(RoomObjectVariableEnum.const_1165,param1.value);
         }
      }
      ...
      private function updateColors(param1:RoomObjectRoomColorUpdateMessage, param2:IRoomObjectModelController) : void
      {
         ...
         this.var_1565 = this._color;
         this.var_1948 = this.var_1736;
         this.var_1278 = _loc3_;
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1958,_loc19_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1764,_loc20_);
            ...
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc12_ == RoomPlaneData.const_310 || _loc12_ == RoomPlaneData.const_416)
                     {
                        _loc26_ = 90;
                        if(_loc11_ != null)
                        {
