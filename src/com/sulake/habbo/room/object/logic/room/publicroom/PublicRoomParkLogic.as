package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomParkLogic extends PublicRoomLogic
   {
      ...
      private static const const_1600:String = "goawaybus";
      
      private static const const_1601:String = "bus";
      
      private static const const_1602:String = "bus_oviopen_hidden";
      ...
      {
         var _loc1_:Array = [RoomObjectRoomActionEvent.const_569,RoomObjectRoomActionEvent.const_629];
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  case const_1600:
                     _loc6_ = new RoomObjectRoomActionEvent(RoomObjectRoomActionEvent.const_569,0,_loc4_,_loc5_);
                     break;
                  case const_1601:
                  case const_1602:
