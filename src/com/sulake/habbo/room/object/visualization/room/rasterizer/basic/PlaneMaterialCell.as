package com.sulake.habbo.room.object.visualization.room.rasterizer.basic
{
   ...
   public class PlaneMaterialCell
   {
      ...
      private var var_743:PlaneTexture;
      ...
      public function method_2(param1:IVector3d) : int
      {
         var _loc2_:* = null;
         if(this.var_743 != null)
         {
            _loc2_ = this.var_743.getBitmap(param1);
            if(_loc2_ != null)
            {
            ...
            if(_loc2_ != null)
            {
               if(!this.isStatic)
               {
                  ...
                  while(_loc6_ < _loc3_)
                  {
                     ...
                     _loc8_ = this.var_1133[_loc6_ % this.var_1133.length] as IGraphicAsset;
