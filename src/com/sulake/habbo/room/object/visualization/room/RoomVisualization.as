package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_2006:int = 16777215;
      
      public static const const_1902:int = 13421772;
      ...
      public static const const_1987:int = 16777215;
      
      public static const const_1847:int = 13421772;
      
      public static const const_1906:int = 10066329;
      ...
      private var var_857:Rectangle = null;
      
      private var var_573:RoomPlaneBitmapMaskParser = null;
      
      private var var_1450:String = null;
      
      private var _floorType:String = null;
      
      private var var_1451:String = null;
      
      private var var_949:Number = NaN;
      
      private var var_1444:Number = NaN;
      
      private var var_2730:Number = NaN;
      
      private var var_2004:String = null;
      
      private var var_1301:uint = 16777215;
      
      private var var_2729:int = 255;
      
      private var var_2728:int = 255;
      ...
      private const const_2364:int = 250;
      
      private var var_1805:int = -1;
      
      private var var_1483:Number = 0.0;
      
      private var var_2411:Number = 0.0;
      
      private var var_2413:Number = 0.0;
      
      private var var_2005:Number = 0.0;
      ...
      public function RoomVisualization()
      {
         ...
         this.var_573 = new RoomPlaneBitmapMaskParser();
         this.var_344["null"] = false;
         this.var_344["null"] = true;
         this.var_344["null"] = true;
         this.var_344["null"] = true;
      }
      ...
      private function resetRoomPlanes() : void
      {
         ...
         if(this.var_164 != null)
         {
            ...
            {
               _loc2_ = this.var_164[_loc1_] as RoomPlane;
               if(_loc2_ != null)
               {
                  _loc2_.dispose();
               }
      ...
      override public function get boundingRectangle() : Rectangle
      {
         ...
         {
            this.var_857 = super.boundingRectangle;
         }
         return new Rectangle(this.var_857.x,this.var_857.y,this.var_857.width,this.var_857.height);
      }
      ...
      protected function defineSprites() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:int = this.var_164.length;
         createSprites(_loc1_);
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_)
         {
            _loc3_ = this.var_164[_loc2_] as RoomPlane;
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         if(!isNaN(this.var_949))
         {
            this._planeParser.floorThicknessMultiplier = this.var_949;
         }
         if(!isNaN(this.var_1444))
         {
            this._planeParser.wallThicknessMultiplier = this.var_1444;
         }
         ...
         var _loc5_:* = 0;
         var _loc6_:int = _loc1_.getModel().getNumber(RoomObjectVariableEnum.const_1259);
         var _loc7_:int = 0;
         while(_loc7_ < this._planeParser.planeCount)
         {
            ...
            else if(_loc12_ == RoomPlaneData.const_416)
            {
            ...
            else if(_loc12_ == RoomPlaneData.const_1892)
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_70,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < this._planeParser.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_416)
            {
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(_loc9_ < this._lastUpdateTime + this.const_2364 && !_loc6_ && !_loc8_)
         {
            return;
         }
         ...
         {
            _loc10_ = 0;
            while(_loc10_ < this.var_403.length)
            {
               _loc11_ = this.var_688[_loc10_];
               _loc12_ = getSprite(_loc11_);
               _loc13_ = this.var_403[_loc10_] as RoomPlane;
               if(_loc12_ != null && _loc13_ != null && _loc13_.type != RoomPlane.TYPE_LANDSCAPE)
               {
                  if(this.var_2003)
                  {
                     _loc14_ = uint(_loc13_.color);
                     _loc15_ = uint((_loc14_ & 255) * this.var_2731 / 255);
                     _loc16_ = uint((_loc14_ >> 8 & 255) * this.var_2728 / 255);
                     _loc17_ = uint((_loc14_ >> 16 & 255) * this.var_2729 / 255);
      ...
      private function updateGeometry(param1:IRoomGeometry) : Boolean
      {
         ...
         if(param1.updateId != this.var_1805)
         {
            this.var_1805 = param1.updateId;
            this.var_857 = null;
            _loc3_ = param1.direction;
            if(_loc3_ != null && (_loc3_.x != this.var_1483 || _loc3_.y != this.var_2411 || _loc3_.z != this.var_2413 || param1.scale != this.var_2005))
            {
               this.var_1483 = _loc3_.x;
               this.var_2411 = _loc3_.y;
               this.var_2413 = _loc3_.z;
      ...
      private function updateMasksAndColors(param1:IRoomObjectModel) : Boolean
      {
         ...
         {
            _loc3_ = param1.getString(RoomObjectVariableEnum.const_1283);
            if(_loc3_ != this.var_2004)
            {
               this.updatePlaneMasks(_loc3_);
               this.var_2004 = _loc3_;
               _loc2_ = true;
            }
            _loc4_ = uint(param1.getNumber(RoomObjectVariableEnum.const_1011));
            if(_loc4_ != this.var_1301)
            {
               this.var_1301 = _loc4_;
               this.var_2731 = this.var_1301 & 255;
               this.var_2728 = this.var_1301 >> 8 & 255;
               this.var_2729 = this.var_1301 >> 16 & 255;
               _loc2_ = true;
            }
            _loc5_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_1370));
            if(_loc5_ != this.var_2003)
            {
      ...
      private function updatePlaneTexturesAndVisibilities(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getString(RoomObjectVariableEnum.const_232);
            ...
            _loc7_ = Boolean(param1.getNumber(RoomObjectVariableEnum.const_788));
      ...
      private function updatePlaneThicknesses(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1183);
            _loc3_ = param1.getNumber(RoomObjectVariableEnum.const_1165);
            if(!isNaN(_loc2_) && !isNaN(_loc3_) && (_loc2_ != this.var_949 || _loc3_ != this.var_1444))
            {
               this.var_949 = _loc2_;
      ...
      private function updateFloorHoles(param1:IRoomObjectModel) : Boolean
      {
         ...
         if(var_147 != param1.getUpdateID())
         {
            _loc2_ = param1.getNumber(RoomObjectVariableEnum.const_1406);
            if(!isNaN(_loc2_) && _loc2_ != this.var_2730)
            {
               this.var_2730 = _loc2_;
               this.resetRoomPlanes();
               return true;
            }
         }
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         var _loc4_:int = 0;
         while(_loc4_ < this.var_164.length)
         {
            _loc5_ = this.var_164[_loc4_] as RoomPlane;
            if(_loc5_ != null)
            {
               if(_loc5_.type == RoomPlane.const_115 && param1 != null)
               {
                  _loc5_.id = param1;
               }
      ...
      {
         if(param1 != this.var_344["null"] || param2 != this.var_344["null"] || param3 != this.var_344["null"])
         {
            this.var_344["null"] = param1;
            this.var_344["null"] = param2;
            this.var_344["null"] = param3;
            this.var_403 = [];
            this.var_688 = [];
         }
      }
      ...
      protected function updatePlanes(param1:IRoomGeometry, param2:Boolean, param3:int) : Boolean
      {
         ...
         var _loc6_:Array = this.var_403;
         if(this.var_403.length == 0)
         {
            _loc6_ = this.var_164;
         }
         var _loc7_:Boolean = false;
         var _loc8_:* = this.var_403.length > 0;
         var _loc9_:int = 0;
               ...
               if(_loc12_ != null)
               {
                  if(_loc12_.update(param1,_loc5_))
                  {
                     if(_loc12_.visible)
                     {
                        ...
                        if(_loc12_.type != RoomPlane.const_115)
                        {
                  ...
                  if(_loc11_.visible != (_loc12_.visible && this.var_344[_loc12_.type]))
                  {
                  ...
                  if(_loc11_.visible)
                  {
                     if(!_loc8_)
                     {
                        this.var_403.push(_loc12_);
                        this.var_688.push(_loc9_);
                     }
                  }
               }
      ...
      private function updateSprite(param1:IRoomObjectSprite, param2:RoomPlane, param3:String, param4:Number) : void
      {
         ...
         param1.assetName = param3 + "_" + this.var_1302;
      }
      ...
      protected function updatePlaneMasks(param1:String) : void
      {
         ...
         this.var_573.initialize(_loc2_);
         var _loc3_:* = null;
         var _loc4_:* = [];
         var _loc5_:* = [];
         var _loc6_:Boolean = false;
         var _loc7_:int = 0;
         while(_loc7_ < this.var_164.length)
         {
            _loc3_ = this.var_164[_loc7_] as RoomPlane;
            if(_loc3_ != null)
            {
         ...
         var _loc8_:int = 0;
         while(_loc8_ < this.var_573.maskCount)
         {
            _loc10_ = this.var_573.getMaskType(_loc8_);
            _loc11_ = this.var_573.getMaskLocation(_loc8_);
            _loc12_ = this.var_573.getMaskCategory(_loc8_);
            if(_loc11_ != null)
            {
               _loc13_ = 0;
               while(_loc13_ < this.var_164.length)
               {
                  _loc3_ = this.var_164[_loc13_] as RoomPlane;
                     ...
                     if(_loc3_ != null && _loc3_.location != null && _loc3_.normal != null)
                     {
                        ...
                        if(_loc15_ < 0.01)
                        {
                           if(_loc3_.leftSide != null && _loc3_.rightSide != null)
                           {
                              ...
                              if(_loc3_.type == RoomPlane.const_70 || _loc3_.type == RoomPlane.TYPE_LANDSCAPE && _loc12_ == RoomPlaneBitmapMaskData.const_304)
                              {
         ...
         while(_loc9_ < _loc4_.length)
         {
            ...
            {
               _loc3_ = this.var_164[_loc18_] as RoomPlane;
