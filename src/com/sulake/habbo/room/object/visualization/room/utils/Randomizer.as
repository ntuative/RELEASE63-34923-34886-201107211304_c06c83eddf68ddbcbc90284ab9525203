package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      private var var_1939:int = 16777216;
      ...
      {
         var _loc1_:int = this.var_3084 * this.var_1938 + this.var_3083;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
         _loc1_ %= this.var_1939;
         this.var_1938 = _loc1_;
         return _loc1_;
      }
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / this.var_1939 * param2);
      }
   }
}
