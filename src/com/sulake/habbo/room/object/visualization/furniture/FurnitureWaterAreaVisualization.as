package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureWaterAreaVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1543:String = "shore";
      ...
      {
         if(this.var_2618 == param1 && this.var_2619 == direction)
         {
         ...
         while(_loc2_ >= 0)
         {
            if(getSpriteTag(param1,direction,_loc2_) == const_1543)
            {
               this.var_1924 = _loc2_;
               this.var_2618 = param1;
               this.var_2619 = direction;
               return this.var_1924;
            }
            _loc2_--;
         }
      ...
      private function updateBorderData() : void
      {
         ...
         this.var_1923 = false;
         _loc5_ = 0;
         while(_loc5_ < this.var_468.length)
         {
            if(this.var_468[_loc5_] == true)
            {
               this.var_1923 = true;
            }
            _loc5_++;
      ...
      {
         var _loc2_:* = null;
         if(this.var_555 == 0 || this.var_661 == 0)
         {
            ...
            this.var_555 = _loc2_.getNumber(RoomObjectVariableEnum.const_295);
            this.var_661 = _loc2_.getNumber(RoomObjectVariableEnum.const_363);
         }
         this.var_468 = [];
         this.var_662 = [];
         var _loc1_:int = 0;
         while(_loc1_ < this.var_555 * 2 + this.var_661 * 2)
         {
            this.var_468.push(false);
      ...
      private function createShoreMask(param1:int, param2:int, param3:Number) : BitmapData
      {
         ...
         return ShoreMaskCreatorUtility.createShoreMask2x2(this.var_80,getSize(param3),this.var_468,this.var_662,assetCollection);
      }
