package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureRoomBrandingVisualization extends FurnitureVisualization
   {
      ...
      private static const const_1683:String = "branded_image";
      
      private static const const_1685:int = 0;
      
      private static const const_1684:int = 1;
      
      private static const const_1687:int = 2;
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         if(_loc2_)
         {
            ...
            if(_loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  this.var_1716 = _loc4_.getNumber(RoomObjectVariableEnum.const_661);
                  this.var_1717 = _loc4_.getNumber(RoomObjectVariableEnum.const_505);
                  this._paramOffsetZ = _loc4_.getNumber(RoomObjectVariableEnum.const_655);
               }
            }
         }
         if(!this.var_1432)
      ...
      protected function checkIfImageChanged() : Boolean
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               _loc3_ = _loc2_.getString(RoomObjectVariableEnum.const_348);
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc4_ = _loc2_.getNumber(RoomObjectVariableEnum.const_513);
                     if(_loc4_ == 1)
                     {
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(this._imageUrl != null && _loc6_ == const_1683)
         {
