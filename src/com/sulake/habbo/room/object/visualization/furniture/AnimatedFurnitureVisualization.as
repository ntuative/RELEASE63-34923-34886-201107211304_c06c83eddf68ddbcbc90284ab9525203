package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class AnimatedFurnitureVisualization extends FurnitureVisualization
   {
      ...
      protected function getAnimationId(param1:AnimationStateData) : int
      {
         ...
         if(_loc2_ != const_1173 && this._animationData.hasAnimation(this.var_463,_loc2_))
         {
            return _loc2_;
         }
         return const_1173;
      ...
      override protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(super.updateObject(param1,param2))
         {
            ...
            if(_loc4_ != this._state)
            {
               ...
               if(_loc5_ != null)
               {
                  _loc6_ = _loc5_.getNumber(RoomObjectVariableEnum.const_784);
         ...
         if(super.updateModel(param1))
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc5_ = _loc3_.getNumber(RoomObjectVariableEnum.const_784);
                     if(_loc5_ > this.var_1876)
                     {
                        this.var_1876 = _loc5_;
                        this.setAnimation(this._state);
                     }
                  }
                  _loc4_ = _loc3_.getNumber(RoomObjectVariableEnum.const_1016);
                  if(!isNaN(_loc4_))
                  {
                     _loc6_ = this._animationData.getAnimationId(this.var_463,_loc4_);
      ...
      protected function setSubAnimation(param1:AnimationStateData, param2:int, param3:Boolean = true) : Boolean
      {
         ...
         if(param3)
         {
            ...
            if(param2 != _loc5_)
            {
               if(!this._animationData.isImmediateChange(this.var_463,param2,_loc5_))
               {
                  _loc6_ = AnimationData.getTransitionFromAnimationId(_loc5_);
                  if(this._animationData.hasAnimation(this.var_463,_loc6_))
                  {
      ...
      protected function resetAllAnimationFrames() : void
      {
         if(this.var_132 != null)
         {
            this.var_132.setLayerCount(this.var_712);
         }
      }
      ...
      {
         var _loc2_:int = 0;
         if(!this.var_132.animationOver || this.var_1006)
         {
      ...
      protected function updateFramesForAnimation(param1:AnimationStateData, param2:Number) : int
      {
         ...
         while(_loc8_ >= 0)
         {
            ...
            if(!_loc9_ || this.var_1006)
            {
               ...
               if(_loc11_ == null || _loc11_.remainingFrameRepeats == AnimationFrame.const_613)
               {
                  _loc10_ = true;
                  _loc9_ = true;
               }
