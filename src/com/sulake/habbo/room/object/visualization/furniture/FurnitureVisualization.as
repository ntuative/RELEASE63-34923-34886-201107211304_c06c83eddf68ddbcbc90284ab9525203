package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureVisualization extends RoomObjectSpriteVisualization
   {
      ...
      protected static const const_2035:Number = Math.sqrt(0.5);
       
      
      private var _direction:int;
      
      private var var_2388:Number = NaN;
      ...
      override public function update(param1:IRoomGeometry, param2:int, param3:Boolean, param4:Boolean) : void
      {
         ...
         if(param4)
         {
            this.var_1471 |= this.updateAnimation(_loc6_);
         }
         else
         {
            _loc7_ = this.updateAnimation(_loc6_) | this.var_1471;
            this.var_1471 = 0;
         }
         if(_loc5_ || _loc7_ != 0)
         {
         ...
         if(_loc4_ != null && _loc3_ != null)
         {
            ...
            if(_loc5_ != null && _loc5_.asset != null)
            {
               ...
               if(param2 != this.var_1470)
               {
                  ...
                  _loc4_.color = this.getSpriteColor(param1,param2,this.var_2385);
               ...
               _loc4_.clickHandling = this.var_2389;
            }
            else
            {
      ...
      protected function updateObject(param1:Number, param2:Number) : Boolean
      {
         ...
         if(var_507 != _loc3_.getUpdateID() || param1 != var_102 || param2 != this.var_2388)
         {
      ...
      protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            this.var_2385 = _loc3_.getNumber(RoomObjectVariableEnum.const_302);
            _loc4_ = Number(_loc3_.getNumber(RoomObjectVariableEnum.const_359));
            if(isNaN(_loc4_))
            {
               _loc4_ = 1;
            }
            ...
            this.var_1197 = this.getAdClickUrl(_loc3_);
            if(this.var_1197 == null || this.var_1197.indexOf("http") != 0)
            {
               this.var_1197 = null;
            }
            this.var_2389 = this.var_1197 != null;
            this.var_2384 = _loc3_.getNumber(RoomObjectVariableEnum.const_810);
      ...
      {
         if(this.var_2383 != param2 || this.var_2386 != param1)
         {
            this.var_981 = [];
            this.var_982 = [];
            this.var_791 = [];
            ...
            this.var_2387 = this.getSize(param1);
      ...
      {
         this.var_712 = param1;
         this.var_1470 = this.var_712 - this.getAdditionalSpriteCount();
      }
      ...
      {
         if(this.var_793[param3] != null && !this.var_1790)
         {
      ...
      {
         if(this.var_795[param2] != null)
         {
            return this.var_795[param2];
         }
         if(this._data == null)
         {
      ...
      protected function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         return Math.ceil(this.var_2384 * (param1 / 2));
      }
