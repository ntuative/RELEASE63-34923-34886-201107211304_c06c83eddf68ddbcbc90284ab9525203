package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurniturePartyBeamerVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_488:int = 2;
      ...
      private static const const_1485:int = 1;
      ...
      private function getNewPoint(param1:Number, param2:int) : Point
      {
         ...
         var _loc4_:int = this.var_1223[param2];
         var _loc5_:int = this.var_1224[param2];
         var _loc6_:Number = this.var_1226[param2];
         if(param1 == 32)
         {
            _loc7_ = const_1066;
         }
         ...
         if(int(_loc9_) == 0)
         {
            this.var_1226[param2] = this.getRandomAmplitudeFactor();
         }
      ...
      private function initItems(param1:Number) : void
      {
         ...
         this.var_1223.push(1);
         this.var_1223.push(-1);
         this.var_1224 = new Array();
         this.var_1224.push(const_1484);
         this.var_1224.push(const_1485);
         this.var_1226 = new Array();
         this.var_1226.push(this.getRandomAmplitudeFactor());
         this.var_1226.push(this.getRandomAmplitudeFactor());
      }
