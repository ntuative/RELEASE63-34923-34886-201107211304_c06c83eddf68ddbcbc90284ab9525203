package com.sulake.habbo.room.object.visualization.furniture
{
   ...
   public class FurnitureParticleSystem
   {
      ...
      private var var_1264:Number = 1.0;
      
      private var var_670:BitmapData;
      
      private var var_841:ColorTransform;
      
      private var var_1550:ColorTransform;
      
      private var var_1933:Matrix;
      ...
      public function FurnitureParticleSystem(param1:AnimatedFurnitureVisualization)
      {
         ...
         this.var_1550 = new ColorTransform();
         this.var_1933 = new Matrix();
      ...
      public function setAnimation(param1:int) : void
      {
         ...
         this.var_113 = this.var_1265[param1];
         this.var_1024 = false;
         this.updateCanvas();
      }
      ...
      private function updateCanvas() : void
      {
         ...
         if(this.var_1932 >= 0)
         {
            this.var_287 = this._visualization.getSprite(this.var_1932);
            if(this.var_287 && this.var_287.asset)
            {
               ...
               if(this.var_99 == null)
               {
                  this.var_99 = this.var_287.asset.clone();
                  if(this.var_841.alphaMultiplier != 1)
                  {
                     this.var_670 = new BitmapData(this.var_99.width,this.var_99.height,true,4278190080);
                  }
               }
               this.var_2637 = -this.var_287.offsetX;
               this.var_2636 = -this.var_287.offsetY;
               this.var_287.asset = this.var_99;
            }
            if(this.var_99)
            {
            ...
            if(this.var_670)
            {
               this.var_670.fillRect(this.var_670.rect,4278190080);
            }
         }
      }
      ...
      public function getSpriteYOffset(param1:int, param2:int, param3:int) : int
      {
         ...
         {
            return this.var_113.y * this.var_1264;
         }
         return 0;
      }
      ...
      public function updateSprites() : void
      {
         ...
         if(this.var_99 && this.var_287.asset != this.var_99)
         {
            this.var_287.asset = this.var_99;
         }
         if(this.var_1024)
      ...
      public function updateAnimation() : void
      {
         ...
         var _loc2_:* = 0;
         var _loc8_:int = 0;
         if(!this.var_1024 && this.var_113.hasIgnited)
         {
            this.var_1024 = true;
         }
         _loc8_ = this.var_1205 * this.var_1264;
         this.var_113.update();
         if(this.var_1024)
         {
            if(this.var_113.roomObjectSpriteId >= 0)
            ...
            {
               this.var_99.draw(this.var_670,this.var_1933,this.var_841,BlendMode.NORMAL,null,false);
            }
            for each(_loc11_ in this.var_113.particles)
            {
               _loc2_ = Number(_loc11_.y);
               _loc3_ = this.var_2637 + (_loc11_.x - _loc11_.z) * 10 / 10 * this.var_1264;
               _loc4_ = this.var_2636 - _loc8_ + (_loc2_ + (_loc11_.x + _loc11_.z) / 2) * 10 / 10 * this.var_1264;
               ...
               if(_loc6_)
               {
                  ...
                  if(_loc11_.fade && _loc11_.alphaMultiplier < 1)
                  {
                     ...
                     this.var_1550.alphaMultiplier = _loc11_.alphaMultiplier;
                     this.var_99.draw(_loc7_,this._translationMatrix,this.var_1550,BlendMode.NORMAL,null,false);
                  }
                  else
                  {
      ...
      public function parseData(param1:XML) : void
      {
         ...
         for each(_loc3_ in param1.emitter)
         {
            ...
            for each(_loc23_ in _loc3_.particles.particle)
            {
               ...
               _loc19_ = _loc23_.@is_emitter == "HabboRoomUICom_jb_icon_disc" ? false : true;
               _loc20_ = _loc23_.hasOwnProperty("@fade") && _loc23_.@fade == "SetClothingChangeDataMessageComposer" ? true : false;
               _loc21_ = [];
