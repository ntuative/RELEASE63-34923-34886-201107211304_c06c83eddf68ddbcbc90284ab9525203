package com.sulake.habbo.room.object.visualization.pet
{
   ...
   public class AnimatedPetVisualization extends AnimatedFurnitureVisualization
   {
      ...
      private static const const_1588:String = "head";
      
      private static const const_703:int = 1;
      
      private static const const_1095:int = 1000;
      
      private static const const_1589:String = "pet_experience_bubble_png";
      
      private static const const_1587:int = 0;
      ...
      override public function initialize(param1:IRoomObjectVisualizationData) : Boolean
      {
         ...
         {
            _loc3_ = this._animationData.commonAssets.getAssetByName(const_1589) as BitmapDataAsset;
            if(_loc3_ != null)
            {
               _loc2_ = (_loc3_.content as BitmapData).clone();
               this.var_401 = new ExperienceData(_loc2_);
            }
         }
      ...
      override protected function updateModel(param1:Number) : Boolean
      {
         ...
         {
            _loc4_ = _loc3_.getString(RoomObjectVariableEnum.const_268);
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_174);
            _loc6_ = _loc3_.getNumber(RoomObjectVariableEnum.const_268);
            if(!isNaN(_loc6_))
            {
            ...
            this.var_2042 = _loc3_.getNumber(RoomObjectVariableEnum.const_266) > 0;
            _loc8_ = _loc3_.getNumber(RoomObjectVariableEnum.const_216);
            if(!isNaN(_loc8_))
            {
               this.var_1980 = _loc8_;
            }
            else
            {
               this.var_1980 = direction;
            }
            this.var_1582 = _loc3_.getNumber(RoomObjectVariableEnum.AVATAR_EXPERIENCE_TIMESTAMP);
            this.var_2450 = _loc3_.getNumber(RoomObjectVariableEnum.const_407);
            _loc9_ = _loc3_.getNumber(RoomObjectVariableEnum.const_996);
            if(_loc9_ != this.var_1979)
            {
               this.var_1979 = _loc9_;
               this.var_2693 = this.var_1979.toString();
            }
      ...
      private function updateExperienceBubble(param1:int) : void
      {
         ...
         if(this.var_401 != null)
         {
            ...
            if(this.var_1582 > 0)
            {
               _loc2_ = param1 - this.var_1582;
               if(_loc2_ < const_1095)
               {
                  this.var_401.alpha = int(Math.sin(_loc2_ / const_1095 * 0) * 255);
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     _loc3_.asset = this.var_401.image;
                     _loc3_.offsetX = -20;
                     _loc3_.offsetY = -80;
                     _loc3_.alpha = this.var_401.alpha;
                     _loc3_.visible = true;
                  }
                  else
                  {
      ...
      {
         return super.getAdditionalSpriteCount() + const_703;
      }
      ...
      override protected function getAsset(param1:String) : IGraphicAsset
      {
         ...
         {
            return assetCollection.getAssetWithPalette(param1,this.var_2693);
         }
         return null;
      }
      ...
      override protected function getSpriteAssetName(param1:int, param2:int) : String
      {
         ...
         if(param2 < _loc3_ - const_703)
         {
            _loc4_ = getSize(param1);
            if(param2 < _loc3_ - (1 + const_703))
            {
               if(param2 >= FurnitureVisualizationData.const_525.length)
               {
                  return null;
               }
      ...
      private function getDirection(param1:int, param2:int) : int
      {
         ...
         {
            return this._animationData.getDirectionValue(param1,this.var_1980);
         }
         return direction;
      }
      ...
      private function isHeadSprite(param1:int) : Boolean
      {
         ...
         {
            if(this._animationData.getTag(var_102,DirectionData.USE_DEFAULT_DIRECTION,param1) == const_1588)
            {
               this.var_1048[param1] = true;
            }
            else
            {
               this.var_1048[param1] = false;
            }
         }
