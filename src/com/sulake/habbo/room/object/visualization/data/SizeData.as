package com.sulake.habbo.room.object.visualization.data
{
   ...
   public class SizeData
   {
      ...
      public static const const_429:int = 1000;
      
      public static const const_1935:int = 0;
      ...
      private var var_1299:DirectionData = null;
      ...
      public function getDirectionValue(param1:int) : int
      {
         ...
         {
            _loc6_ = int(this.var_294.getKey(_loc5_)) * this.var_1591;
