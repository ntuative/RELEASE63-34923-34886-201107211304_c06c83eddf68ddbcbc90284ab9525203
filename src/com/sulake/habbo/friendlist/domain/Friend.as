package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_2251:int = "F".charCodeAt(0);
      
      public static const const_2128:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         this.var_1087 = param1.gender;
         this.var_838 = param1.online;
         this.var_1881 = param1.followingAllowed && param1.online;
         this.var_710 = param1.figure;
         this.var_1879 = param1.motto;
         this.var_1880 = param1.lastAccess;
         this.var_1569 = param1.categoryId;
         this.var_1878 = param1.realName;
