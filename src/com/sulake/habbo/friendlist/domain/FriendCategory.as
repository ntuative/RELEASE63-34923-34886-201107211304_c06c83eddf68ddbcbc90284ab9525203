package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_405:int = 100;
      ...
      {
         var _loc4_:* = null;
         if(this.var_255.indexOf(param1) >= 0)
         {
            return;
         }
         ...
         while(_loc3_ < this.var_255.length)
         {
            ...
            {
               this.var_255.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      public function removeFriend(param1:int) : Friend
      {
         ...
         if(_loc2_ != null)
         {
            Util.remove(this.var_255,_loc2_);
            return _loc2_;
         }
         return null;
      }
      ...
      {
         if(this.var_1034 >= this.getPageCount())
         {
            this.var_1034 = Math.max(0,this.getPageCount() - 1);
         }
      }
      
      public function getPageCount() : int
      {
         return Math.ceil(this.var_255.length / const_405);
      }
      
      public function getStartFriendIndex() : int
      {
         this.checkPageIndex();
         return this.var_1034 * const_405;
      }
      
      public function getEndFriendIndex() : int
      {
         this.checkPageIndex();
         return Math.min((this.var_1034 + 1) * const_405,this.var_255.length);
      }
