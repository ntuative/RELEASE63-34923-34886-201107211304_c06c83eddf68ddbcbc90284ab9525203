package com.sulake.habbo.friendlist
{
   ...
   public class FriendListView
   {
      ...
      private static const const_1555:Point = new Point(110,50);
       
      
      private var _friendList:HabboFriendList;
      
      private var var_2117:FriendListTabsView;
      ...
      public function FriendListView(param1:HabboFriendList)
      {
         ...
         this.var_2117 = new FriendListTabsView(this._friendList);
      }
      ...
      public function openFriendList() : void
      {
         ...
         {
            this.prepare();
            this.var_16.position = const_1555;
         }
         else
         {
      ...
      private function prepare() : void
      {
         ...
         this.var_952 = IWindowContainer(this.var_16.content.findChildByName("main_content"));
         this.var_309 = IWindowContainer(this.var_16.content.findChildByName("footer"));
         this.var_2117.prepare(this.var_952);
         this.var_16.procedure = this.onWindow;
         this.var_16.content.setParamFlag(HabboWindowParam.const_1219,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1276,true);
         this.var_16.header.setParamFlag(HabboWindowParam.const_973,false);
         this.var_16.header.setParamFlag(HabboWindowParam.const_1003,true);
         this.var_16.content.setParamFlag(HabboWindowParam.const_973,false);
         this.var_16.content.setParamFlag(HabboWindowParam.const_1003,true);
         this.var_16.findChildByName("open_edit_ctgs_but").procedure = this.onEditCategoriesButtonClick;
         this.var_1636 = ITextWindow(this.var_16.findChildByName("info_text"));
         this.var_1636.text = "";
      ...
      private function onWindow(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:int = this.var_2119 == -1 ? 0 : int(this.var_16.height - this.var_2119);
         var _loc4_:int = this.var_2118 == -1 ? 0 : int(this.var_16.width - this.var_2118);
      ...
      private function refreshWindowSize() : void
      {
         ...
         this.var_309.y = Util.getLowestPoint(this.var_16.content);
         this.var_309.width = this._friendList.tabs.windowWidth;
         ...
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1388,this._friendList.tabs.findSelectedTab() != null);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_973,false);
         this.var_16.scaler.setParamFlag(HabboWindowParam.const_1219,false);
         ...
         this.var_2119 = this.var_16.height;
         this.var_2118 = this.var_16.width;
