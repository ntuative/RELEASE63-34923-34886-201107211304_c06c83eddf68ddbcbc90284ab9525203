package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private static const const_1425:int = 162;
      
      private static const const_1424:int = 16;
      
      private static const const_680:int = 4;
      
      private static const const_1428:uint = 14342874;
      
      private static const const_1432:uint = 3815994;
      
      private static const const_1436:uint = 2085362;
      
      private static const const_1431:uint = 39616;
      
      private static const const_1427:uint = 10513106;
      
      private static const const_1429:uint = 8734654;
      
      private static const const_1437:uint = 9094430;
      
      private static const const_1435:uint = 6200576;
      
      private static const const_1426:String = "happiness";
      
      private static const const_1433:String = "experience";
      
      private static const const_1434:String = "energy";
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         this.updateStateElement(const_1426,param1.nutrition,param1.nutritionMax,const_1431,const_1436);
         this.updateStateElement(const_1433,param1.experience,param1.experienceMax,const_1429,const_1427);
         this.updateStateElement(const_1434,param1.energy,param1.energyMax,const_1435,const_1437);
      ...
      private function createPercentageBar(param1:int, param2:int, param3:uint, param4:uint) : BitmapData
      {
         ...
         var _loc7_:BitmapData = new BitmapData(const_1425,const_1424,false);
         _loc7_.fillRect(new Rectangle(0,0,_loc7_.width,_loc7_.height),const_1428);
         var _loc8_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,_loc7_.height - 2);
         _loc7_.fillRect(_loc8_,const_1432);
         var _loc9_:Rectangle = new Rectangle(1,1 + const_680,_loc7_.width - 2,_loc7_.height - 2 - const_680);
         _loc9_.width = _loc5_ * _loc9_.width;
         _loc7_.fillRect(_loc9_,param3);
         var _loc10_:Rectangle = new Rectangle(1,1,_loc7_.width - 2,const_680);
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = this._petData.getValue(this.var_582) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            case "btn_pick":
               _loc3_ = "null";
               if(this.var_213 && this.var_213.getPetId() == this.var_582)
               {
            ...
            case "btn_buy_food":
               if(this._catalog)
               {
                  this._catalog.openCatalogPage(CatalogPageName.const_1910,true);
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_436,this._widget.petData.method_1);
      ...
      private function arrangeButtons() : void
      {
         ...
         for each(_loc5_ in _loc2_)
         {
            if(_loc5_.visible)
            {
               ...
               {
                  _loc3_ = _loc1_;
                  _loc4_ += const_1040 + const_1041;
               }
               _loc5_.x = _loc3_ - _loc5_.width;
               _loc5_.y = _loc4_;
               _loc3_ = _loc5_.x - const_1041;
            }
         }
         this.var_108.height = _loc4_ + const_1040;
         this.updateWindow();
      }
   }
}
