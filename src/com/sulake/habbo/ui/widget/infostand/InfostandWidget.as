package com.sulake.habbo.ui.widget.infostand
{
   ...
   public class InfostandWidget extends RoomWidgetBase
   {
      ...
      private const const_2087:String = "infostand_bot_view";
      
      private const const_2091:String = "infostand_jukebox_view";
      
      private const const_2090:String = "infostand_songdisk_view";
      
      private var var_1336:InfoStandFurniView;
      
      private var var_205:InfoStandUserView;
      
      private var var_410:InfoStandPetView;
      
      private var var_483:InfoStandBotView;
      
      private var var_1089:InfoStandJukeboxView;
      
      private var var_1088:InfoStandSongDiskView;
      
      private var var_2870:Array;
      
      private var var_1631:InfostandUserData;
      
      private var var_644:InfostandFurniData;
      ...
      public function InfostandWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:IHabboCatalog)
      {
         ...
         this.var_1336 = new InfoStandFurniView(this,this.const_2089,this._catalog);
         ...
         this.var_483 = new InfoStandBotView(this,this.const_2087);
         this.var_1089 = new InfoStandJukeboxView(this,this.const_2091,this._catalog);
         this.var_1088 = new InfoStandSongDiskView(this,this.const_2090,this._catalog);
         this.var_1631 = new InfostandUserData();
         this.var_644 = new InfostandFurniData();
         this._petData = new InfoStandPetData();
         this.var_185 = new Timer(this.const_2370);
         this.var_185.addEventListener(TimerEvent.TIMER,this.onUpdateTimer);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetBadgeImageUpdateEvent.const_997,this.onBadgeImage);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetBadgeImageUpdateEvent.const_997,this.onBadgeImage);
      ...
      private function onUpdateTimer(param1:TimerEvent) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_312,this.var_410.getCurrentPetId()));
      }
      ...
      private function onFurniInfo(param1:RoomWidgetFurniInfoUpdateEvent) : void
      {
         ...
         if(param1.extraParam == RoomWidgetInfostandExtraParamEnum.const_501)
         {
      ...
      private function onUserTags(param1:RoomWidgetUserTagsUpdateEvent) : void
      {
         ...
         {
            this.var_205.setTags(param1.tags,this.var_2870);
         }
      }
      ...
      private function onUserFigureUpdate(param1:RoomWidgetUserFigureUpdateEvent) : void
      {
         ...
         {
            this.var_483.image = param1.image;
         }
         else
         {
      ...
      private function onBadgeImage(param1:RoomWidgetBadgeImageUpdateEvent) : void
      {
         ...
         if(_loc2_ >= 0)
         {
            if(this.userData.isBot())
            {
               this.var_483.setBadgeImage(_loc2_,param1.badgeImage);
            }
            else
            {
      ...
      {
         var _loc2_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_509,param1.id,param1.category);
      ...
      private function onRoomObjectRemoved(param1:RoomWidgetRoomObjectUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetRoomObjectUpdateEvent.const_197:
               ...
               if(this.var_483 != null && this.var_483.window != null && this.var_483.window.visible)
               {
                  _loc2_ = param1.id == this.var_1631.userRoomId;
                  break;
               }
