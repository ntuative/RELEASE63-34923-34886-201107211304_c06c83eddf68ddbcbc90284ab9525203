package com.sulake.habbo.ui.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1712:int = 250;
      
      private static const const_1711:int = 0;
      
      private static const BOTTOM_MARGIN:int = 55;
      
      private static const const_1713:String = "${widgets.chatinput.say}";
      ...
      private var var_2186:IWindow;
      
      private var _button:IWindow;
      
      private var var_2187:IWindow;
      
      private var var_1690:IWindow;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget)
      {
         super();
         this._widget = param1;
         this.var_1393 = param1.localizations.getKey("widgets.chatinput.mode.whisper",":tell");
         this.var_3013 = param1.localizations.getKey("widgets.chatinput.mode.shout",":shout");
         this.var_3014 = param1.localizations.getKey("widgets.chatinput.mode.speak",":speak");
      ...
      private function createWindow() : void
      {
         ...
         this.var_2186 = this._window.findChildByName("input_border");
         this._button = this._window.findChildByName("send_button");
         this.var_2187 = this._window.findChildByName("send_button_text");
         this.var_1690 = this._window.findChildByName("block_text");
         this.var_2187.caption = const_1713;
         ...
         this.var_1691 = true;
         this.var_739 = "";
         this._window.addEventListener(WindowEvent.const_674,this.updatePosition);
         this._window.addEventListener(WindowEvent.const_547,this.updatePosition);
      }
      ...
      private function updatePosition(param1:WindowEvent = null) : void
      {
         ...
         var _loc4_:int = (this._window.desktop.width - this.var_2186.width) / 2 - _loc3_;
         var _loc5_:int = this._window.desktop.width - this._window.width - const_1712 - _loc3_;
         this._window.x = Math.max(Math.min(_loc4_,_loc5_),const_1711);
      }
      ...
      private function windowKeyEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         if(_loc3_ == Keyboard.BACKSPACE)
         {
            if(this.var_27 != null)
            {
               ...
               _loc8_ = _loc7_.split(" ");
               if(_loc8_[0] == this.var_1393 && _loc8_.length == 3 && _loc8_[2] == "")
               {
                  this.var_27.text = "";
                  this.var_739 = "";
               }
      ...
      private function sendTypingMessage() : void
      {
         ...
         var _loc1_:RoomWidgetChatTypingMessage = new RoomWidgetChatTypingMessage(this.var_740);
      ...
      private function sendChatFromInputField(param1:Boolean = false) : void
      {
         ...
         var _loc2_:int = !!param1 ? 0 : int(RoomWidgetChatMessage.const_138);
