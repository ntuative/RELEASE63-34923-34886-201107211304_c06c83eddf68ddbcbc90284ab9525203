package com.sulake.habbo.ui.widget.avatarinfo
{
   ...
   public class AvatarInfoWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1137:String = "use_minimized_own_avatar_menu";
      ...
      private var var_261:AvatarInfoData;
      ...
      private var var_891:AvatarInfoView;
      
      private var var_893:OwnAvatarMenuView;
      
      private var var_892:AvatarMenuView;
      
      private var var_413:Map;
      
      private var var_2368:Boolean = false;
      
      private var var_2123:Boolean = true;
      ...
      public function AvatarInfoWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboConfigurationManager, param5:IHabboLocalizationManager, param6:Component)
      {
         ...
         this.var_22 = param6;
         this.var_134 = param4;
         this.var_261 = new AvatarInfoData();
         this.var_2920 = Boolean(this.var_134.getBoolean("menu.avatar.enabled",false));
         this.var_2121 = this.var_134.getBoolean("menu.own_avatar.enabled",false);
         this.var_413 = new Map();
         this.handler.roomEngine.events.addEventListener(RoomEngineObjectEvent.const_181,this.onRoomObjectAdded);
      ...
      override public function dispose() : void
      {
         ...
         this.handler.roomEngine.events.removeEventListener(RoomEngineObjectEvent.const_181,this.onRoomObjectAdded);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_353,this.updateEventHandler);
         ...
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_444,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectNameEvent.const_589,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_902,this.updateEventHandler);
         param1.addEventListener(RoomWidgetRoomObjectUpdateEvent.const_419,this.updateEventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_353,this.updateEventHandler);
         ...
         param1.removeEventListener(RoomWidgetRoomEngineUpdateEvent.const_444,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectNameEvent.const_589,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_419,this.updateEventHandler);
         param1.removeEventListener(RoomWidgetRoomObjectUpdateEvent.const_419,this.updateEventHandler);
      }
      ...
      private function updateEventHandler(param1:RoomWidgetUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetAvatarInfoEvent.const_123:
               ...
               if(this.var_2121 && _loc2_.allowNameChange)
               {
               ...
               {
                  this.updateView(_loc2_.userId,_loc2_.userName,_loc2_.roomIndex,RoomObjectTypeEnum.const_122,_loc2_.allowNameChange,null);
               }
            ...
            case RoomWidgetRoomObjectNameEvent.const_589:
               ...
               {
                  this.updateView(RoomWidgetRoomObjectNameEvent(param1).userId,RoomWidgetRoomObjectNameEvent(param1).userName,RoomWidgetRoomObjectNameEvent(param1).roomIndex,RoomObjectTypeEnum.const_122,false,null);
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_353:
               this.var_2123 = true;
               break;
            ...
            case RoomWidgetFurniInfoUpdateEvent.const_382:
               ...
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_902:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  this.var_2122 = RoomWidgetRoomObjectUpdateEvent(param1).id;
                  messageListener.processWidgetMessage(new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_1006,RoomWidgetRoomObjectUpdateEvent(param1).id,RoomWidgetRoomObjectUpdateEvent(param1).category));
               }
               break;
            case RoomWidgetRoomObjectUpdateEvent.const_419:
               if(!(this._view is AvatarMenuView || this._view is OwnAvatarMenuView))
               {
                  if(RoomWidgetRoomObjectUpdateEvent(param1).id == this.var_2122)
                  {
            ...
            case RoomWidgetUserInfoUpdateEvent.const_143:
               ...
               this.updateView(_loc3_.webID,_loc3_.name,_loc3_.userRoomId,RoomObjectTypeEnum.const_122,false,!!_loc3_.isSpectatorMode ? null : this.var_261);
               break;
            case RoomWidgetUserInfoUpdateEvent.BOT:
               _loc4_ = param1 as RoomWidgetUserInfoUpdateEvent;
               this.updateView(_loc4_.webID,_loc4_.name,_loc4_.userRoomId,RoomObjectTypeEnum.const_588,false,null);
               break;
            ...
            case RoomWidgetRoomEngineUpdateEvent.const_98:
               this.var_1782 = false;
               break;
            case RoomWidgetRoomEngineUpdateEvent.const_444:
               this.var_1782 = true;
         }
      ...
      public function selectOwnAvatar() : void
      {
         ...
         _loc3_ = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_324,_loc2_.id,RoomObjectCategoryEnum.const_29);
      ...
      {
         this.var_261.amIAnyRoomController = param1.amIAnyRoomController;
         this.var_261.amIController = param1.amIController;
         this.var_261.amIOwner = param1.amIOwner;
         this.var_261.canBeAskedAsFriend = param1.canBeAskedAsFriend;
         this.var_261.canBeKicked = param1.canBeKicked;
         this.var_261.canTrade = param1.canTrade;
         this.var_261.canTradeReason = param1.canTradeReason;
         this.var_261.hasFlatControl = param1.hasFlatControl;
         this.var_261.isIgnored = param1.isIgnored;
         this.var_261.respectLeft = param1.respectLeft;
         this.var_261.isOwnUser = param1.type == RoomWidgetUserInfoUpdateEvent.const_108;
         this.var_261.allowNameChange = param1.allowNameChange;
      }
      ...
      private function updateView(param1:int, param2:String, param3:int, param4:int, param5:Boolean, param6:AvatarInfoData) : void
      {
         ...
         if(param6)
         {
            _loc7_ = !!param6.isOwnUser ? Boolean(this.var_2121) : Boolean(this.var_2920);
         }
            ...
            if(!this.var_1782)
            {
               if(_loc7_)
               {
                  ...
                  else
                  {
                     if(!this.var_892)
                     {
                        this.var_892 = new AvatarMenuView(this);
                     }
               ...
               else
               {
                  if(!this.var_891)
                  {
                     this.var_891 = new AvatarInfoView(this);
                  }
      ...
      private function showFriendName(param1:IUserData, param2:int) : void
      {
         ...
         if(this.var_413[param1.name] == null)
         {
            ...
            FriendNameView.setup(_loc3_,param1.webID,param1.name,-1,RoomObjectTypeEnum.const_122,param2);
      ...
      {
         this.handler.container.avatarEditor.openEditor(AvatarEditorInstanceId.const_208,null,null,true);
         this.handler.container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_208);
      }
      ...
      {
         return this.handler.container.config.getBoolean(const_1137,true);
      }
      
      public function set useMinimizedOwnAvatarMenu(param1:Boolean) : void
      {
         this.handler.container.config.setKey(const_1137,!!param1 ? "1" : "0");
      }
   }
}
