package com.sulake.habbo.ui.widget.chooser
{
   ...
   public class ChooserView
   {
      ...
      private const const_2074:uint = 0;
      ...
      public function populate(param1:Array, param2:Boolean) : void
      {
         ...
         while(_loc6_ < param1.length)
         {
            ...
            if(_loc4_ != null)
            {
               ...
               _loc5_.color = !!(_loc6_ % 2) ? uint(this.const_2074) : uint(this.const_2073);
      ...
      {
         var _loc2_:* = null;
         if(this._itemList == null || param1 < 0 || param1 > this._itemList.numListItems || param1 == this.var_1050)
         {
            return;
         }
         if(this.var_1050 != -1)
         {
            _loc2_ = this._itemList.getListItemAt(this.var_1050) as IWindowContainer;
            if(_loc2_ != null)
            {
               _loc2_.color = !!(this.var_1050 % 2) ? uint(this.const_2074) : uint(this.const_2073);
            }
         }
