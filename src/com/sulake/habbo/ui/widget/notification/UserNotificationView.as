package com.sulake.habbo.ui.widget.notification
{
   ...
   public class UserNotificationView implements IDisposable
   {
      ...
      protected static const const_2040:String = "button_ok";
      ...
      public function showNotification(param1:String, param2:String) : Boolean
      {
         ...
         dialog.center();
         dialog.findChildByName(const_2040).addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,function(param1:WindowMouseEvent):void
         {
      ...
      public function hideNotification(param1:IFrameWindow) : void
      {
         ...
         if(param1 != null)
         {
            _loc2_ = this.var_642.indexOf(param1);
            if(_loc2_ > -1)
            {
               this.var_642.splice(_loc2_,1);
            }
            param1.dispose();
         }
      }
