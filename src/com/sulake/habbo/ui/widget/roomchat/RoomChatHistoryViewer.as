package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         this.var_206.state = RoomChatHistoryPulldown.const_294;
         ...
         this.var_54 = param2.createWindow("chatscroller","",HabboWindowType.const_1324,HabboWindowStyle.const_47,0 | 0,new Rectangle(param3.rectangle.right - SCROLLBAR_WIDTH,param3.y,SCROLLBAR_WIDTH,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         this.var_206.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_294);
      }
      ...
      {
         return !!this.var_487 ? Number(SCROLLBAR_WIDTH) : Number(0);
      }
      ...
      public function get visible() : Boolean
      {
         ...
         return this.var_206.state == RoomChatHistoryPulldown.const_457 || this.var_206.state == RoomChatHistoryPulldown.const_642;
      }
      ...
      {
         if(!this.var_487 && !this.var_1827)
         {
            this.var_487 = true;
            this.setHistoryViewerScrollbar(true);
            this.var_206.state = RoomChatHistoryPulldown.const_457;
            if(this._widget != null)
            {
      ...
      public function containerResized(param1:Rectangle, param2:Boolean = false) : void
      {
         if(this.var_54 != null)
         {
            ...
            if(param2)
            {
               this.var_54.scrollV = this.var_713;
            }
         }
         if(this.var_206 != null)
         {
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_488 > 0 && param2)
         {
            if(this.var_2102)
            {
               if(Math.abs(param1 - this.var_488) <= const_1250)
               {
                  return;
               }
               this.var_2102 = false;
            ...
            if(this.var_487)
            {
               ...
               _loc3_ = this.var_713 - _loc5_ / _loc4_;
      ...
      public function beginDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(this.var_54 != null)
         {
            this.var_713 = this.var_54.scrollV;
         }
         if(this.var_54 != null)
         {
      ...
      private function moveHistoryScroll() : void
      {
         ...
         var _loc1_:Number = this.var_713 - this.var_54.scrollV;
         if(_loc1_ == 0)
         {
            return;
         }
