package com.sulake.habbo.ui.widget.roomchat
{
   ...
   public class RoomChatWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      private static const const_1457:int = 9;
      
      private static const const_1049:int = 10;
      
      private static const const_683:int = 25;
      
      private static const const_1453:int = 25;
      
      private static const const_1048:int = 4000;
      
      private static const const_1454:int = 6000;
      ...
      private static const const_1047:int = (const_684 + const_472) * const_118 + const_118;
      
      private static const const_471:int = 9;
      
      private static const const_1455:int = 40;
      ...
      private var var_2338:int = 150;
      
      private var var_243:int = 171.0;
      ...
      public function RoomChatWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IHabboConfigurationManager, param6:int, param7:Component)
      {
         ...
         this.var_773 = new Point();
         super(param1,param2,param3,param4);
         this._config = param5;
         this.var_2339 = param6;
         this.var_41 = param2.createWindow("chat_container","",HabboWindowType.const_78,HabboWindowStyle.const_30,HabboWindowParam.const_47,new Rectangle(0,0,200,this.var_243 + RoomChatHistoryPulldown.const_92),null,0) as IWindowContainer;
         this.var_41.background = true;
         this.var_41.color = 33554431;
         this.var_41.tags.push("room_widget_chat");
         this.var_371 = param2.createWindow("chat_contentlist","",HabboWindowType.const_1214,HabboWindowStyle.const_47,0 | 0,new Rectangle(0,0,200,this.var_243),null,0) as IItemListWindow;
         this.var_41.addChild(this.var_371);
         this.var_127 = param2.createWindow("chat_active_content","",HabboWindowType.const_78,HabboWindowStyle.const_47,HabboWindowParam.const_64,new Rectangle(0,0,200,this.var_243),null,0) as IWindowContainer;
         this.var_127.clipping = false;
         this.var_371.addListItem(this.var_127);
         this.var_30 = new RoomChatHistoryViewer(this,param2,this.var_41,param3);
         this._baseUrl = param5.getKey("site.url");
         this.var_2338 = int(param5.getKey("chat.history.item.max.count","150"));
      ...
      {
         var _loc2_:int = 0;
         if(getTimer() > this.var_1180 && this.var_1180 > 0)
         {
            this.var_1180 = -1;
            this.animationStart();
         }
         if(this.var_969)
         {
            _loc2_ = param1 / const_1453 * const_1456;
            if(_loc2_ + this.var_970 > this.var_972)
            {
               _loc2_ = this.var_972 - this.var_970;
            }
            if(_loc2_ > 0)
            {
            ...
            if(this.var_970 >= this.var_972)
            {
               this.var_972 = const_118;
               this.var_970 = 0;
               this.animationStop();
               this.processBuffer();
               this.var_1180 = getTimer() + const_1048;
            }
         }
         if(this.var_30 != null)
         {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetRoomViewUpdateEvent.const_968,this.onRoomViewUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetRoomViewUpdateEvent.const_968,this.onRoomViewUpdate);
      }
      ...
      private function onChatMessage(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         if(this.var_971 != 1)
         {
            _loc2_.senderX /= this.var_971;
         }
         _loc2_.senderX -= this.var_773.x;
      ...
      private function onRoomViewUpdate(param1:RoomWidgetRoomViewUpdateEvent) : void
      {
         ...
         if(param1.scale > 0)
         {
            if(this.var_1758 == 0)
            {
               this.var_1758 = param1.scale;
            }
            else
            {
               this.var_971 = param1.scale / this.var_1758;
            }
         }
         if(param1.positionDelta != null)
         {
            this.var_773.x += param1.positionDelta.x / this.var_971;
            this.var_773.y += param1.positionDelta.y / this.var_971;
         }
         if(param1.rect != null)
         {
            if(this.var_30 == null)
            ...
            this.var_41.height = this.var_243 + this.var_30.pulldownBarHeight;
            this.var_371.width = this.var_41.width - this.var_30.scrollbarWidth;
            this.var_371.height = this.var_243;
            this.var_371.x = this.var_41.x;
            this.var_371.y = this.var_41.y;
            this.var_127.width = this.var_41.width - this.var_30.scrollbarWidth;
            this.var_127.height = this.var_243;
      ...
      private function processBuffer() : void
      {
         ...
         else
         {
            ...
            {
               this.var_972 = this.getItemSpacing(this._itemList[this._itemList.length - 1],this.var_79[0]);
            }
            else
            {
               this.var_972 = const_118;
      ...
      private function activateItemFromBuffer() : void
      {
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc1_.aboveLevels > const_684 + const_472 + 2)
               {
                  _loc1_.aboveLevels = const_684 + const_472 + 2;
               }
               this.var_774 = 0;
      ...
      private function selectItemsToMove() : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            if(_loc4_.view != null)
            {
               if(_loc4_.screenLevel > const_472 || _loc4_.screenLevel == _loc2_ - 1 || _loc1_ - _loc4_.timeStamp >= const_1454)
               {
      ...
      private function setChatItemLocHorizontal(param1:RoomChatItem) : void
      {
         ...
         var _loc2_:Number = (param1.senderX + this.var_773.x) * this.var_971;
         var _loc3_:Number = _loc2_ - param1.width / 2;
         var _loc4_:Number = _loc3_ + param1.width;
         var _loc5_:Number = -this.var_41.width / 2 - const_1049 + this.var_3069;
         var _loc6_:Number = this.var_41.width / 2 + const_1049 - this.var_30.scrollbarWidth - this.var_3070;
      ...
      private function setChatItemLocVertical(param1:RoomChatItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            {
               param1.y = this.getAreaBottom() - (_loc3_ + 1) * const_118 - const_471;
            }
            else
            {
      ...
      private function getAreaBottom() : Number
      {
         ...
         return this.var_243 + this.var_41.y;
      }
      ...
      private function purgeItems() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc3_:int = 0;
         while(this._itemList.length > this.var_2338)
         {
      ...
      {
         return "chat_" + this.var_2339.toString() + "_item_" + (this.var_2340++).toString();
      }
      ...
      public function onItemMouseClick(param1:int, param2:String, param3:int, param4:int, param5:int, param6:WindowMouseEvent) : void
      {
         ...
         var _loc7_:RoomWidgetRoomObjectMessage = new RoomWidgetRoomObjectMessage(RoomWidgetRoomObjectMessage.const_509,param1,param3);
         messageListener.processWidgetMessage(_loc7_);
         var _loc8_:RoomWidgetChatSelectAvatarMessage = new RoomWidgetChatSelectAvatarMessage(RoomWidgetChatSelectAvatarMessage.const_955,param1,param2,param4,param5);
      ...
      {
         var _loc2_:int = this.var_41.context.getDesktopWindow().height - 0 - const_1455;
         param1 = Math.min(param1,_loc2_);
         this.var_243 = param1 - this.var_41.y;
         this.var_41.height = this.var_243 + RoomChatHistoryPulldown.const_92;
         if(this.var_30 != null)
         {
            this.var_30.containerResized(this.var_41.rectangle);
         }
      ...
      public function resetArea() : void
      {
         ...
         this.animationStop();
         this.var_243 = const_1047 + const_471;
         this.var_41.height = this.var_243 + this.var_30.pulldownBarHeight;
         this.var_371.width = this.var_41.width - this.var_30.scrollbarWidth;
         this.var_371.height = this.var_243;
         this.var_127.width = this.var_41.width - this.var_30.scrollbarWidth;
         if(this.historyViewerActive())
         {
            this.var_127.height = this.getTotalContentHeight() + const_471;
         }
         else
         {
            this.var_127.height = this.var_243;
      ...
      public function resizeContainerToLowestItem() : void
      {
         ...
         if(Math.abs(_loc3_) < RoomChatHistoryViewer.const_1250)
         {
            this.resetArea();
            return;
         }
      ...
      public function mouseUp() : void
      {
         ...
         {
            if(_loc1_ <= this.var_243 + this.var_41.y)
            {
               if(this.historyViewerActive())
               {
                  this.hideHistoryViewer();
         ...
         if(this.var_1759 && !this.historyViewerActive())
         {
            this.resetArea();
            this.var_1759 = false;
         }
