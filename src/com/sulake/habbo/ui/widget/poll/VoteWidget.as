package com.sulake.habbo.ui.widget.poll
{
   ...
   public class VoteWidget extends RoomWidgetBase
   {
      ...
      override public function dispose() : void
      {
         ...
         {
            this.var_185.reset();
            this.var_185.removeEventListener(TimerEvent.TIMER,this.updateEvent);
            this.var_185 = null;
         }
         this._config = null;
         super.dispose();
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_159,this.showVoteQuestion);
         param1.addEventListener(RoomWidgetVoteUpdateEvent.const_166,this.showVoteResult);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_159,this.showVoteQuestion);
         param1.removeEventListener(RoomWidgetVoteUpdateEvent.const_166,this.showVoteResult);
      }
      ...
      private function showVoteQuestion(param1:RoomWidgetVoteUpdateEvent) : void
      {
         ...
         if(this.var_185 == null)
         {
            ...
            this.var_185.addEventListener(TimerEvent.TIMER,this.updateEvent);
         }
      ...
      private function updateTimerView() : void
      {
         ...
         var _loc1_:int = getTimer() - this.var_2074;
      ...
      {
         var _loc2_:int = getTimer() - this.var_2074;
