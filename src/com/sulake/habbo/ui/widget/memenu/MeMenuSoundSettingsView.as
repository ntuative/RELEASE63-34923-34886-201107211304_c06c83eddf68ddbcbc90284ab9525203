package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsView implements IMeMenuView
   {
      ...
      {
         this.var_1064 = param1.volume;
         if(this.var_1061 != null)
         {
            this.var_1061.setValue(this.var_1064);
         }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1065 = (_loc5_.content as BitmapData).clone();
         }
         ...
         if(_loc5_ != null && _loc5_.content != null)
         {
            this.var_1063 = (_loc5_.content as BitmapData).clone();
         }
      ...
      private function updateSoundIcons() : void
      {
         if(this.var_1064 == 0)
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1063);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1060);
         }
         else
         {
            this.setBitmapWrapperContent("sounds_on_icon",this.var_1062);
            this.setBitmapWrapperContent("sounds_off_icon",this.var_1065);
         }
      }
