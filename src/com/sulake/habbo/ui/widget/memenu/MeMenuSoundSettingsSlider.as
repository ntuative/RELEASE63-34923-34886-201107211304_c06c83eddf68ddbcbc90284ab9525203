package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuSoundSettingsSlider
   {
      ...
      private var var_1860:MeMenuSoundSettingsView;
      ...
      {
         if(param1.type != WindowEvent.const_408)
         {
            return;
         }
         this.var_1860.saveVolume(this.getValue(param2.x),false);
      }
      ...
      private function displaySlider() : void
      {
         ...
         if(_loc3_ != null && this.var_786 != null)
         {
            _loc3_.bitmap = new BitmapData(this.var_786.width,this.var_786.height,true,16777215);
            _loc3_.bitmap.copyPixels(this.var_786,this.var_786.rect,new Point(0,0),null,null,true);
         }
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc2_ != null)
            {
               ...
               if(_loc3_ != null && this.var_787 != null)
               {
                  _loc3_.bitmap = new BitmapData(this.var_787.width,this.var_787.height,true,16777215);
                  _loc3_.bitmap.copyPixels(this.var_787,this.var_787.rect,new Point(0,0),null,null,true);
                  _loc2_.procedure = this.buttonProcedure;
                  this.var_1788 = _loc1_.width - _loc3_.width;
               }
            }
         }
      }
