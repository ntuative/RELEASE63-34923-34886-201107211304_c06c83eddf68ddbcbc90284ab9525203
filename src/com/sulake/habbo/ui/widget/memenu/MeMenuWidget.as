package com.sulake.habbo.ui.widget.memenu
{
   ...
   public class MeMenuWidget extends RoomWidgetBase
   {
      ...
      public static const const_560:String = "me_menu_my_clothes_view";
      
      public static const const_1208:String = "me_menu_dance_moves_view";
      
      public static const const_791:String = "me_menu_settings_view";
      
      public static const const_982:String = "me_menu_sound_settings";
      
      private static const const_1051:Point = new Point(95,440);
      ...
      public function MeMenuWidget(param1:IRoomWidgetHandler, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager, param5:IEventDispatcher, param6:IHabboConfigurationManager)
      {
         ...
         if(false)
         {
            this.var_2364 = param6.getBoolean("client.news.embed.enabled",false);
         }
         this.var_2121 = this._config.getBoolean("menu.own_avatar.enabled",false);
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetWaveUpdateEvent.const_806,this.onWaveEvent);
         param1.addEventListener(RoomWidgetDanceUpdateEvent.const_743,this.onDanceEvent);
         param1.addEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_780,this.onUpdateEffects);
         param1.addEventListener(RoomWidgetToolbarClickedUpdateEvent.const_831,this.onToolbarClicked);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1368,this.onAvatarEditorClosed);
         param1.addEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1234,this.onHideAvatarEditor);
         ...
         param1.addEventListener(RoomWidgetSettingsUpdateEvent.const_412,this.onSettingsUpdate);
         ...
         param1.addEventListener(RoomWidgetPurseUpdateEvent.const_129,this.onCreditBalance);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_98,this.onNormalMode);
         param1.addEventListener(RoomWidgetRoomEngineUpdateEvent.const_444,this.onGameMode);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetWaveUpdateEvent.const_806,this.onWaveEvent);
         param1.removeEventListener(RoomWidgetDanceUpdateEvent.const_743,this.onDanceEvent);
         param1.removeEventListener(RoomWidgetUpdateEffectsUpdateEvent.const_780,this.onUpdateEffects);
         param1.removeEventListener(RoomWidgetToolbarClickedUpdateEvent.const_831,this.onToolbarClicked);
         ...
         param1.removeEventListener(RoomWidgetAvatarEditorUpdateEvent.const_1234,this.onAvatarEditorClosed);
         param1.removeEventListener(RoomWidgetUserInfoUpdateEvent.const_108,this.onUserInfo);
         param1.removeEventListener(RoomWidgetSettingsUpdateEvent.const_412,this.onSettingsUpdate);
         ...
         param1.removeEventListener(RoomWidgetPurseUpdateEvent.const_129,this.onCreditBalance);
      ...
      private function onUserInfo(param1:RoomWidgetUserInfoUpdateEvent) : void
      {
         ...
         if(!(this.var_530 && this.var_53.window.name == const_560))
         {
            _loc2_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_981);
      ...
      private function onSettingsUpdate(param1:RoomWidgetSettingsUpdateEvent) : void
      {
         ...
         if(this.var_53.window.name == const_982)
         {
      ...
      private function onTutorialEvent(param1:RoomWidgetTutorialEvent) : void
      {
         switch(param1.type)
         {
            case RoomWidgetTutorialEvent.const_498:
               ...
               if(this.var_530 != true || this.var_53.window.name != const_182)
               {
                  return;
               }
      ...
      private function onToolbarClicked(param1:RoomWidgetToolbarClickedUpdateEvent) : void
      {
         ...
         if(this.var_530)
         {
            _loc2_ = new RoomWidgetMeMenuMessage(RoomWidgetMeMenuMessage.const_876);
            if(messageListener != null)
            {
               messageListener.processWidgetMessage(_loc2_);
            }
      ...
      {
         if(this.var_53 != null && this.var_53.window.name != const_560)
         {
            this.hide();
         }
      }
      ...
      private function onHabboClubEvent(param1:RoomWidgetHabboClubUpdateEvent) : void
      {
         ...
         this.var_2367 = param1.periodsLeft;
         this.var_3073 = param1.pastPeriods;
         this.var_2366 = param1.allowClubDances;
         _loc2_ = Boolean(_loc2_ || param1.clubLevel != this.var_1781);
         this.var_1781 = param1.clubLevel;
         if(_loc2_)
         {
            if(this.var_53 != null)
            {
      ...
      private function onCreditBalance(param1:RoomWidgetPurseUpdateEvent) : void
      {
         ...
         localizations.registerParameter("widget.memenu.credits","credits",this.var_2365.toString());
      }
