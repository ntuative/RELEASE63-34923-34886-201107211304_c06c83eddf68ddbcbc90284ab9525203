   ...
   public class PlayListEditorItemListView
   {
      ...
      public function setItemIndexPlaying(param1:int) : void
      {
         ...
         if(param1 < 0)
         {
            ...
            {
               _loc3_.setIconState(PlayListEditorItem.const_635);
            }
            return;
         }
         ...
         if(this.var_1211 >= 0 && this.var_1211 < this._items.length)
         {
            _loc2_ = this._items[this.var_1211] as PlayListEditorItem;
            _loc2_.setIconState(PlayListEditorItem.const_635);
         }
         _loc2_ = this._items[param1] as PlayListEditorItem;
         _loc2_.setIconState(PlayListEditorItem.const_1195);
