package com.sulake.habbo.ui.widget.playlisteditor
{
   ...
   public class PlayListStatusView
   {
      ...
      public static const const_951:String = "PLSV_ADD_SONGS";
      
      public static const const_1381:String = "PLSV_START_PLAYBACK";
      
      public static const const_599:String = "PLSV_NOW_PLAYING";
      ...
      {
         if(this.var_53 != const_599)
         {
            return;
         }
         var _loc2_:IWindowContainer = this.var_498[this.var_53];
      ...
      public function set addSongsBackgroundImage(param1:BitmapData) : void
      {
         ...
         var _loc2_:IWindowContainer = this.var_498[const_951];
         if(_loc2_ == null)
         {
            return;
         }
      ...
      private function createWindows() : void
      {
         ...
         if(_loc1_ != null)
         {
            this.var_498.add(const_599,_loc1_);
