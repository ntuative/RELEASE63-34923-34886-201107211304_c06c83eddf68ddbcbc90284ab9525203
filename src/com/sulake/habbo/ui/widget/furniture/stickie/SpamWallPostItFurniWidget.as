package com.sulake.habbo.ui.widget.furniture.stickie
{
   ...
   public class SpamWallPostItFurniWidget extends StickieFurniWidget
   {
      ...
      {
         param1.addEventListener(RoomWidgetSpamWallPostItEditEvent.const_591,this.onEditPostItRequest);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetSpamWallPostItEditEvent.const_591,this.onEditPostItRequest);
      }
      ...
      override protected function sendUpdate() : void
      {
         ...
         if(var_238 != -1)
         {
            ...
            {
               _loc1_ = new RoomWidgetSpamWallPostItFinishEditingMessage(RoomWidgetSpamWallPostItFinishEditingMessage.const_789,var_238,this.var_470,_text,var_362);
