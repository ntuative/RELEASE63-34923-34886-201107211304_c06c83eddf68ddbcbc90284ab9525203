package com.sulake.habbo.ui.widget.furniture.clothingchange
{
   ...
   public class ClothingChangeFurnitureWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetClothingChangeUpdateEvent.const_1209,this.onUpdate);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetClothingChangeUpdateEvent.const_1209,this.onUpdate);
      }
      ...
      private function showGenderSelectionInterface(param1:RoomWidgetClothingChangeUpdateEvent) : void
      {
         ...
         this.var_2294 = param1.objectCategory;
         ...
         this.var_490 = windowManager.createWindow("clothing change gender selection","",HabboWindowType.const_78,HabboWindowStyle.const_47,0 | 0 | 0 | 0,new Rectangle(100,100,200,200),null,0) as IWindowContainer;
      ...
      {
         var _loc2_:RoomWidgetClothingChangeMessage = new RoomWidgetClothingChangeMessage(RoomWidgetClothingChangeMessage.const_959,param1,this.var_238,this.var_2294,this._roomId,this._roomCategory);
