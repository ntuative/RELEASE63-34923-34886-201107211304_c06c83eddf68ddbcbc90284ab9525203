package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerFurniWidget extends RoomWidgetBase
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_1000,this.onPresets);
         param1.addEventListener(RoomWidgetDimmerUpdateEvent.const_870,this.onHide);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_1000,this.onPresets);
         param1.removeEventListener(RoomWidgetDimmerUpdateEvent.const_870,this.onHide);
      ...
      private function onDimmerState(param1:RoomWidgetDimmerStateUpdateEvent) : void
      {
         ...
         this.var_2475 = param1.presetId;
         this.var_1273 = param1.effectId;
         ...
         if(!this.validateBrightness(this.var_1275,this.var_1273))
         {
            return;
         }
         _loc2_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1275,this.var_1273 == 2);
      ...
      public function removePreview() : void
      {
         ...
         _loc1_ = new RoomWidgetDimmerPreviewMessage(this._color,this.var_1275,this.var_1273 == 2);
         messageListener.processWidgetMessage(_loc1_);
      }
