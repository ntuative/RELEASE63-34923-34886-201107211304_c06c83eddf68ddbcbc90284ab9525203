package com.sulake.habbo.ui.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_629:DimmerViewColorGrid;
      ...
      private function createWindow() : void
      {
         ...
         this._window = this._widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_78,HabboWindowStyle.const_30,0 | 0,new Rectangle(const_1440,const_1439,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               this.var_629 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,this._widget.windowManager,this._widget.assets);
            }
         }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         this.var_1468 = _loc2_.light;
         if(this.var_447 != null)
         {
            this.var_447.setValue(this.var_1468);
         }
         this.var_603 = this.colors.indexOf(_loc2_.color);
         if(this.var_629 != null)
         {
            this.var_629.setSelectedColorIndex(this.var_603);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(this.var_629 != null)
         {
            this.var_629.setSelectedColorIndex(param1);
         }
         this._widget.previewCurrentSetting();
      }
