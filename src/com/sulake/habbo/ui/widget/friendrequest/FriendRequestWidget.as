package com.sulake.habbo.ui.widget.friendrequest
{
   ...
   public class FriendRequestWidget extends RoomWidgetBase implements IUpdateReceiver
   {
      ...
      override public function registerUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.addEventListener(RoomWidgetFriendRequestUpdateEvent.const_586,this.eventHandler);
      ...
      override public function unregisterUpdateEvents(param1:IEventDispatcher) : void
      {
         ...
         param1.removeEventListener(RoomWidgetFriendRequestUpdateEvent.const_586,this.eventHandler);
      ...
      private function eventHandler(param1:RoomWidgetFriendRequestUpdateEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFriendRequestUpdateEvent.const_586:
      ...
      public function update(param1:uint) : void
      {
         ...
         for each(_loc2_ in this._requests)
         {
            if(_loc2_)
            {
               _loc3_ = messageListener.processWidgetMessage(new RoomWidgetGetUserLocationMessage(_loc2_.userId,RoomObjectTypeEnum.const_122)) as RoomWidgetUserLocationUpdateEvent;
               if(_loc3_)
               {
      ...
      public function acceptRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_836,param1));
      ...
      public function declineRequest(param1:int) : void
      {
         ...
         messageListener.processWidgetMessage(new RoomWidgetFriendRequestMessage(RoomWidgetFriendRequestMessage.const_768,param1));
         this.removeRequest(param1);
      }
