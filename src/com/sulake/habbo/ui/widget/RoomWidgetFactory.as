package com.sulake.habbo.ui.widget
{
   ...
   public class RoomWidgetFactory extends Component implements IRoomWidgetFactory
   {
      ...
      private var var_3088:IAssetLibrary;
      ...
      public function RoomWidgetFactory(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_3088 = param1.root.assets;
      ...
      public function createWidget(param1:String, param2:IRoomWidgetHandler) : IRoomWidget
      {
         ...
         switch(param1)
         {
            case RoomWidgetEnum.const_439:
               _loc3_ = new RoomChatWidget(param2,this._windowManager,assets,this.var_77,this.var_161,this.var_2732++,this);
               break;
            case RoomWidgetEnum.const_340:
               _loc3_ = new RoomChatInputWidget(param2,this._windowManager,assets,this.var_77,this.var_161,this);
               break;
            case RoomWidgetEnum.const_653:
               _loc3_ = new InfostandWidget(param2,this._windowManager,assets,this.var_77,this.var_161,this._catalog);
               break;
            case RoomWidgetEnum.const_546:
               _loc3_ = new MeMenuWidget(param2,this._windowManager,assets,this.var_77,events,this.var_161);
               break;
            ...
            case RoomWidgetEnum.const_532:
               _loc3_ = new TeaserFurniWidget(param2,this._windowManager,assets,this.var_77,this.var_161,this.var_12);
               break;
            ...
            case RoomWidgetEnum.const_538:
               _loc3_ = new LoadingBarWidget(param2,this._windowManager,assets,this.var_77,this.var_161);
               break;
            case RoomWidgetEnum.const_503:
               _loc3_ = new RoomQueueWidget(param2,this._windowManager,assets,this.var_77,this.var_161);
               break;
            case RoomWidgetEnum.const_131:
               _loc3_ = new VoteWidget(param2,this._windowManager,assets,this.var_77,this.var_161);
               break;
            ...
            case RoomWidgetEnum.const_123:
               _loc3_ = new AvatarInfoWidget(param2,this._windowManager,assets,this.var_161,this.var_77,this);
               break;
            ...
            case RoomWidgetEnum.const_574:
               _loc3_ = new PlayListEditorWidget(param2,this._windowManager,this._soundManager,assets,this.var_77,this.var_161,this._catalog);
               break;
