package com.sulake.habbo.ui.handler
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler, IAvatarImageListener
   {
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_208);
         }
         this.var_1155 = true;
         this.container = null;
         this.var_12 = null;
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(this._container != null)
         {
            ...
            {
               this.var_12.events.removeEventListener(HabboInventoryEffectsEvent.const_273,this.onAvatarEffectsChanged);
            ...
            {
               this._container.habboHelp.events.removeEventListener(HabboHelpTutorialEvent.const_999,this.onHelpTutorialEvent);
            ...
            {
               this._container.catalog.events.removeEventListener(PurseEvent.const_129,this.onCreditBalance);
            }
         }
         ...
         if(this.var_12 != null)
         {
            this.var_12.events.addEventListener(HabboInventoryEffectsEvent.const_273,this.onAvatarEffectsChanged);
         ...
         {
            this._container.habboHelp.events.addEventListener(HabboHelpTutorialEvent.const_999,this.onHelpTutorialEvent);
         ...
         {
            this._container.catalog.events.addEventListener(PurseEvent.const_129,this.onCreditBalance);
         }
      }
      ...
      private function setMeMenuToolbarIcon() : void
      {
         ...
         if(this._toolbar != null)
         {
            ...
            {
               if(_loc1_.height > const_482)
               {
                  _loc7_ = new BitmapData(_loc1_.width,const_482,true,0);
                  _loc8_ = _loc7_.rect.clone();
                  if(_loc2_.height > const_482 - const_1092)
                  {
                     _loc8_.offset(0,_loc2_.height - const_482 + const_1092);
                  }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_868);
         _loc1_.push(RoomWidgetDanceMessage.const_758);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_1025);
         ...
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_800);
         _loc1_.push(RoomWidgetStopEffectMessage.const_790);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1907);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1311);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_521);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1765);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_1270);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_887);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_981);
         _loc1_.push(RoomWidgetMeMenuMessage.const_876);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_998);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1855);
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_981:
               ...
               break;
            case RoomWidgetWaveMessage.const_868:
               if(this._container != null && this._container.roomSession != null)
               {
                  this._container.roomSession.sendWaveMessage();
               }
               break;
            case RoomWidgetDanceMessage.const_758:
               if(this._container != null && this._container.roomSession != null)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_1025:
               if(this.var_12 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_1174:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_800:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(this._catalog != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_1291)
               {
            ...
            case RoomWidgetOpenInventoryMessage.const_817:
               ...
               if(this.var_12 != null)
               {
                  ...
                  {
                     case RoomWidgetOpenInventoryMessage.const_1840:
                        this._catalog.openCatalogPage(CatalogPageName.const_1362,true);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_790:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_1311:
            ...
            case RoomWidgetShowOwnRoomsMessage.const_887:
               ...
               break;
            case RoomWidgetMeMenuMessage.const_876:
               ...
               {
                  this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_129,this._catalog.getPurse().credits));
               }
            ...
            case RoomWidgetAvatarEditorMessage.const_521:
               ...
               if(this._container)
               {
                  this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_208,null,null,true);
                  this._container.avatarEditor.loadOwnAvatarInEditor(AvatarEditorInstanceId.const_208);
                  if(this._container.habboHelp && this._container.habboHelp.events)
                  {
                     this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_639));
                  }
               }
               break;
            case RoomWidgetGetSettingsMessage.const_998:
               this._container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_412,this._container.soundManager.volume));
               break;
            ...
            case RoomWidgetAvatarEditorMessage.const_1372:
               if(this._container.habboHelp && this._container.habboHelp.events)
               {
                  this._container.habboHelp.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_656));
               }
               break;
            default:
      ...
      private function onCreditBalance(param1:PurseEvent) : void
      {
         ...
         this._container.events.dispatchEvent(new RoomWidgetPurseUpdateEvent(RoomWidgetPurseUpdateEvent.const_129,param1.balance));
      }
      ...
      private function onHelpTutorialEvent(param1:HabboHelpTutorialEvent) : void
      {
         ...
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_126:
               ...
               break;
            case HabboHelpTutorialEvent.const_999:
