package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureClothingChangeWidgetHandler implements IRoomWidgetHandler, IHabboAvatarEditorDataSaver
   {
      ...
      private static const const_1679:String = "hd-99999-99999.lg-270-62";
      
      private static const const_1678:String = "hd-99999-99999.ch-630-62.lg-695-62";
      ...
      public function dispose() : void
      {
         ...
         {
            this._container.avatarEditor.close(AvatarEditorInstanceId.const_455);
         }
         this.var_1155 = true;
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_792,RoomWidgetClothingChangeMessage.const_959,RoomWidgetAvatarEditorMessage.const_521];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_792:
               ...
               break;
            case RoomWidgetClothingChangeMessage.const_959:
               ...
               if(_loc2_ != null)
               {
                  ...
                  if(_loc3_ != null)
                  {
                     ...
                     _loc8_ = "null";
                     _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1329);
                     ...
                     {
                        _loc8_ = "null";
                        _loc9_ = _loc3_.getString(RoomObjectVariableEnum.const_1172);
                        if(_loc9_ == null || _loc9_ == "")
                        {
                           _loc9_ = const_1678;
                        }
                     }
                     if(this._container.avatarEditor.openEditor(AvatarEditorInstanceId.const_455,this,[AvatarEditorFigureCategory.const_263,AvatarEditorFigureCategory.const_894],false,"${widget.furni.clothingchange.editor.title}"))
                     {
                        this._container.avatarEditor.loadAvatarInEditor(AvatarEditorInstanceId.const_455,_loc9_,_loc8_,HabboClubLevelEnum.const_53);
