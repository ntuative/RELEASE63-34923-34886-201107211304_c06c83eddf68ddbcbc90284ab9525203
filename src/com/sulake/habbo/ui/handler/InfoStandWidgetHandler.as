package com.sulake.habbo.ui.handler
{
   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function InfoStandWidgetHandler(param1:IHabboMusicController)
      {
         ...
         {
            this.var_258.events.addEventListener(NowPlayingEvent.const_104,this.onNowPlayingChanged);
      ...
      public function dispose() : void
      {
         ...
         {
            _loc1_ = this.var_692.length - 1;
            while(_loc1_ >= 0)
            {
               _loc2_ = this.var_692.getWithIndex(_loc1_);
               if(_loc2_)
               {
                  _loc2_.dispose();
               }
         ...
         if(this.var_258 != null)
         {
            this.var_258.events.removeEventListener(NowPlayingEvent.const_104,this.onNowPlayingChanged);
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetRoomObjectMessage.const_509);
         _loc1_.push(RoomWidgetRoomObjectMessage.const_1006);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_288);
         _loc1_.push(RoomWidgetFurniActionMessage.const_872);
         _loc1_.push(RoomWidgetFurniActionMessage.const_835);
         _loc1_.push(RoomWidgetFurniActionMessage.const_770);
         _loc1_.push(RoomWidgetFurniActionMessage.const_1277);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_912);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_773);
         _loc1_.push(RoomWidgetGetBadgeImageMessage.const_754);
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_1813);
         _loc1_.push(RoomWidgetPetCommandMessage.const_643);
         _loc1_.push(RoomWidgetPetCommandMessage.const_916);
         _loc1_.push(RoomWidgetUserActionMessage.const_617);
         _loc1_.push(RoomWidgetUserActionMessage.const_312);
         _loc1_.push(RoomWidgetChangeMottoMessage.const_854);
         return _loc1_;
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         if(_loc4_ != null)
         {
            ...
            else if(param1.type == RoomWidgetUserActionMessage.const_312 || param1.type == RoomWidgetUserActionMessage.const_617 || param1.type == RoomWidgetUserActionMessage.const_671)
            {
         ...
         switch(param1.type)
         {
            case RoomWidgetRoomObjectMessage.const_509:
               return this.handleGetObjectInfoMessage(param1 as RoomWidgetRoomObjectMessage);
            case RoomWidgetRoomObjectMessage.const_1006:
            ...
            case RoomWidgetUserActionMessage.const_640:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_1357,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_312:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_912:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_773:
               ...
               break;
            case RoomWidgetGetBadgeImageMessage.const_754:
      ...
      private function handleGetObjectNameMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               {
                  _loc11_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_258);
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_26:
               ...
               else if(_loc8_.getNumber(RoomObjectVariableEnum.const_745) == 1)
               {
                  _loc6_.extraParam = RoomWidgetInfostandExtraParamEnum.const_1213;
               }
               ...
               {
                  _loc24_ = _loc8_.getNumber(RoomObjectVariableEnum.const_258);
                  if(param1.category == RoomObjectCategoryEnum.const_27)
                  {
               ...
               _loc10_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1407);
               _loc11_ = _loc8_.getNumber(RoomObjectVariableEnum.const_1339);
               ...
               if(_loc6_.extraParam != null && _loc6_.extraParam.length > 0)
               {
                  ...
                  _loc28_ = "";
                  _loc29_ = "";
                  if(_loc6_.extraParam == RoomWidgetInfostandExtraParamEnum.const_501)
                  {
                     _loc30_ = this.var_258.getRoomItemPlaylist();
                     if(_loc30_ != null)
                     {
                  ...
                  if(_loc26_ != -1)
                  {
                     _loc32_ = this.var_258.getSongInfo(_loc26_);
                     if(_loc32_ != null)
                     {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               if(_loc12_.type == RoomObjectTypeEnum.const_122)
               {
                  _loc13_ = "null";
               ...
               {
                  if(_loc12_.type != RoomObjectTypeEnum.const_588)
                  {
                     return null;
                  }
                  _loc13_ = "null";
               ...
               if(_loc17_ != null)
               {
                  _loc14_.carryItem = _loc17_.getModel().getNumber(RoomObjectVariableEnum.const_356);
               }
               ...
               if(_loc13_ == RoomWidgetUserInfoUpdateEvent.const_143)
               {
                  ...
                  if(_loc17_ != null)
                  {
                     _loc38_ = _loc17_.getModel().getString(RoomObjectVariableEnum.const_853);
                  ...
                  if(!_loc34_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_865;
                  }
                  if(!_loc35_)
                  {
                     _loc14_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_841;
                  }
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc7_:BitmapData = this.var_692.getValue(_loc4_) as BitmapData;
         if(_loc7_ == null)
         {
            _loc7_ = this.getPetImage(_loc4_);
            this.var_692.add(_loc4_,_loc7_);
         }
         if(this._container != null && this._container.events != null)
         {
            _loc8_ = _loc2_.method_1 == this._container.sessionDataManager.userId;
            _loc9_ = new RoomWidgetPetInfoUpdateEvent(_loc5_,_loc6_,_loc3_.name,_loc2_.petId,_loc7_,_loc8_,_loc2_.method_1,_loc2_.ownerName,_loc3_.id);
            ...
            _loc13_ = this._container.roomSession.userDataManager.getUserData(_loc2_.method_1);
            if(_loc13_ != null)
            {
               _loc14_ = this._container.roomEngine.getRoomObject(_loc11_,_loc12_,_loc13_.id,RoomObjectCategoryEnum.const_29);
               if(_loc14_ != null)
               {
                  _loc15_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_853);
      ...
      private function onNowPlayingChanged(param1:NowPlayingEvent) : void
      {
         ...
         if(this.var_258 != null)
         {
            ...
            if(_loc2_ != -1)
            {
               _loc5_ = this.var_258.getSongInfo(_loc2_);
               if(_loc5_ != null)
               {
                  _loc3_ = _loc5_.name;
      ...
      private function onSongInfoReceivedEvent(param1:SongInfoReceivedEvent) : void
      {
         ...
         if(this.var_258 != null)
         {
            ...
            if(_loc2_ != null)
            {
               this._container.events.dispatchEvent(new RoomWidgetSongUpdateEvent(RoomWidgetSongUpdateEvent.const_448,param1.id,_loc2_.name,_loc2_.creator));
            }
         }
      }
   }
