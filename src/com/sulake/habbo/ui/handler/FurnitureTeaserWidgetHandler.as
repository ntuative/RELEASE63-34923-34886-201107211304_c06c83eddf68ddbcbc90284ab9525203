package com.sulake.habbo.ui.handler
{
   ...
   public class FurnitureTeaserWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_911,RoomWidgetViralFurniMessage.const_762,RoomWidgetViralFurniMessage.const_198];
      }
            ...
            case RoomWidgetFurniToWidgetMessage.const_911:
               ...
               if(_loc3_ != null)
               {
                  ...
                  if(_loc5_ != null)
                  {
                     ...
                     _loc7_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_662);
                     _loc8_ = "+";
               ...
               break;
            case RoomWidgetViralFurniMessage.const_762:
      ...
      {
         return [RoomSessionViralFurniStatusEvent.const_664,RoomSessionViralFurniStatusEvent.const_603];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionViralFurniStatusEvent.const_664:
               ...
               break;
            case RoomSessionViralFurniStatusEvent.const_603:
               _loc2_ = param1 as RoomSessionViralFurniStatusEvent;
               _loc3_ = new RoomWidgetTeaserDataUpdateEvent(RoomWidgetTeaserDataUpdateEvent.const_961);
               _loc3_.campaignID = _loc2_.campaignID;
               _loc3_.status = _loc2_.status;
               _loc3_.data = _loc2_.shareId;
               _loc3_.itemCategory = _loc2_.itemCategory;
