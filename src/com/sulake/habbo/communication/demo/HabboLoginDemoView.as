package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_815:String = "InitConnection";
      ...
      private function createWindow() : void
      {
         ...
         this._window = this.var_136.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_167,HabboWindowStyle.const_47,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
         ...
         if(_loc8_)
         {
            ...
            {
               if(this.var_136.habboConfiguration.getKey("use.sso","HabboRoomUICom_jb_icon_disc") == "SetClothingChangeDataMessageComposer")
               {
                  _loc8_.select();
               }
            }
         ...
         if(this.var_136.habboConfiguration && this.var_136.habboConfiguration.getKey("try.existing.session","HabboRoomUICom_jb_icon_disc") == "SetClothingChangeDataMessageComposer")
         {
            this.var_1579 = true;
      ...
      private function windowEventProcessor(param1:WindowEvent = null, param2:IWindow = null) : void
      {
         ...
         {
            dispatchEvent(new Event(const_815));
         }
      }
      ...
      private function initSSOTicket(param1:Boolean) : void
      {
         ...
         {
            this.var_163.removeEventListener(SSOTicket.const_452,this.onParsedTicketSuccess);
            this.var_163.removeEventListener(SSOTicket.const_375,this.onParsedTicketFailure);
            this.var_163 = null;
         }
         var _loc2_:String = "";
         ...
         this.var_163 = new SSOTicket(this.var_136.assets,_loc3_,_loc2_,param1);
         this.var_163.addEventListener(SSOTicket.const_452,this.onParsedTicketSuccess);
         this.var_163.addEventListener(SSOTicket.const_375,this.onParsedTicketFailure);
      }
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         this.var_136.flashClientUrl = this.var_163.flashClientUrl;
         this.var_136.ssoTicket = this.var_163.ticket;
         this.var_163.removeEventListener(SSOTicket.const_452,this.onParsedTicketSuccess);
         this.var_163.removeEventListener(SSOTicket.const_375,this.onParsedTicketFailure);
         this.var_163 = null;
         dispatchEvent(new Event(const_815));
