package com.sulake.habbo.communication.demo
{
   ...
   public class HabboHotelView implements IDisposable
   {
      ...
      private var var_1100:IDesktopWindow;
      
      private var _disposed:Boolean = false;
      
      private var var_1367:Function;
      
      private var var_1368:Function;
      
      private var var_905:IAssetLibrary;
      ...
      public function HabboHotelView(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IEventDispatcher, param4:Boolean = true)
      {
         ...
         this.var_905 = param2;
         this._events = param3;
         this.var_1100 = param1.getDesktop(0);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_905.loadAssetFromFile("hotelview_png",new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      private function hotelViewLoadedHandler(param1:AssetLoaderEvent) : void
      {
         ...
         var _loc3_:IAsset = this.var_905.getAssetByName(_loc2_.assetName);
      ...
      {
         var _loc3_:AssetLoaderStruct = this.var_905.loadAssetFromFile("hotel_view_banner_" + this.var_1366,new URLRequest(param1),"image/png");
         if(param2 == null)
         {
      ...
      public function show() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1100.addChildAt(this._window,0);
         }
      }
      ...
      public function hide() : void
      {
         if(this._window && !this._window.disposed)
         {
            this.var_1100.removeChild(this._window);
         }
      }
   }
}
