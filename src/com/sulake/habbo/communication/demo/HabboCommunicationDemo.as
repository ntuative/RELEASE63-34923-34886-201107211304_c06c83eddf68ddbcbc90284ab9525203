package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private var var_2644:PseudoRandom;
      ...
      public function setSSOTicket(param1:String) : void
      {
         ...
         {
            this.var_674 = param1;
            this.var_65.initConnection(HabboConnectionType.const_256);
         }
      }
      ...
      {
         if(this.var_65 && this.var_161 && this.var_15 && this._windowManager)
         {
      ...
      private function componentsAreRunning() : void
      {
         ...
         this.var_674 = this.var_161.getKey("sso.ticket",null);
         this.var_1943 = this.var_161.getKey("flash.client.url","");
         this.var_2643 = this.var_161.getKey("external.variables.txt","");
         if(this.var_253 == null)
         {
            this.var_253 = new HabboHotelView(this._windowManager,assets,Component(context).events,_loc1_);
         }
         if(_loc4_)
         {
            this.var_65.mode = HabboConnectionType.const_98;
            if(this.var_674)
            {
               this.var_65.initConnection(HabboConnectionType.const_256);
            }
         ...
         else if(this._windowManager != null)
         {
            ...
            if(_loc5_)
            {
               ...
               this._view.addEventListener(HabboLoginDemoView.const_815,this.onInitConnection);
            }
            else
            {
               Core.crash("Login without an SSO ticket is not supported",Core.const_1881);
            }
         }
      }
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         this.var_2644 = new PseudoRandom(parseInt(_loc4_.substring(_loc4_.length - 4),16),65536);
         switch(this.var_65.mode)
         {
            case HabboConnectionType.const_98:
               ...
               this.var_1560 = _loc4_;
               this.var_253.loadBannerImage(_loc7_ + "?token=" + this.var_1560,this.onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1325:
               this.sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1903:
               this.var_1030 = this.generateRandomHexString(30);
               this.var_558 = new DiffieHellman(new BigInteger(this.var_161.getKey("connection.development.prime"),16),new BigInteger(this.var_161.getKey("connection.development.generator"),16));
               this.var_558.init(this.var_1030);
      ...
      private function onSecretKeyEvent(param1:IMessageEvent) : void
      {
         ...
         var _loc7_:IEncryption = new RC4_R27(_loc6_,this.var_2644);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         connection.send(new VersionCheckMessageComposer(401,this.var_1943,this.var_2643));
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !this.var_2642)
         {
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,this.var_1560);
