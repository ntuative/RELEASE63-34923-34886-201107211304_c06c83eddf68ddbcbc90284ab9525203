package com.sulake.habbo.tracking
{
   ...
   public class HabboTracking extends Component implements IHabboTracking, IUpdateReceiver
   {
      ...
      private static const const_1097:uint = 11;
      ...
      private var var_1297:IHabboWindowManager;
      ...
      private var var_292:PerformanceTracker = null;
      
      private var var_475:FramerateTracker = null;
      
      private var var_293:LatencyTracker = null;
      
      private var var_686:LagWarningLogger = null;
      
      private var var_476:ToolbarClickTracker = null;
      ...
      public function HabboTracking(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         this.var_292 = new PerformanceTracker();
         this.var_475 = new FramerateTracker();
         this.var_293 = new LatencyTracker();
         this.var_686 = new LagWarningLogger();
         this.var_476 = new ToolbarClickTracker(this);
         this.var_1586 = new Array(const_1097);
         var _loc4_:int = 0;
         while(_loc4_ < const_1097)
         {
            this.var_1586[_loc4_] = 0;
            _loc4_++;
         }
         ...
         if(_loc5_ != null)
         {
            ...
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1858,new Date().getTime().toString());
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1744,!true ? ExternalInterface.call("window.navigator.userAgent.toString") : "unknown");
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_2014,Capabilities.serverString);
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_949,String(false));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1244,String(0));
         }
      ...
      override public function dispose() : void
      {
         if(!disposed)
         {
            ...
            if(this.var_1297)
            {
               this.var_1297.release(new IIDHabboWindowManager());
               this.var_1297 = null;
            }
            if(this.var_335)
            {
            ...
            if(this.var_228)
            {
               if(!this.var_228.disposed)
               {
                  ...
                  Component(this.var_228).events.removeEventListener(HabboFriendListTrackingEvent.const_515,this.onFriendlistTrackingEvent);
               }
            ...
            if(this._roomEngine)
            {
               if(!this._roomEngine.disposed)
               {
                  ...
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_196,this.onRoomAction);
                  this._roomEngine.events.removeEventListener(RoomEngineEvent.const_333,this.onRoomAction);
               }
      ...
      {
         this.var_1586[param2] = param1;
      }
      
      private function onConfigurationReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_134 = IHabboConfigurationManager(param2);
         if(this.var_134)
         {
            if(this.var_293 != null)
            {
               this.var_293.configuration = this.var_134;
            }
            if(this.var_292 != null)
            {
               this.var_292.configuration = this.var_134;
            }
            this.setErrorContextFlag(1,0);
            this.trackLoginStep(HabboLoginTrackingStep.const_1773);
            if(this.var_134)
            {
               if(this.var_686 != null)
               {
                  this.var_686.configure(this.var_134);
               }
               if(this.var_475 != null)
               {
                  this.var_475.configure(this.var_134);
               }
               if(this.var_476 != null)
               {
                  this.var_476.configure(this.var_134);
               }
            }
         }
      }
      ...
      private function onConnectionReady(param1:IConnection) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(this.var_292 != null)
            {
               this.var_292.connection = param1;
            }
            if(this.var_293 != null)
            {
               this.var_293.communication = this._communication;
               this.var_293.connection = param1;
            }
            if(this.var_686 != null)
            {
               this.var_686.connection = param1;
            }
         }
      }
      ...
      private function onHotelViewEvent(param1:Event) : void
      {
         ...
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1940);
         }
         else if(param1.type == HabboHotelViewEvent.const_502)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1899);
         }
         else if(param1.type == HabboHotelViewEvent.const_71)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1848);
         }
      }
      ...
      {
         this.var_1297 = IHabboWindowManager(param2);
         if(this.var_1297)
         {
      ...
      private function onError(param1:ErrorEvent) : void
      {
         ...
         if(param1.critical && !this._crashed)
         {
            ...
            if(this.var_134)
            {
               if(this.var_134.keyExists("client.fatal.error.url"))
               {
                  _loc2_ = this.var_134.getKey("client.fatal.error.url");
                  ...
                  _loc8_ = "";
                  for each(_loc9_ in this.var_1586)
                  {
                  ...
                  if(this.var_292 != null)
                  {
                     _loc4_["null"] = this.var_292.flashVersion;
                     _loc4_["null"] = this.var_292.averageUpdateInterval;
                  }
      ...
      {
         this.trackLoginStep(HabboLoginTrackingStep.const_1304);
         if(context && false)
         {
            context.root.events.removeEventListener(HabboLoginTrackingStep.const_1304,this.onCoreRunning);
         }
      }
      ...
      private function onFriendlistReady(param1:IID, param2:IUnknown) : void
      {
         ...
         Component(this.var_228).events.addEventListener(HabboFriendListTrackingEvent.const_515,this.onFriendlistTrackingEvent);
      }
      ...
      private function onFriendlistTrackingEvent(param1:Event) : void
      {
         switch(param1.type)
         {
            ...
            case HabboFriendListTrackingEvent.HABBO_FRIENDLIST_TRACKIG_EVENT_REQUEST:
               ...
               break;
            case HabboFriendListTrackingEvent.const_515:
      ...
      private function onRoomEnter(param1:IMessageEvent) : void
      {
         if(!this.var_2696)
         {
            this.trackLoginStep(HabboLoginTrackingStep.const_1894);
            this.var_2696 = true;
         }
         var _loc2_:RoomEntryInfoMessageParser = RoomEntryInfoMessageEvent(param1).getParser();
         if(_loc2_.privateRoom)
         {
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_1244,String(_loc2_.guestRoomId));
            ErrorReportStorage.setParameter(HabboErrorVariableEnum.const_949,String(true));
      ...
      private function onRoomEngineReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_196,this.onRoomAction);
         Component(this._roomEngine).events.addEventListener(RoomEngineEvent.const_333,this.onRoomAction);
      }
      
      private function onAdManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         this.var_335 = param2 as IAdManager;
         this.var_335.events.addEventListener(AdEvent.const_584,this.onRoomAdLoad);
      }
      ...
      {
         if(param1.type == RoomEngineEvent.const_196)
         {
            if(this.var_1985 < 1)
            {
               if(!this.var_342)
         ...
         else if(param1.type == RoomEngineEvent.const_333)
         {
            if(this.var_342)
            {
               this.var_342.removeEventListener(TimerEvent.TIMER,this.onRoomActionTimerEvent);
         ...
         if(!disposed)
         {
            if(this._connection)
            {
               if(this.var_475)
               {
                  ...
                  this.trackEventLog("Performance","fps",String(this.var_475.frameRate),_loc2_);
                  ++this.var_1985;
               }
            }
         }
      ...
      private function onToolbarClick(param1:HabboToolbarEvent) : void
      {
         if(this.var_476)
         {
            this.var_476.track(param1.iconName);
         }
      }
      ...
      private function onZoomToggle(param1:HabboNavigatorEvent) : void
      {
         if(this.var_476)
         {
            this.var_476.track(param1.type);
         }
      }
      ...
      {
         if(this.var_134 != null && !Boolean(this.var_134.getKey("processlog.enabled")))
         {
            return;
         }
      ...
      {
         this.var_686.chatLagDetected(param1);
      }
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            ++this.var_1983;
            ErrorReportStorage.addDebugData("Invalid time counter","Invalid times: " + this.var_1983);
         }
         if(this.var_569 > -1 && _loc2_ - this.var_569 > 15000)
         {
            ++this.var_1984;
            ErrorReportStorage.addDebugData("Time leap counter","Time leaps: " + this.var_1984);
         }
         this.var_569 = _loc2_;
         if(this.var_292 != null)
         {
            this.var_292.update(param1,this.var_569);
         }
         if(this.var_293 != null)
         {
            this.var_293.update(param1,this.var_569);
         }
         if(this.var_475 != null)
         {
            this.var_475.trackUpdate(param1,this,this.var_569);
         }
         if(this.var_686 != null)
         {
            this.var_686.update(this.var_569);
         }
      }
   }
}
