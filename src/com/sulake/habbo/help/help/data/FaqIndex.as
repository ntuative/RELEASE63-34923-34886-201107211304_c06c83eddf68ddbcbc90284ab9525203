package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_869:FaqCategory;
      
      private var var_870:FaqCategory;
      
      private var var_868:FaqCategory;
      ...
      {
         super();
         this.var_869 = new FaqCategory(-999,"${help.faq.title.urgent}");
         this.var_870 = new FaqCategory(-9999,"${help.faq.title.normal}");
         this.var_868 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
      ...
      {
         var _loc4_:* = null;
         if(this.var_869.hasItem(param1))
         {
            this.var_869.getItem(param1).answerText = param2;
         }
         if(this.var_870.hasItem(param1))
         {
            this.var_870.getItem(param1).answerText = param2;
         }
         if(this.var_868.hasItem(param1))
         {
            this.var_868.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
      ...
      private function findItem(param1:int) : FaqItem
      {
         ...
         if(this.var_869.hasItem(param1))
         {
            return this.var_869.getItem(param1);
         }
         if(this.var_870.hasItem(param1))
         {
            return this.var_870.getItem(param1);
         }
         if(this.var_868.hasItem(param1))
         {
            return this.var_868.getItem(param1);
         }
         var _loc2_:int = 0;
