package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_2179:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager)
      {
         ...
         this._windowManager.registerLocalizationParameter("info.client.version","version",new String(201107211259));
         this.var_145 = new Map();
         this.var_145.add(HabboHelpViewEnum.const_2000,IHelpViewController(new PlaceholderView(this,this._windowManager,this._assetLibrary)));
         this.var_145.add(HabboHelpViewEnum.const_230,IHelpViewController(new HelpMainView(this,this._windowManager,this._assetLibrary)));
         this.var_145.add(HabboHelpViewEnum.const_672,IHelpViewController(new FaqBrowseTopView(this,this._windowManager,this._assetLibrary)));
         this.var_145.add(HabboHelpViewEnum.const_374,IHelpViewController(new FaqBrowseCategoryView(this,this._windowManager,this._assetLibrary)));
         this.var_145.add(HabboHelpViewEnum.const_309,IHelpViewController(new FaqBrowseEntry(this,this._windowManager,this._assetLibrary)));
         this.var_145.add(HabboHelpViewEnum.const_396,IHelpViewController(new CallForHelpTopicSelection(this,this._windowManager,this._assetLibrary)));
         this.var_145.add(HabboHelpViewEnum.const_811,IHelpViewController(new CallForHelpTextInput(this,this._windowManager,this._assetLibrary)));
         this.var_145.add(HabboHelpViewEnum.const_300,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_thanks")));
         this.var_145.add(HabboHelpViewEnum.const_1335,IHelpViewController(new CallForHelpSentView(this,this._windowManager,this._assetLibrary,"help_cfh_abusive")));
         this.var_145.add(HabboHelpViewEnum.const_1197,IHelpViewController(new CallForHelpPendingItemView(this,this._windowManager,this._assetLibrary)));
         this.var_145.add(HabboHelpViewEnum.const_826,IHelpViewController(new CallForHelpReportUserSelection(this,this._windowManager,this._assetLibrary)));
      }
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(param1 == this.var_2179)
         {
            this.var_599 = new Array();
         }
         else if(param2)
         {
            if(this.var_599.length == 0 || param1 != this.var_422)
            {
               this.var_599.push(this.var_422);
            }
         }
         this.var_422 = param1;
         ...
         if(_loc3_ == null)
         {
            Logger.log("* No view controller found for " + this.var_422);
            return;
         }
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_300:
               ...
               break;
            case CallForHelpResultEnum.const_1359:
               this.showUI(HabboHelpViewEnum.const_1197);
               break;
            case CallForHelpResultEnum.const_1210:
               this.showUI(HabboHelpViewEnum.const_1335);
         }
      }
      ...
      public function updateCallForGuideBotUI(param1:Boolean) : void
      {
         ...
         var _loc2_:IHelpViewController = this.var_145.getValue(HabboHelpViewEnum.const_230) as IHelpViewController;
      ...
      public function handleCallGuideBot() : void
      {
         ...
         this.hideUI();
         this.var_22.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_595));
      }
      ...
      {
         return this.var_145.getValue(this.var_422);
      }
      ...
      private function createWindow() : void
      {
         ...
         this.var_2668 = this._window.width - _loc3_.width;
         this.var_2669 = this._window.height;
      }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         this._window.height = _loc1_.height + this.var_2669;
         this._window.width = _loc1_.width + this.var_2668;
      }
      ...
      private function onBack(param1:WindowMouseEvent) : void
      {
         ...
         {
            this.showUI(this.var_599.pop(),false);
         }
      }
      ...
      {
         var _loc3_:* = null;
         if(this.var_422 == HabboHelpViewEnum.const_230)
         {
            return;
         }
         if(this.var_735.length < 2)
         {
            ...
            this.var_735.push(_loc3_.content as BitmapData);
            _loc3_ = this._assetLibrary.getAssetByName("back_hi_png") as BitmapDataAsset;
            this.var_735.push(_loc3_.content as BitmapData);
         }
         var _loc2_:IBitmapWrapperWindow = this.var_421.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
         ...
         if(param1)
         {
            _loc2_.bitmap.copyPixels(this.var_735[1],this.var_735[1].rect,new Point(0,0));
         }
         else
         {
            _loc2_.bitmap.copyPixels(this.var_735[0],this.var_735[0].rect,new Point(0,0));
         }
      }
      ...
      private function addBackButtonWindow() : void
      {
         ...
         var _loc3_:* = null;
         var _loc4_:* = null;
         if(this.var_422 == HabboHelpViewEnum.const_230 || this.var_599.length == 0)
         {
            return;
         }
         if(this.var_421 == null)
         {
            ...
            this.var_421 = this._windowManager.buildFromXML(XML(_loc2_.content)) as IWindowContainer;
            _loc3_ = this.var_421.findChildByName("back_image");
            if(_loc3_ != null)
            {
            ...
            _loc4_ = this.var_421.findChildByName("back_text");
            if(_loc4_ != null)
            {
         ...
         var _loc1_:IItemListWindow = this._window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || this.var_421 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(this.var_421 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(this.var_421 as IWindow);
         this.setBackButtonActiveState(false);
      }
   }
}
