package com.sulake.habbo.help.tutorial
{
   ...
   public class NameChangeView
   {
      ...
      private function showSelectionView() : void
      {
         if(!this.var_769)
         {
            this.var_769 = this.var_26.buildXmlWindow("welcome_name_selection") as IWindowContainer;
            if(!this.var_769)
            {
               return;
            }
      ...
      private function showConfirmationView() : void
      {
         if(!this.var_768)
         {
            this.var_768 = this.var_26.buildXmlWindow("welcome_name_confirmation") as IWindowContainer;
            if(!this.var_768)
            {
               return;
            }
