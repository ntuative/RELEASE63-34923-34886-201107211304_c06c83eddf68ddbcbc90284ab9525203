package com.sulake.habbo.help.tutorial
{
   ...
   public class TutorialUI implements INameChangeUI
   {
      ...
      public static const const_453:String = "TUI_CLOTHES_VIEW";
      
      public static const const_628:String = "TUI_GUIDEBOT_VIEW";
      ...
      private var var_397:NameChangeView;
      ...
      public function TutorialUI(param1:HabboHelp, param2:Boolean = true)
      {
         ...
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_595,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_639,this.onTaskDoneEvent);
         this.var_36.events.addEventListener(HabboHelpTutorialEvent.const_656,this.onTaskDoneEvent);
      ...
      {
         return this.var_1285 && this.var_1286 && this.var_1572;
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_36)
         {
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_595,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_639,this.onTaskDoneEvent);
            this.var_36.events.removeEventListener(HabboHelpTutorialEvent.const_656,this.onTaskDoneEvent);
            if(this.var_36.sessionDataManager != null)
            {
      ...
      public function onTaskDoneEvent(param1:HabboHelpTutorialEvent) : void
      {
         switch(param1.type)
         {
            case HabboHelpTutorialEvent.const_595:
               this.var_1572 = true;
               if(this.var_53 != null && this.var_53.id == const_628)
               {
                  this.showView(const_95);
               }
               break;
            case HabboHelpTutorialEvent.const_639:
               if(this.var_53 != null && this.var_53.id == const_453)
               {
                  this.var_1962 = true;
                  this.disposeWindow();
               }
      ...
      public function showView(param1:String) : void
      {
         ...
         if(this._window == null)
         {
            ...
            this.var_2668 = this._window.width - _loc2_.width;
         ...
         switch(param1)
         {
            ...
            case const_332:
               ...
               if(this.var_397 == null)
               {
                  this.var_397 = new NameChangeView(this);
               }
               this.var_397.showMainView();
               this.prepareForTutorial();
               break;
            case const_453:
         ...
         this._window.height = _loc2_.height + this.var_2669;
         this._window.width = _loc2_.width + this.var_2668;
         if(_loc3_)
         {
            if(this._window == null)
            {
      ...
      public function onUserNameChanged(param1:String) : void
      {
         ...
         if(this.var_53 != null && (this.var_53.id == const_332 || this.var_53.id == const_95))
         {
            this.showView(const_95);
         }
      }
      ...
      {
         this.var_1285 = true;
         if(this.var_53 != null && (this.var_53.id == const_453 || this.var_53.id == const_95))
         {
            this.showView(const_95);
         }
      }
      ...
      public function onChangeUserNameResult(param1:ChangeUserNameResultMessageEvent) : void
      {
         ...
         {
            this.var_397.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
         }
      }
      ...
      public function onCheckUserNameResult(param1:CheckUserNameResultMessageEvent) : void
      {
         ...
         if(_loc2_.resultCode == ChangeUserNameResultMessageEvent.var_505)
         {
            this.var_397.checkedName = _loc2_.name;
         }
         else
         {
            this.var_397.setNameNotAvailableView(_loc2_.resultCode,_loc2_.name,_loc2_.nameSuggestions);
