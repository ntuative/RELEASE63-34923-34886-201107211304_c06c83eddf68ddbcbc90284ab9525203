package com.sulake.habbo.navigator
{
   ...
   public class PopupCtrl
   {
      ...
      public function PopupCtrl(param1:HabboNavigator, param2:int, param3:int, param4:String)
      {
         ...
         this.var_411.addEventListener(TimerEvent.TIMER,this.onHideTimer);
      }
      ...
      public function dispose() : void
      {
         ...
         if(this.var_411)
         {
            this.var_411.removeEventListener(TimerEvent.TIMER,this.onHideTimer);
            this.var_411.reset();
            this.var_411 = null;
         }
      }
      ...
      public function showPopup(param1:IWindow) : void
      {
         if(this.var_58 == null)
         {
            this.var_58 = IWindowContainer(this._navigator.getXmlWindow(this.var_1148));
            this.var_58.visible = false;
            this.var_58.setParamFlag(HabboWindowParam.const_44,true);
         ...
         this.var_58.x = _loc2_.x + this.var_2551 + param1.width;
