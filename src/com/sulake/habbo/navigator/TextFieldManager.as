package com.sulake.habbo.navigator
{
   ...
   public class TextFieldManager
   {
      ...
      public function TextFieldManager(param1:HabboNavigator, param2:ITextFieldWindow, param3:int = 1000, param4:Function = null, param5:String = null)
      {
         ...
         this.var_69.addEventListener(WindowKeyboardEvent.const_191,this.checkEnterPress);
         this.var_69.addEventListener(WindowEvent.const_111,this.checkMaxLen);
         this._orgTextBackground = this.var_69.textBackground;
         this.var_2342 = this.var_69.textBackgroundColor;
      ...
      public function restoreBackground() : void
      {
         ...
         this.var_69.textBackgroundColor = this.var_2342;
      ...
      public function goBackToInitialState() : void
      {
         ...
         {
            this.var_69.text = this.var_1636;
            this.var_624 = true;
         }
         else
         {
      ...
      private function checkMaxLen(param1:WindowEvent) : void
      {
         ...
         if(_loc2_.length > this.var_1761)
         {
            this.var_69.text = _loc2_.substring(0,this.var_1761);
         }
      }
   }
}
