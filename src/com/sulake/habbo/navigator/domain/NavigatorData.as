package com.sulake.habbo.navigator.domain
{
   ...
   public class NavigatorData
   {
      ...
      private static const const_2083:int = 10;
      ...
      private var var_696:RoomEventData;
      ...
      private var var_2046:OfficialRoomEntryData;
      ...
      public function set categories(param1:Array) : void
      {
         ...
         this.var_1615 = new Array();
         for each(_loc2_ in this.var_1616)
         {
            if(_loc2_.visible)
            {
               this.var_1615.push(_loc2_);
            }
         }
      }
      ...
      {
         var _loc2_:int = 0;
         this.var_2824 = param1.limit;
         this.var_1617 = param1.favouriteRoomIds.length;
         this._favouriteIds = new Dictionary();
      ...
      {
         return this.var_1617 >= this.var_2824;
      }
