package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_1381:RoomLayout;
      
      private var var_730:Timer;
      
      private var var_2154:Boolean = true;
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(this.var_1381.view.findChildByName("select_arrow"));
         var _loc6_:int = Math.abs(_loc3_.y - 0) < 2 || Math.abs(_loc3_.y - 15) < 2 ? 1 : 2;
         _loc3_.y += !!this.var_2154 ? _loc6_ : -_loc6_;
         if(_loc3_.y < 0)
         {
            this.var_2154 = true;
            _loc3_.y = 1;
      ...
      private function prepare() : void
      {
         ...
         this.var_63 = IItemListWindow(this.var_210.findChildByName("item_list"));
         ...
         this.var_1382 = new TextFieldManager(this._navigator,ITextFieldWindow(this.var_210.findChildByName("room_name_input")),25,null,this._navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      {
         this.var_1382.goBackToInitialState();
         this.var_1382.input.textBackgroundColor = 4294967295;
         this.var_1381 = this.var_46[0];
         this.refreshRoomThumbnails();
      ...
      {
         return Boolean(this.var_1382.checkMandatory(this._navigator.getText("navigator.createroom.nameerr")));
      }
      ...
      {
         var _loc2_:String = this.var_1382.getText();
         var _loc3_:String = "model_" + this.var_1381.name;
