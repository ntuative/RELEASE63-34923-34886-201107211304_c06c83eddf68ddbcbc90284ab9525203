package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_924:TextFieldManager;
      ...
      private var var_1403:TextFieldManager;
      ...
      private var var_1138:IDropMenuWindow;
      
      private var var_3026:IWindowContainer;
      ...
      {
         if(param1 != this.var_426 || this.var_1401 < 1)
         {
            return;
         }
         this.close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         this.var_1401 = 0;
         if(param2 == RoomSettingsSaveErrorMessageParser.const_1912)
         {
            this.var_924.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1759)
         {
            this.var_924.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         ...
         {
            this.setTagError(this.var_1132,param3,"${navigator.roomsettings.unacceptablewords}");
            this.setTagError(this.var_1131,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1732)
         {
            this.setTagError(this.var_1132,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         ...
         {
            this.var_1136.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_924.displayError("Update failed: error " + param2);
         }
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_548,this.onDoorModePasswordUnselect);
         ...
         this.var_924 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("room_name")),60);
         this.var_1400 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("description")),255);
         this.var_1132 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag1")),30);
         this.var_1131 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("tag2")),30);
         this.var_1136 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password")),30);
         this.var_1403 = new TextFieldManager(this._navigator,ITextFieldWindow(this._window.findChildByName("password_confirm")),30);
         this.var_1397 = ICheckBoxWindow(this._window.findChildByName("allow_pets_checkbox"));
         this.var_1395 = ICheckBoxWindow(this._window.findChildByName("allow_foodconsume_checkbox"));
         this.var_1399 = ICheckBoxWindow(this._window.findChildByName("allow_walk_through_checkbox"));
         this.var_922 = ICheckBoxWindow(this._window.findChildByName("hide_walls_checkbox"));
         this.var_2199 = this._window.findChildByName("hide_walls_text") as ITextWindow;
         this.var_1137 = IDropMenuWindow(this._window.findChildByName("wall_thickness"));
         this.var_1138 = IDropMenuWindow(this._window.findChildByName("floor_thickness"));
         this.var_3026 = IWindowContainer(this._window.findChildByName("thumbnail_container"));
         this.var_1398 = IWindowContainer(this._window.findChildByName("basic_settings_container"));
         this.var_1402 = IWindowContainer(this._window.findChildByName("advanced_settings_container"));
         this.var_2197 = IWindowContainer(this._window.findChildByName("switch_view_container"));
         this.var_1697 = IWindowContainer(this._window.findChildByName("footer_container"));
         this.var_265 = IWindowContainer(this._window.findChildByName("flat_controllers_container"));
         this.var_1396 = IWindowContainer(this._window.findChildByName("password_container"));
         this.var_1698 = ITextWindow(this._window.findChildByName("switch_view_text"));
         this.var_1698.mouseThreshold = 0;
         this.var_1698.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onSwitchView);
         this.var_1396.visible = false;
         if(!this.var_1699)
         {
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         this.var_2197.visible = this.var_1699;
         this.populateForm();
         if(this.var_923)
         {
            ...
            this.var_1402.height = Util.getLowestPoint(this.var_1402) + 4;
         }
         else
         {
            this.var_1398.visible = true;
            this.var_1697.visible = true;
            this.var_3026.visible = this.var_1699;
            this.var_1398.height = Util.getLowestPoint(this.var_1398) + 4;
         }
         this.var_1698.text = !!this.var_923 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(this._window,[this.var_1398.name,this.var_1402.name,this.var_1697.name,this.var_2197.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         this.var_924.setText(_loc1_.name);
         this.var_1400.setText(_loc1_.description);
         this.var_1136.setText("");
         this.var_1403.setText("");
         ...
         this.setTag(this.var_1132,_loc1_.tags[0]);
         this.setTag(this.var_1131,_loc1_.tags[1]);
         if(this.var_1397)
         {
            if(_loc1_.allowPets)
            {
               this.var_1397.select();
            }
            else
            {
               this.var_1397.unselect();
            }
         }
         if(this.var_1395)
         {
            ...
            {
               this.var_1395.select();
            }
            else
            {
               this.var_1395.unselect();
            }
         }
         if(this.var_1399)
         {
            ...
            {
               this.var_1399.select();
            }
            else
            {
               this.var_1399.unselect();
            }
         }
         if(!this.VIPFeaturesAllowed())
         {
            this.disableWindow(this.var_922);
            this.disableWindow(this.var_1137);
            this.disableWindow(this.var_1138);
            this.disableWindow(this.var_2199);
         }
         else
         {
            this.enableWindow(this.var_922);
            this.enableWindow(this.var_1137);
            this.enableWindow(this.var_1138);
            this.enableWindow(this.var_2199);
         }
         if(this.var_922)
         {
            if(_loc1_.hideWalls)
            ...
            {
               this.var_922.unselect();
            }
         }
         if(this.var_1137)
         {
            this.var_1137.selection = this.getThicknessSelectionIndex(_loc1_.wallThickness);
         }
         if(this.var_1138)
         {
            this.var_1138.selection = this.getThicknessSelectionIndex(_loc1_.floorThickness);
         }
         this.clearErrors();
      }
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         _loc2_.name = this.var_924.getText();
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_561;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_132)
         {
            _loc8_ = this.var_1136.getText();
            _loc9_ = this.var_1403.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_1136.clearErrors();
               this.var_1403.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = this.var_1397.isSelected;
         _loc2_.allowFoodConsume = this.var_1395.isSelected;
         _loc2_.allowWalkThrough = this.var_1399.isSelected;
         _loc2_.hideWalls = this.var_922.isSelected;
         _loc2_.wallThickness = this.var_1137.selection - 2;
         _loc2_.floorThickness = this.var_1138.selection - 2;
         _loc2_.tags = new Array();
         this.addTag(this.var_1132,_loc2_.tags);
         this.addTag(this.var_1131,_loc2_.tags);
         this.clearErrors();
         this.var_1401 = _loc2_.roomId;
