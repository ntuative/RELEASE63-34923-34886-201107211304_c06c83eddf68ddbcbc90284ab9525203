package com.sulake.habbo.navigator.mainview
{
   ...
   public class OfficialRoomEntryManager implements IDisposable
   {
      ...
      private static const const_1445:int = 267;
      
      private static const const_1446:int = 65;
      
      private static const const_1447:int = -70;
      ...
      private var var_1164:UserCountRenderer;
      
      private var var_2292:PublicRoomThumbs;
      
      public function OfficialRoomEntryManager(param1:HabboNavigator)
      {
         this.var_2292 = new PublicRoomThumbs();
         super();
         this._navigator = param1;
         this.var_1164 = new UserCountRenderer(this._navigator);
      }
      ...
      public function refreshEntry(param1:IWindowContainer, param2:Boolean, param3:int, param4:OfficialRoomEntryData) : void
      {
         ...
         if(param2)
         {
            ...
            if(param4.type == OfficialRoomEntryData.const_1784)
            {
      ...
      private function refreshUserCount(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         var _loc4_:int = 0;
         var _loc5_:int = 0;
         if(param2.showDetails && (param2.type == OfficialRoomEntryData.const_765 || param2.type == OfficialRoomEntryData.const_888))
         {
            _loc3_ = 3;
            _loc4_ = 34;
            _loc5_ = 13;
            this.var_1164.refreshUserCount(param2.maxUsers,param1,param2.userCount,"${navigator.usercounttooltip.users}",param1.width - _loc3_ - _loc4_,param1.height - _loc3_ - _loc5_);
         }
      }
      ...
      private function refreshCell(param1:IWindowContainer, param2:OfficialRoomEntryData) : void
      {
         ...
         _loc3_.visible = true;
         _loc3_.width = !!param2.showDetails ? int(const_1446) : int(const_1445);
      ...
      {
         var _loc4_:String = this.var_2292.resolveRoomImageName(param2);
         ...
         param3.x = !!param2.showDetails ? int(const_1447) : 0;
      ...
      private function handleClick(param1:IWindow) : void
      {
         ...
         else if(_loc2_.tag != null)
         {
            ...
            this._navigator.mainViewCtrl.startSearch(Tabs.const_257,Tabs.const_579,_loc2_.tag);
         }
