package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ExtraToolsExtension
   {
      ...
      private static const const_1477:uint = 16777215;
      
      private static const const_1476:uint = 12247545;
      
      private static const const_1478:String = "HELP";
      ...
      {
         this.var_63.removeListItem(this.var_373);
      }
      
      public function showRoomInfo() : void
      {
         this.var_63.addListItemAt(this.var_373,0);
      }
      ...
      private function showConfirmation() : void
      {
         ...
         if(!this.var_326)
         {
            this.var_326 = this.createWindow("logout_confirmation_xml") as IWindowContainer;
            _loc1_ = new Point();
            this._window.getGlobalPosition(_loc1_);
            this.var_326.x = _loc1_.x + this._window.width - this.var_326.width;
            this.var_326.y = _loc1_.y + this._window.height - this.var_326.height;
         }
      }
      ...
      private function onClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         switch(param2.name)
         {
            case "logout_region":
               ...
               break;
            case "help_region":
               this._toolbar.toggleWindowVisibility(const_1478);
               break;
