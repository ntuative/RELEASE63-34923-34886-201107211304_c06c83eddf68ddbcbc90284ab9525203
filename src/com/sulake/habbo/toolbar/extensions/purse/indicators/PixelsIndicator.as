package com.sulake.habbo.toolbar.extensions.purse.indicators
{
   ...
   public class PixelsIndicator extends CurrencyIndicatorBase
   {
      ...
      private static const const_1422:uint = 4285767869;
      
      private static const const_1420:uint = 4283664040;
      
      private static const const_486:Array = ["icon_pixel_0_png","icon_pixel_1_png","icon_pixel_2_png","icon_pixel_3_png"];
      ...
      public function PixelsIndicator(param1:IHabboWindowManager, param2:IAssetLibrary, param3:IHabboCatalog, param4:ICoreLocalizationManager)
      {
         ...
         this.iconAnimationSequence = const_486.concat(const_486);
         this.iconAnimationDelay = 50;
         this.amountZeroText = param4.getKey("purse.pixels.zero.amount.text","Get");
         createWindow("purse_indicator_pixels_xml",const_486[0]);
         this.setAmount(0);
      }
      ...
      {
         this._catalog.openCatalogPage(CatalogPageName.const_1788);
      }
      ...
      private function onPixelBalance(param1:PurseEvent) : void
      {
         ...
         if(this.var_1810 != 0)
         {
            if(this.var_1810 > param1.balance)
            {
