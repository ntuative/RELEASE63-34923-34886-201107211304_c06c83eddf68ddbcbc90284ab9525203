package com.sulake.habbo.toolbar.extensions
{
   ...
   public class ClubDiscountPromoExtension
   {
      ...
      private static const const_718:String = "club_promo";
      
      private static const const_1421:int = 13;
      
      private static const const_1039:int = 14;
      
      private static const const_1525:uint = 16777215;
      
      private static const const_1526:uint = 12247545;
      ...
      private var var_701:IExtensionView;
      ...
      private var var_1323:IRegionWindow;
      ...
      public function ClubDiscountPromoExtension(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IEventDispatcher, param5:IHabboConfigurationManager, param6:ICoreLocalizationManager, param7:IHabboInventory, param8:IHabboCatalog, param9:IConnection)
      {
         ...
         this.var_701 = param1.extensionView;
         if(this.var_12)
         {
         ...
         if(_loc4_)
         {
            ...
            if(_loc3_)
            {
               ...
               if(this.var_87)
               {
                  ...
                  if(_loc5_)
                  {
                     this.var_877 = _loc5_.content as BitmapData;
                     if(this.var_877)
                     {
                        this.var_87.bitmap = this.var_877.clone();
                     }
                  }
                  this.var_87.visible = false;
               }
               this.var_1323 = _loc3_.findChildByName("text_region") as IRegionWindow;
               if(this.var_1323)
               {
                  this.var_1323.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,this.onTextRegionClicked);
                  this.var_1323.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_OVER,this.onTextRegionMouseOver);
                  this.var_1323.addEventListener(WindowMouseEvent.const_25,this.onTextRegionMouseOut);
               }
               this.assignState();
            }
         }
      ...
      public function dispose() : void
      {
         if(!this._disposed)
         {
            if(this.var_701)
            {
               this.var_701.detachExtension(const_718);
               this.var_701 = null;
            }
            this.animate(false);
            this.clearAnimation();
      ...
      private function onClubChanged(param1:HabboInventoryHabboClubEvent) : void
      {
         if(this.var_12.clubIsExpiring)
         {
            if(!this._view)
            {
               ...
               this.assignState();
               this.var_701.attachExtension(const_718,this._view,ExtensionFixedSlotsEnum.const_1806);
            }
         }
         else
         {
      ...
      private function resetAnimationVariables() : void
      {
         ...
         this.var_2057 = this._view.width - 7 - this.var_87.bitmap.width;
         this.var_1621 = 0;
      }
      
      private function startAnimationTimer() : void
      {
         this.var_741 = new Timer(25,26);
         this.var_741.addEventListener(TimerEvent.TIMER,this.onAnimationTimer);
         this.var_741.addEventListener(TimerEvent.TIMER_COMPLETE,this.onAnimationTimerComplete);
         this.var_741.start();
      }
      ...
      private function onAnimationTimer(param1:TimerEvent) : void
      {
         var _loc2_:int = 0;
         var _loc3_:* = null;
         this.var_87.x = 3 + this.var_1621 / 20 * this.var_2057;
         if(this.var_87.x > this.var_2057)
         {
            _loc2_ = this._view.width - 4 - this.var_87.x;
            _loc3_ = new BitmapData(_loc2_,this.var_877.height);
            _loc3_.copyPixels(this.var_877,new Rectangle(0,0,_loc2_,this.var_877.height),new Point(0,0));
