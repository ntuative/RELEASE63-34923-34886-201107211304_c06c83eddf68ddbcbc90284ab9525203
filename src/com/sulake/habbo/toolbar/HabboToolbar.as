package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private static const const_1643:String = "purse";
      
      private static const const_1644:String = "extra_tools";
      ...
      private var var_700:ExtraToolsExtension;
      
      private var _connection:IConnection;
      
      private var _catalog:IHabboCatalog;
      
      private var var_1324:PurseExtension;
      
      private var var_1622:ClubDiscountPromoExtension;
      
      private var _localization:ICoreLocalizationManager;
      
      private var var_12:IHabboInventory;
      
      private var var_701:ExtensionView;
      ...
      {
         if(this.var_279 && this._windowManager && this._config && this._localization && this.var_12 && this._catalog)
         {
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         if(this._config && this._config.getKey("client.logout.enabled","HabboRoomUICom_jb_icon_disc") == "SetClothingChangeDataMessageComposer")
         {
            this.var_701 = new ExtensionView(this._windowManager,this._assetLibrary,this);
            if(this.var_701)
            {
               this.var_1324 = new PurseExtension(this._windowManager,this._assetLibrary,this._config,this._catalog,this.var_12,this._localization);
               this.var_700 = new ExtraToolsExtension(this,this._windowManager,this._assetLibrary,events,this._config);
               if(this._config.getBoolean("club.membership.extend.promotion.enabled",false))
               {
                  this.var_1622 = new ClubDiscountPromoExtension(this,this._windowManager,this._assetLibrary,events,this._config,this._localization,this.var_12,this._catalog,this._connection);
               }
               this.var_701.attachExtension(const_1643,this.var_1324.window,ExtensionFixedSlotsEnum.const_1921);
               this.var_701.attachExtension(const_1644,this.var_700.window,ExtensionFixedSlotsEnum.const_1815);
            }
         }
         if(this._view == null)
         {
      ...
      public function setToolbarState(param1:String) : void
      {
         switch(param1)
         {
            case HabboToolbarEnum.const_933:
               ...
               break;
            case HabboToolbarEnum.const_1008:
      ...
      private function toolbarExtensionVisible(param1:Boolean) : void
      {
         ...
         if(param1)
         {
            this.var_700.showRoomInfo();
         }
         else
         {
            this.var_700.hideRoomInfo();
         }
      }
