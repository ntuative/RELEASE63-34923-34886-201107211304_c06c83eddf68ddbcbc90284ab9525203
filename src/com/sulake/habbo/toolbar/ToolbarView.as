package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarView
   {
      ...
      private static const const_1555:Point = new Point(3,3);
      
      private static const const_1551:uint = 7433577;
      
      private static const const_1553:uint = 5723213;
      ...
      private static const const_1547:int = 80;
      
      private static const const_1549:int = 74;
      ...
      public function ToolbarView(param1:HabboToolbar, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IConnection, param5:IHabboCatalog, param6:IEventDispatcher, param7:IHabboConfigurationManager)
      {
         ...
         this._window.position = const_1555;
         this._window.addEventListener(WindowEvent.const_674,this.onParentResized);
         ...
         this.var_223.x = _loc13_.width - this.var_223.width - const_479;
         this.var_223.y = const_479;
      ...
      private function checkSize(param1:Boolean = false) : void
      {
         ...
         if(!param1 && _loc2_ == this.var_1547)
         {
            return;
         }
         this.var_1547 = _loc2_;
         var _loc3_:int = !!_loc2_ ? int(const_1549) : int(const_1547);
         ...
         while(_loc7_ < _loc5_.length)
         {
            ...
            _loc6_.y = const_1552 + _loc7_ * (_loc3_ + _loc4_);
            _loc7_++;
         }
      ...
      private function setIconHoverState(param1:IBitmapWrapperWindow, param2:String) : void
      {
         ...
         {
            _loc4_ = param2 == const_478 ? this.var_1549 : this.var_1548;
         }
         else
         {
      ...
      public function getIconVerticalLocation(param1:String) : int
      {
         switch(param1)
         {
            case HabboToolbarIconEnum.NAVIGATOR:
               return !!this.var_1547 ? 45 : 50;
            case HabboToolbarIconEnum.QUESTS:
               return !!this.var_1547 ? 125 : 140;
            default:
               return 0;
         }
      }
      ...
      {
         return this._config.getKey("toolbar.new_additions.notification.enabled","HabboRoomUICom_jb_icon_disc") == "SetClothingChangeDataMessageComposer";
      }
   }
}
