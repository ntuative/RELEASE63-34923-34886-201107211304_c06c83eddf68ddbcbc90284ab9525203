package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_631:Number = 64;
      
      public static const const_1320:Number = 32;
      ...
      public function RoomGeometry(param1:Number, param2:IVector3d, param3:IVector3d, param4:IVector3d = null)
      {
         ...
         this.x_scale = 1;
         this.y_scale = 1;
         this.var_1941 = Math.sqrt(0.5) / Math.sqrt(0.75);
         this.z_scale = 1;
      ...
      {
         this.var_470.assign(this.var_106);
         this.var_470.x *= this.var_469;
         this.var_470.y *= this.var_472;
         this.var_470.z *= this.var_471;
         return this.var_470;
      }
      ...
      {
         if(this.var_469 != param1 * this.var_1942)
         {
            this.var_469 = param1 * this.var_1942;
            ++this.var_180;
         }
      }
      ...
      {
         if(this.var_472 != param1 * this.var_1940)
         {
            this.var_472 = param1 * this.var_1940;
            ++this.var_180;
         }
      }
      ...
      {
         if(this.var_471 != param1 * this.var_1941)
         {
            this.var_471 = param1 * this.var_1941;
            ++this.var_180;
         }
      }
      ...
      public function set location(param1:IVector3d) : void
      {
         ...
         this.var_106.x /= this.var_469;
         this.var_106.y /= this.var_472;
         this.var_106.z /= this.var_471;
      ...
      public function set direction(param1:IVector3d) : void
      {
         ...
         if(_loc10_ != 0)
         {
            ...
            this.var_1272.assign(this.var_172);
         }
         else
         {
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            this.var_1271.assign(_loc22_);
         }
         else
         {
            this.var_1271.assign(_loc17_);
         }
         ++this.var_180;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.x *= this.var_469;
         _loc2_.y *= this.var_472;
         _loc2_.z *= this.var_471;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,this.var_1271);
         if(_loc3_ < this.var_3086 || _loc3_ > this.var_3085)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= this.var_472;
            _loc2_.z *= this.var_471;
            _loc3_ = Vector3d.scalarProjection(_loc2_,this.var_1271);
         }
         _loc2_.x = _loc4_;
         _loc2_.y = _loc5_;
         _loc2_.z = _loc3_;
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         _loc7_.add(Vector3d.product(this.var_171,_loc6_));
         var _loc8_:Vector3d = new Vector3d(this.var_106.x * this.var_469,this.var_106.y * this.var_472,this.var_106.z * this.var_471);
         _loc8_.add(_loc7_);
         var _loc9_:IVector3d = this.var_172;
         var _loc10_:Vector3d = new Vector3d(param2.x * this.var_469,param2.y * this.var_472,param2.z * this.var_471);
         var _loc11_:Vector3d = new Vector3d(param3.x * this.var_469,param3.y * this.var_472,param3.z * this.var_471);
         var _loc12_:Vector3d = new Vector3d(param4.x * this.var_469,param4.y * this.var_472,param4.z * this.var_471);
      ...
      public function performZoom() : void
      {
         if(this.isZoomedIn())
         {
            this.scale = const_1320;
         }
         else
         {
            this.scale = const_631;
         }
      }
      
      public function isZoomedIn() : Boolean
      {
         return this.scale == const_631;
      }
