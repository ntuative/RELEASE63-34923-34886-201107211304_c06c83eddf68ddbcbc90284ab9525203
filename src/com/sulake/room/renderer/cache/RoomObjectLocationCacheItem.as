package com.sulake.room.renderer.cache
{
   ...
   public class RoomObjectLocationCacheItem
   {
      ...
      public function getScreenLocation(param1:IRoomObject, param2:IRoomGeometry) : IVector3d
      {
         ...
         if(param2.updateId != this.var_1805 || param1.getUpdateID() != this.var_2936)
         {
            this.var_2936 = param1.getUpdateID();
            if(param2.updateId != this.var_1805 || _loc4_.x != this.var_1354.x || _loc4_.y != this.var_1354.y || _loc4_.z != this.var_1354.z)
            {
               this.var_1805 = param2.updateId;
               this.var_1354.assign(_loc4_);
               _loc3_ = true;
            }
         }
         ...
         if(_loc3_)
         {
            ...
            if(isNaN(_loc6_) || _loc6_ == 0)
            {
               ...
               if(_loc7_.x != _loc4_.x || _loc7_.y != _loc4_.y)
               {
                  ...
                  this.var_415.assign(_loc5_);
                  if(_loc8_ != null)
                  {
                     this.var_415.z = _loc8_.z;
                  }
               }
               else
               {
            ...
            this.var_415.x = Math.round(this.var_415.x);
            this.var_415.y = Math.round(this.var_415.y);
         }
         return this.var_415;
      }
   }
