package com.sulake.room.renderer.cache
{
   ...
   public class BitmapDataCache
   {
      ...
      public function BitmapDataCache(param1:int, param2:int, param3:int = 1)
      {
         ...
         this.var_953 = param1 * 1024 * 1024;
         this.var_1734 = param2 * 1024 * 1024;
         this.var_1449 = param3 * 1024 * 1024;
         if(this.var_1449 < 0)
         {
            this.var_1449 = 0;
         }
      ...
      {
         this.var_953 += this.var_1449;
         if(this.var_953 > this.var_1734)
         {
            this.var_953 = this.var_1734;
         }
      }
