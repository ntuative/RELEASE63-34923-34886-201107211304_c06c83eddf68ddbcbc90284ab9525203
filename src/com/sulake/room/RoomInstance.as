package com.sulake.room
{
   ...
   public class RoomInstance implements IRoomInstance
   {
      ...
      private var var_189:IRoomRendererBase;
      ...
      public function dispose() : void
      {
         ...
         if(this.var_310 != null)
         {
            ...
            {
               _loc3_ = this.var_310.getWithIndex(_loc2_) as IRoomObjectManager;
               if(_loc3_ != null)
               {
                  _loc3_.dispose();
               }
      ...
      {
         if(this.var_1545.indexOf(param1) >= 0)
         {
            return;
         }
         if(param3)
      ...
      public function createObjectInternal(param1:int, param2:int, param3:String, param4:int) : IRoomObject
      {
         ...
         if(_loc5_ != null)
         {
            ...
            if(this.var_189 != null)
            {
               this.var_189.feedRoomObject(_loc6_);
            }
            return _loc6_;
         }
         return null;
      ...
      public function disposeObject(param1:int, param2:int) : Boolean
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               if(this.var_189)
               {
                  this.var_189.removeRoomObject(_loc4_.getInstanceId());
               }
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc4_ < _loc2_)
            {
               ...
               if(_loc5_ != null)
               {
                  ...
                  if(this.var_189)
                  {
                     this.var_189.removeRoomObject(_loc6_);
                  }
               }
               _loc4_++;
            }
      ...
      public function setRenderer(param1:IRoomRendererBase) : void
      {
         ...
         while(_loc3_ >= 0)
         {
            ...
            while(_loc6_ >= 0)
            {
               ...
               if(_loc7_ != null)
               {
                  this.var_189.feedRoomObject(_loc7_);
               }
               _loc6_--;
            }
            _loc3_--;
      ...
      protected function createObjectManager(param1:int) : IRoomObjectManager
      {
         ...
         {
            return this.var_310.getValue(_loc2_) as IRoomObjectManager;
         }
         if(this._container == null)
         {
            return null;
      ...
      {
         return this.var_310.getValue(String(param1)) as IRoomObjectManager;
      }
      ...
      protected function disposeObjectManager(param1:int) : Boolean
      {
         ...
         if(this.var_310.getValue(_loc2_) != null)
         {
            _loc3_ = this.var_310.remove(_loc2_) as IRoomObjectManager;
            if(_loc3_ != null)
            {
               _loc3_.dispose();
            }
