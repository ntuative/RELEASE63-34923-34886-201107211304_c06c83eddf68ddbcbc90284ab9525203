package com.hurlant.math
{
   ...
   class MontgomeryReduction implements IReduction
   {
      ...
      function MontgomeryReduction(param1:BigInteger)
      {
         super();
         this.m = param1;
         this.var_1978 = param1.invDigit();
         this.var_1977 = this.var_1978 & 32767;
         this.var_2686 = this.var_1978 >> 15;
         this.var_2687 = 131071;
         this.var_2688 = 2 * param1.t;
      }
      ...
      public function convert(param1:BigInteger) : BigInteger
      {
         ...
         if(param1.s < 0 && _loc2_.compareTo(BigInteger.const_190) > 0)
         {
